...
### `def ++=(xs: TraversableOnce[(A, B)]): ImmutableMapAdaptor.this.type`    ###
...
### `def +=(elem1: (A, B), elem2: (A, B), elems: (A, B)*): ImmutableMapAdaptor.this.type` ###
...
### `def --=(xs: TraversableOnce[A]): ImmutableMapAdaptor.this.type`         ###
...
### `def -=(elem1: A, elem2: A, elems: A*): ImmutableMapAdaptor.this.type`   ###
...
--------------------------------------------------------------------------------
    Instance Constructors From scala.collection.mutable.ImmutableMapAdaptor
--------------------------------------------------------------------------------


### `new ImmutableMapAdaptor(imap: immutable.Map[A, B])`                     ###

(defined at scala.collection.mutable.ImmutableMapAdaptor)


--------------------------------------------------------------------------------
        Value Members From scala.collection.mutable.ImmutableMapAdaptor
--------------------------------------------------------------------------------
...
* Definition Classes
  * ImmutableMapAdaptor → MapLike → Builder → Growable
...
* Definition Classes
  * ImmutableMapAdaptor → MapLike → Shrinkable
...
* Definition Classes
  * ImmutableMapAdaptor → MapLike → Function1 → GenMapLike
...
* Definition Classes
  * ImmutableMapAdaptor → MapLike → GenMapLike
...
* Definition Classes
  * ImmutableMapAdaptor → MapLike → PartialFunction → GenMapLike
...
### `def retain(p: (A, B) ⇒ Boolean): ImmutableMapAdaptor.this.type`         ###
...
* Definition Classes
  * ImmutableMapAdaptor → MapLike

(defined at scala.collection.mutable.ImmutableMapAdaptor)


### `def transform(f: (A, B) ⇒ B): ImmutableMapAdaptor.this.type`            ###
...
* Implicit information
  * This member is added by an implicit conversion from ImmutableMapAdaptor [A,
    B] to CollectionsHaveToParArray [ImmutableMapAdaptor [A, B], T] performed by
    ...
    ImmutableMapAdaptor [A, B]) ⇒ GenTraversableOnce [T] is in scope.
* Definition Classes
