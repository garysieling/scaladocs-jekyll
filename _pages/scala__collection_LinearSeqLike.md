...
* Definition Classes
  * LinearSeqLike → GenSeqLike → Parallelizable → TraversableOnce →
    GenTraversableOnce
...
* Implicit information
  * This member is added by an implicit conversion from LinearSeqLike [A, Repr]
    to CollectionsHaveToParArray [LinearSeqLike [A, Repr], T] performed by
    method CollectionsHaveToParArray in scala.collection.parallel. This
    conversion will take place only if an implicit value of type (LinearSeqLike
