...
--------------------------------------------------------------------------------
         Abstract Value Members From scala.collection.parallel.Splitter
--------------------------------------------------------------------------------


### `abstract def split: Seq[Splitter[T]]`                                   ###
...
* Implicit information
  * This member is added by an implicit conversion from Splitter [T] to
    CollectionsHaveToParArray [Splitter [T], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Splitter [T]) ⇒
