...
### `def bf2seq[S, That](bf: CanBuildFrom[ParSeq[T], S, That]): CanBuildFrom[scala.Seq[T], S, That]` ###
...
### `def sequentially[S, That <: Parallel](b: (scala.Seq[T]) ⇒ Parallelizable[S, That]): ParSeq[T]` ###
...
--------------------------------------------------------------------------------
          Concrete Value Members From scala.collection.parallel.ParSeq
--------------------------------------------------------------------------------
...
* Definition Classes
  * ParSeq → ParIterable → GenericParTemplate → GenSeq → GenIterable →
...
### `def view: SeqView[T, scala.Seq[T]]`                                     ###
