...
### `def parCombiner: Combiner[Double, ParArray[Double]]`                    ###
...
### `def lastIndexOf[B >: Double](elem: B): Int`                             ###
...
### `def prefixLength(p: (Double) ⇒ Boolean): Int`                           ###
...
### `def toBuffer[A1 >: Double]: Buffer[A1]`                                 ###
...
### `def drop(n: Int): WrappedArray[Double]`                                 ###
...
### `def dropRight(n: Int): WrappedArray[Double]`                            ###
...
### `def dropWhile(p: (Double) ⇒ Boolean): WrappedArray[Double]`             ###
...
### `def reverse: WrappedArray[Double]`                                      ###
...
### `def sameElements[B >: Double](that: GenIterable[B]): Boolean`           ###
...
### `def slice(from: Int, until: Int): WrappedArray[Double]`                 ###
...
### `def span(p: (Double) ⇒ Boolean): (WrappedArray[Double], WrappedArray[Double])` ###
...
### `def splitAt(n: Int): (WrappedArray[Double], WrappedArray[Double])`      ###
...
### `def take(n: Int): WrappedArray[Double]`                                 ###
...
### `def takeRight(n: Int): WrappedArray[Double]`                            ###
...
### `def takeWhile(p: (Double) ⇒ Boolean): WrappedArray[Double]`             ###
...
### `def zipWithIndex[A1 >: Double, That](implicit bf: CanBuildFrom[WrappedArray[Double], (A1, Int), That]): That` ###
...
### `def zip[A1 >: Double, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[WrappedArray[Double], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[WrappedArray[Double]]`                 ###
...
### `def sliding(size: Int): Iterator[WrappedArray[Double]]`                 ###
...
### `def sliding(size: Int, step: Int): Iterator[WrappedArray[Double]]`      ###
...
### `def toIterable: collection.Iterable[Double]`                            ###
...
### `def toStream: immutable.Stream[Double]`                                 ###
...
### `def zipAll[B, A1 >: Double, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[WrappedArray[Double], (A1, B), That]): That` ###
...
### `def +:[B >: Double, That](elem: B)(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[WrappedArray[Double]]`               ###
...
### `def corresponds[B](that: GenSeq[B])(p: (Double, B) ⇒ Boolean): Boolean` ###
...
### `def diff[B >: Double](that: GenSeq[B]): WrappedArray[Double]`           ###
...
### `def distinct: WrappedArray[Double]`                                     ###
...
### `def indexOfSlice[B >: Double](that: GenSeq[B]): Int`                    ###
...
### `def indexOfSlice[B >: Double](that: GenSeq[B], from: Int): Int`         ###
...
### `def intersect[B >: Double](that: GenSeq[B]): WrappedArray[Double]`      ###
...
### `def lastIndexOfSlice[B >: Double](that: GenSeq[B]): Int`                ###
...
### `def lastIndexOfSlice[B >: Double](that: GenSeq[B], end: Int): Int`      ###
...
### `def padTo[B >: Double, That](len: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def patch[B >: Double, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def permutations: Iterator[WrappedArray[Double]]`                       ###
...
### `def reverseMap[B, That](f: (Double) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def sortBy[B](f: (Double) ⇒ B)(implicit ord: math.Ordering[B]): WrappedArray[Double]` ###
...
### `def sortWith(lt: (Double, Double) ⇒ Boolean): WrappedArray[Double]`     ###
...
### `def sorted[B >: Double](implicit ord: math.Ordering[B]): WrappedArray[Double]` ###
...
### `def toSeq: collection.Seq[Double]`                                      ###
...
### `def union[B >: Double, That](that: GenSeq[B])(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def updated[B >: Double, That](index: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def ++:[B >: Double, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def ++:[B >: Double, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def ++[B >: Double, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[Double, B])(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def filter(p: (Double) ⇒ Boolean): WrappedArray[Double]`                ###
...
### `def filterNot(p: (Double) ⇒ Boolean): WrappedArray[Double]`             ###
...
### `def flatMap[B, That](f: (Double) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def groupBy[K](f: (Double) ⇒ K): immutable.Map[K, WrappedArray[Double]]` ###
...
### `def inits: Iterator[WrappedArray[Double]]`                              ###
...
### `def map[B, That](f: (Double) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def partition(p: (Double) ⇒ Boolean): (WrappedArray[Double], WrappedArray[Double])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, Double) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Double, B) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def scan[B >: Double, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[WrappedArray[Double], B, That]): That` ###
...
### `def tails: Iterator[WrappedArray[Double]]`                              ###
...
### `def toTraversable: collection.Traversable[Double]`                      ###
...
### `def withFilter(p: (Double) ⇒ Boolean): FilterMonadic[Double, WrappedArray[Double]]` ###
...
### `def toIndexedSeq: immutable.IndexedSeq[Double]`                         ###
...
### `def toMap[T, U](implicit ev: <:<[Double, (T, U)]): immutable.Map[T, U]` ###
...
### `def toSet[B >: Double]: immutable.Set[B]`                               ###
...
### `def flatten[B](implicit asTraversable: (Double) ⇒ GenTraversableOnce[B]): IndexedSeq[B]` ###
...
### `def transpose[B](implicit asTraversable: (Double) ⇒ GenTraversableOnce[B]): IndexedSeq[IndexedSeq[B]]` ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Double, WrappedArray[Double]]` ###
...
### `def view: IndexedSeqView[Double, WrappedArray[Double]]`                 ###
...
### `def transform(f: (Double) ⇒ Double): ofDouble.this.type`                ###
...
### `def newBuilder: Builder[Double, WrappedArray[Double]]`                  ###
...
### `def thisCollection: WrappedArray[Double]`                               ###
...
### `def toCollection(repr: WrappedArray[Double]): WrappedArray[Double]`     ###
...
--------------------------------------------------------------------------------
   Instance Constructors From scala.collection.mutable.WrappedArray.ofDouble
--------------------------------------------------------------------------------


### `new ofDouble(array: Array[Double])`                                     ###

(defined at scala.collection.mutable.WrappedArray.ofDouble)


--------------------------------------------------------------------------------
       Value Members From scala.collection.mutable.WrappedArray.ofDouble
--------------------------------------------------------------------------------
...
* Definition Classes
  * ofDouble → WrappedArray → SeqLike → GenSeqLike → Function1
...
* Definition Classes
  * ofDouble → WrappedArray → IndexedSeqLike → SeqLike
...
* Implicit information
  * This member is added by an implicit conversion from ofDouble to
    CollectionsHaveToParArray [ofDouble, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ofDouble) ⇒ GenTraversableOnce
    [T] is in scope.
* Definition Classes
