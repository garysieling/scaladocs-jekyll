...
* Implicit information
  * This member is added by an implicit conversion from IterableViewLike [A,
    Coll, This] to CollectionsHaveToParArray [IterableViewLike [A, Coll, This],
    T] performed by method CollectionsHaveToParArray in
    scala.collection.parallel. This conversion will take place only if an
    implicit value of type (IterableViewLike [A, Coll, This]) ⇒
