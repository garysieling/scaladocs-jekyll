...
* Implicit information
  * This member is added by an implicit conversion from GenericSetTemplate [A,
    CC] to CollectionsHaveToParArray [GenericSetTemplate [A, CC], T] performed
    ...
    GenericSetTemplate [A, CC]) ⇒ GenTraversableOnce [T] is in scope.
* Definition Classes
