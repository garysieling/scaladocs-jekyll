...
### `def newAppended[B >: A](that: GenTraversable[B]): IndexedSeqView.Transformed[B]` ###
...
### `def newDropped(n: Int): IndexedSeqView.Transformed[A]`                  ###
...
### `def newFlatMapped[B](f: (A) ⇒ GenTraversableOnce[B]): IndexedSeqView.Transformed[B]` ###
...
### `def newForced[B](xs: ⇒ GenSeq[B]): IndexedSeqView.Transformed[B]`       ###
...
### `def newMapped[B](f: (A) ⇒ B): IndexedSeqView.Transformed[B]`            ###
...
### `def newPatched[B >: A](_from: Int, _patch: GenSeq[B], _replaced: Int): IndexedSeqView.Transformed[B]` ###
...
### `def newPrepended[B >: A](that: GenTraversable[B]): IndexedSeqView.Transformed[B]` ###
...
### `def newTaken(n: Int): IndexedSeqView.Transformed[A]`                    ###
...
### `def newZippedAll[A1 >: A, B](that: GenIterable[B], _thisElem: A1, _thatElem: B): IndexedSeqView.Transformed[(A1, B)]` ###
...
### `def newZipped[B](that: GenIterable[B]): IndexedSeqView.Transformed[(A, B)]` ###
...
### `def flatten[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): IndexedSeqView.Transformed[B]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (A) ⇒ (A1, A2, A3)): (IndexedSeqView.Transformed[A1], IndexedSeqView.Transformed[A2], IndexedSeqView.Transformed[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (A) ⇒ (A1, A2)): (IndexedSeqView.Transformed[A1], IndexedSeqView.Transformed[A2])` ###
...
--------------------------------------------------------------------------------
      Abstract Value Members From scala.collection.mutable.IndexedSeqView
--------------------------------------------------------------------------------
...
* Definition Classes
  * IndexedSeqView → IndexedSeqLike → SeqLike
* Exceptions thrown
...
### `def transform(f: (A) ⇒ A): IndexedSeqView.this.type`                    ###
...
* Implicit information
  * This member is added by an implicit conversion from IndexedSeqView [A, Coll]
    to SeqCharSequence performed by method SeqCharSequence in scala.Predef. This
...
* Implicit information
  * This member is added by an implicit conversion from IndexedSeqView [A, Coll]
    to CollectionsHaveToParArray [IndexedSeqView [A, Coll], T] performed by
    method CollectionsHaveToParArray in scala.collection.parallel. This
    conversion will take place only if an implicit value of type (IndexedSeqView
    [A, Coll]) ⇒ GenTraversableOnce [T] is in scope.
* Definition Classes
