...
### `def appendParIterable[U >: T, PI <: IterableSplitter[U]](that: PI): Taken.Appended[U, PI]` ###
...
--------------------------------------------------------------------------------
      Value Members From scala.collection.parallel.IterableSplitter.Taken
--------------------------------------------------------------------------------


### `def takeSeq[PI <: IterableSplitter[T]](sq: scala.Seq[PI])(taker: (PI, Int) ⇒ PI): Seq[PI]` ###
...
(defined at scala.collection.parallel.IterableSplitter.Taken)
...
--------------------------------------------------------------------------------
     Instance Constructors From scala.collection.parallel.SeqSplitter.Taken
--------------------------------------------------------------------------------


### `new Taken(tk: Int)`                                                     ###

(defined at scala.collection.parallel.SeqSplitter.Taken)


--------------------------------------------------------------------------------
         Value Members From scala.collection.parallel.SeqSplitter.Taken
--------------------------------------------------------------------------------
...
* Definition Classes
  * Taken → SeqSplitter → Taken → IterableSplitter
...
* Definition Classes
  * Taken → SeqSplitter → PreciseSplitter

(defined at scala.collection.parallel.SeqSplitter.Taken)


### `def split: scala.Seq[SeqSplitter[T]]`                                   ###
...
* Definition Classes
  * Taken → SeqSplitter → PreciseSplitter → Taken → IterableSplitter → Splitter
...
* Implicit information
  * This member is added by an implicit conversion from Taken to
    CollectionsHaveToParArray [Taken, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Taken) ⇒ GenTraversableOnce [T]
    is in scope.
* Definition Classes
