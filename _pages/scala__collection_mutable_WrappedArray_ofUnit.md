...
### `def andThen[C](k: (Unit) ⇒ C): PartialFunction[Int, C]`                 ###
...
### `def applyOrElse[A1 <: Int, B1 >: Unit](x: A1, default: (A1) ⇒ B1): B1`  ###
...
### `def orElse[A1 <: Int, B1 >: Unit](that: PartialFunction[A1, B1]): PartialFunction[A1, B1]` ###
...
### `def runWith[U](action: (Unit) ⇒ U): (Int) ⇒ Boolean`                    ###
...
### `def indexOf[B >: Unit](elem: B, from: Int): Int`                        ###
...
### `def indexWhere(p: (Unit) ⇒ Boolean): Int`                               ###
...
### `def lastIndexOf[B >: Unit](elem: B): Int`                               ###
...
### `def lastIndexOf[B >: Unit](elem: B, end: Int): Int`                     ###
...
### `def lastIndexWhere(p: (Unit) ⇒ Boolean): Int`                           ###
...
### `def prefixLength(p: (Unit) ⇒ Boolean): Int`                             ###
...
### `def drop(n: Int): WrappedArray[Unit]`                                   ###
...
### `def dropRight(n: Int): WrappedArray[Unit]`                              ###
...
### `def dropWhile(p: (Unit) ⇒ Boolean): WrappedArray[Unit]`                 ###
...
### `def exists(p: (Unit) ⇒ Boolean): Boolean`                               ###
...
### `def find(p: (Unit) ⇒ Boolean): Option[Unit]`                            ###
...
### `def foldLeft[B](z: B)(op: (B, Unit) ⇒ B): B`                            ###
...
### `def foldRight[B](z: B)(op: (Unit, B) ⇒ B): B`                           ###
...
### `def forall(p: (Unit) ⇒ Boolean): Boolean`                               ###
...
### `def indexWhere(p: (Unit) ⇒ Boolean, from: Int): Int`                    ###
...
### `def lastIndexWhere(p: (Unit) ⇒ Boolean, end: Int): Int`                 ###
...
### `def reduceLeft[B >: Unit](op: (B, Unit) ⇒ B): B`                        ###
...
### `def reduceRight[B >: Unit](op: (Unit, B) ⇒ B): B`                       ###
...
### `def sameElements[B >: Unit](that: GenIterable[B]): Boolean`             ###
...
### `def segmentLength(p: (Unit) ⇒ Boolean, from: Int): Int`                 ###
...
### `def slice(from: Int, until: Int): WrappedArray[Unit]`                   ###
...
### `def span(p: (Unit) ⇒ Boolean): (WrappedArray[Unit], WrappedArray[Unit])` ###
...
### `def splitAt(n: Int): (WrappedArray[Unit], WrappedArray[Unit])`          ###
...
### `def take(n: Int): WrappedArray[Unit]`                                   ###
...
### `def takeRight(n: Int): WrappedArray[Unit]`                              ###
...
### `def takeWhile(p: (Unit) ⇒ Boolean): WrappedArray[Unit]`                 ###
...
### `def zipWithIndex[A1 >: Unit, That](implicit bf: CanBuildFrom[WrappedArray[Unit], (A1, Int), That]): That` ###
...
### `def zip[A1 >: Unit, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[WrappedArray[Unit], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[WrappedArray[Unit]]`                   ###
...
### `def sliding(size: Int): Iterator[WrappedArray[Unit]]`                   ###
...
### `def sliding(size: Int, step: Int): Iterator[WrappedArray[Unit]]`        ###
...
### `def zipAll[B, A1 >: Unit, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[WrappedArray[Unit], (A1, B), That]): That` ###
...
### `def +:[B >: Unit, That](elem: B)(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[WrappedArray[Unit]]`                 ###
...
### `def corresponds[B](that: GenSeq[B])(p: (Unit, B) ⇒ Boolean): Boolean`   ###
...
### `def diff[B >: Unit](that: GenSeq[B]): WrappedArray[Unit]`               ###
...
### `def distinct: WrappedArray[Unit]`                                       ###
...
### `def intersect[B >: Unit](that: GenSeq[B]): WrappedArray[Unit]`          ###
...
### `def padTo[B >: Unit, That](len: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def patch[B >: Unit, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def permutations: Iterator[WrappedArray[Unit]]`                         ###
...
### `def reverseMap[B, That](f: (Unit) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def sortBy[B](f: (Unit) ⇒ B)(implicit ord: math.Ordering[B]): WrappedArray[Unit]` ###
...
### `def sortWith(lt: (Unit, Unit) ⇒ Boolean): WrappedArray[Unit]`           ###
...
### `def sorted[B >: Unit](implicit ord: math.Ordering[B]): WrappedArray[Unit]` ###
...
### `def union[B >: Unit, That](that: GenSeq[B])(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def updated[B >: Unit, That](index: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def ++:[B >: Unit, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def ++:[B >: Unit, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def ++[B >: Unit, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[Unit, B])(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def filter(p: (Unit) ⇒ Boolean): WrappedArray[Unit]`                    ###
...
### `def filterNot(p: (Unit) ⇒ Boolean): WrappedArray[Unit]`                 ###
...
### `def flatMap[B, That](f: (Unit) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def groupBy[K](f: (Unit) ⇒ K): immutable.Map[K, WrappedArray[Unit]]`    ###
...
### `def inits: Iterator[WrappedArray[Unit]]`                                ###
...
### `def map[B, That](f: (Unit) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def partition(p: (Unit) ⇒ Boolean): (WrappedArray[Unit], WrappedArray[Unit])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, Unit) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Unit, B) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def scan[B >: Unit, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[WrappedArray[Unit], B, That]): That` ###
...
### `def tails: Iterator[WrappedArray[Unit]]`                                ###
...
### `def withFilter(p: (Unit) ⇒ Boolean): FilterMonadic[Unit, WrappedArray[Unit]]` ###
...
### `def aggregate[B](z: ⇒ B)(seqop: (B, Unit) ⇒ B, combop: (B, B) ⇒ B): B`  ###
...
### `def copyToArray[B >: Unit](xs: Array[B]): Unit`                         ###
...
### `def copyToArray[B >: Unit](xs: Array[B], start: Int): Unit`             ###
...
### `def fold[A1 >: Unit](z: A1)(op: (A1, A1) ⇒ A1): A1`                     ###
...
### `def reduceLeftOption[B >: Unit](op: (B, Unit) ⇒ B): Option[B]`          ###
...
### `def reduceOption[A1 >: Unit](op: (A1, A1) ⇒ A1): Option[A1]`            ###
...
### `def reduceRightOption[B >: Unit](op: (Unit, B) ⇒ B): Option[B]`         ###
...
### `def reduce[A1 >: Unit](op: (A1, A1) ⇒ A1): A1`                          ###
...
### `def toMap[T, U](implicit ev: <:<[Unit, (T, U)]): immutable.Map[T, U]`   ###
...
### `def flatten[B](implicit asTraversable: (Unit) ⇒ GenTraversableOnce[B]): IndexedSeq[B]` ###
...
### `def transpose[B](implicit asTraversable: (Unit) ⇒ GenTraversableOnce[B]): IndexedSeq[IndexedSeq[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (Unit) ⇒ (A1, A2, A3)): (IndexedSeq[A1], IndexedSeq[A2], IndexedSeq[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (Unit) ⇒ (A1, A2)): (IndexedSeq[A1], IndexedSeq[A2])` ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Unit, WrappedArray[Unit]]` ###
...
### `def view: IndexedSeqView[Unit, WrappedArray[Unit]]`                     ###
...
### `def transform(f: (Unit) ⇒ Unit): ofUnit.this.type`                      ###
...
### `def newBuilder: Builder[Unit, WrappedArray[Unit]]`                      ###
...
### `def toCollection(repr: WrappedArray[Unit]): WrappedArray[Unit]`         ###
...
--------------------------------------------------------------------------------
    Instance Constructors From scala.collection.mutable.WrappedArray.ofUnit
--------------------------------------------------------------------------------


### `new ofUnit(array: Array[Unit])`                                         ###

(defined at scala.collection.mutable.WrappedArray.ofUnit)


--------------------------------------------------------------------------------
        Value Members From scala.collection.mutable.WrappedArray.ofUnit
--------------------------------------------------------------------------------
...
* Definition Classes
  * ofUnit → WrappedArray → SeqLike → GenSeqLike → Function1
...
* Definition Classes
  * ofUnit → WrappedArray → IndexedSeqLike → SeqLike
...
* Implicit information
  * This member is added by an implicit conversion from ofUnit to
    CollectionsHaveToParArray [ofUnit, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ofUnit) ⇒ GenTraversableOnce [
    T] is in scope.
* Definition Classes
