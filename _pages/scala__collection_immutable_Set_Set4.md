...
--------------------------------------------------------------------------------
             Value Members From scala.collection.immutable.Set.Set4
--------------------------------------------------------------------------------
...
* Definition Classes
  * Set4 → SetLike → GenSetLike

(defined at scala.collection.immutable.Set.Set4)
...
* Definition Classes
  * Set4 → SetLike → Subtractable → GenSetLike
...
* Definition Classes
  * Set4 → IterableLike → TraversableLike → TraversableOnce → GenTraversableOnce
...
* Definition Classes
  * Set4 → IterableLike → GenericTraversableTemplate → TraversableLike →
...
* Definition Classes
  * Set4 → Set → TraversableOnce → GenTraversableOnce
* Annotations
...
* Implicit information
  * This member is added by an implicit conversion from Set4 [A] to
    CollectionsHaveToParArray [Set4 [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Set4 [A]) ⇒ GenTraversableOnce
    [T] is in scope.
* Definition Classes
