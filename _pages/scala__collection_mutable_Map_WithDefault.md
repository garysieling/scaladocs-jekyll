...
### `def ++=(xs: TraversableOnce[(A, B)]): WithDefault.this.type`            ###
...
### `def +=(elem1: (A, B), elem2: (A, B), elems: (A, B)*): WithDefault.this.type` ###
...
### `def --=(xs: TraversableOnce[A]): WithDefault.this.type`                 ###
...
### `def -=(elem1: A, elem2: A, elems: A*): WithDefault.this.type`           ###
...
--------------------------------------------------------------------------------
      Instance Constructors From scala.collection.mutable.Map.WithDefault
--------------------------------------------------------------------------------


### `new WithDefault(underlying: Map[A, B], d: (A) ⇒ B)`                     ###

(defined at scala.collection.mutable.Map.WithDefault)


--------------------------------------------------------------------------------
          Value Members From scala.collection.mutable.Map.WithDefault
--------------------------------------------------------------------------------


### `def +=(kv: (A, B)): WithDefault.this.type`                              ###
...
* Definition Classes
  * WithDefault → MapLike → Builder → Growable
...
* Definition Classes
  * WithDefault → MapLike → MapLike → GenMapLike
...
* Definition Classes
  * WithDefault → MapLike → MapLike → Subtractable → GenMapLike
...
* Definition Classes
  * WithDefault → MapLike → Shrinkable
...
* Definition Classes
  * WithDefault → MapLike → MapLike → GenMap
...
### `def retain(p: (A, B) ⇒ Boolean): WithDefault.this.type`                 ###
...
### `def transform(f: (A, B) ⇒ B): WithDefault.this.type`                    ###
