...
### `def concat[A](xss: collection.Traversable[A]*): Iterable[A]`            ###
...
The default builder for `immutable.Iterable` objects.

* A
  * the type of the immutable iterable collection's elements
