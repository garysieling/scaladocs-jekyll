...
* Implicit information
  * This member is added by an implicit conversion from Set [A] to
    CollectionsHaveToParArray [Set [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Set [A]) ⇒ GenTraversableOnce
    [T] is in scope.
* Definition Classes
