...
### `abstract def newBuilder: Builder[T, Array[T]]`                          ###
...
--------------------------------------------------------------------------------
         Concrete Value Members From scala.collection.mutable.ArrayOps
--------------------------------------------------------------------------------
...
### `def toCollection(repr: Array[T]): IndexedSeq[T]`                        ###
...
* Implicit information
  * This member is added by an implicit conversion from ArrayOps [T] to
    CollectionsHaveToParArray [ArrayOps [T], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ArrayOps [T]) ⇒
