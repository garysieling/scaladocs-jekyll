...
### `def slice(from: Int, until: Int): ArrayBuffer[A]`                       ###
...
### `def span(p: (A) ⇒ Boolean): (ArrayBuffer[A], ArrayBuffer[A])`           ###
...
### `def splitAt(n: Int): (ArrayBuffer[A], ArrayBuffer[A])`                  ###
...
### `def takeRight(n: Int): ArrayBuffer[A]`                                  ###
...
### `def takeWhile(p: (A) ⇒ Boolean): ArrayBuffer[A]`                        ###
...
### `def zipWithIndex[A1 >: A, That](implicit bf: CanBuildFrom[ArrayBuffer[A], (A1, Int), That]): That` ###
...
### `def zip[A1 >: A, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[ArrayBuffer[A], (A1, B), That]): That` ###
...
### `def sliding(size: Int): Iterator[ArrayBuffer[A]]`                       ###
...
### `def sliding(size: Int, step: Int): Iterator[ArrayBuffer[A]]`            ###
...
### `def zipAll[B, A1 >: A, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[ArrayBuffer[A], (A1, B), That]): That` ###
...
### `def +:[B >: A, That](elem: B)(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def diff[B >: A](that: GenSeq[B]): ArrayBuffer[A]`                      ###
...
### `def intersect[B >: A](that: GenSeq[B]): ArrayBuffer[A]`                 ###

[use case]

Computes the multiset intersection between this array buffer and another
sequence.
...
### `def padTo[B >: A, That](len: Int, elem: B)(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def patch[B >: A, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def reverseMap[B, That](f: (A) ⇒ B)(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def sortBy[B](f: (A) ⇒ B)(implicit ord: math.Ordering[B]): ArrayBuffer[A]` ###
...
### `def sortWith(lt: (A, A) ⇒ Boolean): ArrayBuffer[A]`                     ###
...
### `def sorted[B >: A](implicit ord: math.Ordering[B]): ArrayBuffer[A]`     ###
...
### `def union[B >: A, That](that: GenSeq[B])(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def updated[B >: A, That](index: Int, elem: B)(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def ++:[B >: A, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def ++[B >: A, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[A, B])(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def flatMap[B, That](f: (A) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def map[B, That](f: (A) ⇒ B)(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def scanLeft[B, That](z: B)(op: (B, A) ⇒ B)(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (A, B) ⇒ B)(implicit bf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def scan[B >: A, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[ArrayBuffer[A], B, That]): That` ###
...
### `def tails: Iterator[ArrayBuffer[A]]`                                    ###
...
### `def withFilter(p: (A) ⇒ Boolean): FilterMonadic[A, ArrayBuffer[A]]`     ###
...
### `def flatten[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): ArrayBuffer[B]` ###
...
### `def newBuilder: Builder[A, ArrayBuffer[A]]`                             ###
...
### `def transpose[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): ArrayBuffer[ArrayBuffer[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (A) ⇒ (A1, A2, A3)): (ArrayBuffer[A1], ArrayBuffer[A2], ArrayBuffer[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (A) ⇒ (A1, A2)): (ArrayBuffer[A1], ArrayBuffer[A2])` ###
...
--------------------------------------------------------------------------------
        Instance Constructors From scala.collection.mutable.ArrayBuffer
--------------------------------------------------------------------------------
...
### `def toCollection(repr: ArrayBuffer[A]): IndexedSeq[A]`                  ###
...
### `def view(from: Int, until: Int): IndexedSeqView[A, ArrayBuffer[A]]`     ###
...
### `def view: IndexedSeqView[A, ArrayBuffer[A]]`                            ###
...
* Implicit information
  * This member is added by an implicit conversion from ArrayBuffer [A] to
...
* Implicit information
  * This member is added by an implicit conversion from ArrayBuffer [A] to
    CollectionsHaveToParArray [ArrayBuffer [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ArrayBuffer [A]) ⇒
