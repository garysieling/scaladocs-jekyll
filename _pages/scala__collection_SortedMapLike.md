...
* Implicit information
  * This member is added by an implicit conversion from SortedMapLike [A, B,
    This] to CollectionsHaveToParArray [SortedMapLike [A, B, This], T] performed
    by method CollectionsHaveToParArray in scala.collection.parallel. This
    conversion will take place only if an implicit value of type (SortedMapLike
