...
--------------------------------------------------------------------------------
              Value Members From scala.collection.Map.WithDefault
--------------------------------------------------------------------------------
...
* Definition Classes
  * WithDefault → MapLike → GenMapLike
* Exceptions thrown
  *

(defined at scala.collection.Map.WithDefault)
...
--------------------------------------------------------------------------------
     Instance Constructors From scala.collection.immutable.Map.WithDefault
--------------------------------------------------------------------------------


### `new WithDefault(underlying: Map[A, B], d: (A) ⇒ B)`                     ###

(defined at scala.collection.immutable.Map.WithDefault)


--------------------------------------------------------------------------------
         Value Members From scala.collection.immutable.Map.WithDefault
--------------------------------------------------------------------------------
...
* Definition Classes
  * WithDefault → Map → MapLike → MapLike → GenMapLike
...
* Definition Classes
  * WithDefault → MapLike → Subtractable → GenMapLike

(defined at scala.collection.immutable.Map.WithDefault)


### `def empty: WithDefault[A, B]`                                           ###
...
* Definition Classes
  * WithDefault → Map → Map → MapLike

(defined at scala.collection.immutable.Map.WithDefault)


### `def updated[B1 >: B](key: A, value: B1): WithDefault[A, B1]`            ###
...
* Definition Classes
  * WithDefault → Map → MapLike → MapLike → GenMap
