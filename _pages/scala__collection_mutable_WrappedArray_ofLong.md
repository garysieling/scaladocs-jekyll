...
### `def parCombiner: Combiner[Long, ParArray[Long]]`                        ###
...
### `def lastIndexOf[B >: Long](elem: B): Int`                               ###
...
### `def prefixLength(p: (Long) ⇒ Boolean): Int`                             ###
...
### `def toBuffer[A1 >: Long]: Buffer[A1]`                                   ###
...
### `def copyToArray[B >: Long](xs: Array[B], start: Int, len: Int): Unit`   ###
...
### `def drop(n: Int): WrappedArray[Long]`                                   ###
...
### `def dropRight(n: Int): WrappedArray[Long]`                              ###
...
### `def dropWhile(p: (Long) ⇒ Boolean): WrappedArray[Long]`                 ###
...
### `def sameElements[B >: Long](that: GenIterable[B]): Boolean`             ###
...
### `def slice(from: Int, until: Int): WrappedArray[Long]`                   ###
...
### `def span(p: (Long) ⇒ Boolean): (WrappedArray[Long], WrappedArray[Long])` ###
...
### `def splitAt(n: Int): (WrappedArray[Long], WrappedArray[Long])`          ###
...
### `def take(n: Int): WrappedArray[Long]`                                   ###
...
### `def takeRight(n: Int): WrappedArray[Long]`                              ###
...
### `def takeWhile(p: (Long) ⇒ Boolean): WrappedArray[Long]`                 ###
...
### `def zipWithIndex[A1 >: Long, That](implicit bf: CanBuildFrom[WrappedArray[Long], (A1, Int), That]): That` ###
...
### `def zip[A1 >: Long, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[WrappedArray[Long], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[WrappedArray[Long]]`                   ###
...
### `def sliding(size: Int): Iterator[WrappedArray[Long]]`                   ###
...
### `def sliding(size: Int, step: Int): Iterator[WrappedArray[Long]]`        ###
...
### `def toIterable: collection.Iterable[Long]`                              ###
...
### `def zipAll[B, A1 >: Long, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[WrappedArray[Long], (A1, B), That]): That` ###
...
### `def +:[B >: Long, That](elem: B)(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[WrappedArray[Long]]`                 ###
...
### `def corresponds[B](that: GenSeq[B])(p: (Long, B) ⇒ Boolean): Boolean`   ###
...
### `def diff[B >: Long](that: GenSeq[B]): WrappedArray[Long]`               ###
...
### `def distinct: WrappedArray[Long]`                                       ###
...
### `def indexOfSlice[B >: Long](that: GenSeq[B]): Int`                      ###
...
### `def indexOfSlice[B >: Long](that: GenSeq[B], from: Int): Int`           ###
...
### `def intersect[B >: Long](that: GenSeq[B]): WrappedArray[Long]`          ###
...
### `def lastIndexOfSlice[B >: Long](that: GenSeq[B]): Int`                  ###
...
### `def lastIndexOfSlice[B >: Long](that: GenSeq[B], end: Int): Int`        ###
...
### `def padTo[B >: Long, That](len: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def patch[B >: Long, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def permutations: Iterator[WrappedArray[Long]]`                         ###
...
### `def reverseMap[B, That](f: (Long) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def sortBy[B](f: (Long) ⇒ B)(implicit ord: math.Ordering[B]): WrappedArray[Long]` ###
...
### `def sortWith(lt: (Long, Long) ⇒ Boolean): WrappedArray[Long]`           ###
...
### `def sorted[B >: Long](implicit ord: math.Ordering[B]): WrappedArray[Long]` ###
...
### `def union[B >: Long, That](that: GenSeq[B])(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def updated[B >: Long, That](index: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def ++:[B >: Long, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def ++:[B >: Long, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def ++[B >: Long, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[Long, B])(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def filter(p: (Long) ⇒ Boolean): WrappedArray[Long]`                    ###
...
### `def filterNot(p: (Long) ⇒ Boolean): WrappedArray[Long]`                 ###
...
### `def flatMap[B, That](f: (Long) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def groupBy[K](f: (Long) ⇒ K): immutable.Map[K, WrappedArray[Long]]`    ###
...
### `def inits: Iterator[WrappedArray[Long]]`                                ###
...
### `def map[B, That](f: (Long) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def partition(p: (Long) ⇒ Boolean): (WrappedArray[Long], WrappedArray[Long])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, Long) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Long, B) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def scan[B >: Long, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[WrappedArray[Long], B, That]): That` ###
...
### `def tails: Iterator[WrappedArray[Long]]`                                ###
...
### `def toTraversable: collection.Traversable[Long]`                        ###
...
### `def withFilter(p: (Long) ⇒ Boolean): FilterMonadic[Long, WrappedArray[Long]]` ###
...
### `def copyToBuffer[B >: Long](dest: Buffer[B]): Unit`                     ###
...
### `def reduceOption[A1 >: Long](op: (A1, A1) ⇒ A1): Option[A1]`            ###
...
### `def reduce[A1 >: Long](op: (A1, A1) ⇒ A1): A1`                          ###
...
### `def toMap[T, U](implicit ev: <:<[Long, (T, U)]): immutable.Map[T, U]`   ###
...
### `def flatten[B](implicit asTraversable: (Long) ⇒ GenTraversableOnce[B]): IndexedSeq[B]` ###
...
### `def transpose[B](implicit asTraversable: (Long) ⇒ GenTraversableOnce[B]): IndexedSeq[IndexedSeq[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (Long) ⇒ (A1, A2, A3)): (IndexedSeq[A1], IndexedSeq[A2], IndexedSeq[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (Long) ⇒ (A1, A2)): (IndexedSeq[A1], IndexedSeq[A2])` ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Long, WrappedArray[Long]]` ###
...
### `def view: IndexedSeqView[Long, WrappedArray[Long]]`                     ###
...
### `def transform(f: (Long) ⇒ Long): ofLong.this.type`                      ###
...
### `def newBuilder: Builder[Long, WrappedArray[Long]]`                      ###
...
### `def thisCollection: WrappedArray[Long]`                                 ###
...
### `def toCollection(repr: WrappedArray[Long]): WrappedArray[Long]`         ###
...
--------------------------------------------------------------------------------
    Instance Constructors From scala.collection.mutable.WrappedArray.ofLong
--------------------------------------------------------------------------------


### `new ofLong(array: Array[Long])`                                         ###

(defined at scala.collection.mutable.WrappedArray.ofLong)


--------------------------------------------------------------------------------
        Value Members From scala.collection.mutable.WrappedArray.ofLong
--------------------------------------------------------------------------------
...
* Definition Classes
  * ofLong → WrappedArray → SeqLike → GenSeqLike → Function1
...
* Definition Classes
  * ofLong → WrappedArray → IndexedSeqLike → SeqLike
...
* Implicit information
  * This member is added by an implicit conversion from ofLong to
    CollectionsHaveToParArray [ofLong, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ofLong) ⇒ GenTraversableOnce [
    T] is in scope.
* Definition Classes
