...
### `def bf2seq[S, That](bf: CanBuildFrom[ParMap[K, V], S, That]): CanBuildFrom[collection.Map[K, V], S, That]` ###
...
### `def sequentially[S, That <: Parallel](b: (collection.Map[K, V]) ⇒ Parallelizable[S, That]): ParMap[K, V]` ###
...
### `def view: IterableView[(K, V), collection.Map[K, V]]`                   ###
