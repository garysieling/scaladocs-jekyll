...
### `def ++=(xs: TraversableOnce[A]): Buffer.this.type`                      ###
...
### `def transform(f: (A) ⇒ A): Buffer.this.type`                            ###
...
* Implicit information
  * This member is added by an implicit conversion from Buffer [A] to
    CollectionsHaveToParArray [Buffer [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Buffer [A]) ⇒
