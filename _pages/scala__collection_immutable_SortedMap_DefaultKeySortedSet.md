...
--------------------------------------------------------------------------------
     Value Members From scala.collection.SortedMapLike.DefaultKeySortedSet
--------------------------------------------------------------------------------
...
* Definition Classes
  * DefaultKeySortedSet → Sorted

(defined at scala.collection.SortedMapLike.DefaultKeySortedSet)
...
### `def groupBy[K](f: (A) ⇒ K): Map[K, SortedSet[A]]`                       ###
...
--------------------------------------------------------------------------------
Instance Constructors From scala.collection.immutable.SortedMap.DefaultKeySortedSet
--------------------------------------------------------------------------------


### `new DefaultKeySortedSet()`                                              ###

(defined at scala.collection.immutable.SortedMap.DefaultKeySortedSet)


--------------------------------------------------------------------------------
  Value Members From scala.collection.immutable.SortedMap.DefaultKeySortedSet
--------------------------------------------------------------------------------
...
* Definition Classes
  * DefaultKeySortedSet → DefaultKeySortedSet → DefaultKeySet → SetLike →
    GenSetLike
...
* Definition Classes
  * DefaultKeySortedSet → DefaultKeySortedSet → SortedSetLike → Sorted
...
Returns this immutable sorted set as an immutable set, perhaps accepting a wider
...
* Definition Classes
  * DefaultKeySortedSet → Set → TraversableOnce → GenTraversableOnce
...
* Implicit information
  * This member is added by an implicit conversion from DefaultKeySortedSet to
    CollectionsHaveToParArray [DefaultKeySortedSet, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (DefaultKeySortedSet) ⇒
