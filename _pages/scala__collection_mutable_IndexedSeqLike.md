...
### `abstract def seq: collection.IndexedSeq[A]`                             ###
...
* Implicit information
  * This member is added by an implicit conversion from IndexedSeqLike [A, Repr]
    to CollectionsHaveToParArray [IndexedSeqLike [A, Repr], T] performed by
    method CollectionsHaveToParArray in scala.collection.parallel. This
    conversion will take place only if an implicit value of type (IndexedSeqLike
