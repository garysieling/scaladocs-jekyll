...
### `def newDropped(n: Int): Appended.Transformed[B]`                        ###
...
### `def newTaken(n: Int): Appended.Transformed[B]`                          ###
...
--------------------------------------------------------------------------------
       Concrete Value Members From scala.collection.SeqViewLike.Appended
--------------------------------------------------------------------------------
...
* Definition Classes
  * Appended → Transformed → SeqLike → GenSeqLike → Function1
* Exceptions thrown
  * IndexOutOfBoundsException if `idx` does not satisfy `0 <= idx < length` .

(defined at scala.collection.SeqViewLike.Appended)


### `lazy val restSeq: GenSeq[B]`                                            ###
...
### `def flatten[B](implicit asTraversable: (B) ⇒ GenTraversableOnce[B]): Appended.Transformed[B]` ###
