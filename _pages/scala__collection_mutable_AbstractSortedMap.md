...
### `def ++=(xs: TraversableOnce[(A, B)]): AbstractSortedMap.this.type`      ###
...
### `def +=(elem1: (A, B), elem2: (A, B), elems: (A, B)*): AbstractSortedMap.this.type` ###
...
### `def --=(xs: TraversableOnce[A]): AbstractSortedMap.this.type`           ###
...
### `def -=(elem1: A, elem2: A, elems: A*): AbstractSortedMap.this.type`     ###
...
--------------------------------------------------------------------------------
     Instance Constructors From scala.collection.mutable.AbstractSortedMap
--------------------------------------------------------------------------------


### `new AbstractSortedMap()`                                                ###

(defined at scala.collection.mutable.AbstractSortedMap)
...
### `abstract def +=(kv: (A, B)): AbstractSortedMap.this.type`               ###
...
### `abstract def -=(key: A): AbstractSortedMap.this.type`                   ###
...
### `def retain(p: (A, B) ⇒ Boolean): AbstractSortedMap.this.type`           ###
...
### `def transform(f: (A, B) ⇒ B): AbstractSortedMap.this.type`              ###
...
* Implicit information
  * This member is added by an implicit conversion from AbstractSortedMap [A, B]
    to CollectionsHaveToParArray [AbstractSortedMap [A, B], T] performed by
    ...
    AbstractSortedMap [A, B]) ⇒ GenTraversableOnce [T] is in scope.
* Definition Classes
