...
### `def indexWhere(p: ((T, S)) ⇒ Boolean): Int`                             ###
...
### `def appendParIterable[U >: (T, S), PI <: IterableSplitter[U]](that: PI): Appended[U, PI]` ###
...
### `def slice(from1: Int, until1: Int): IterableSplitter[(T, S)]`           ###
...
### `def splitWithSignalling: scala.Seq[IterableSplitter[(T, S)]]`           ###
...
### `def take(n: Int): IterableSplitter[(T, S)]`                             ###
...
--------------------------------------------------------------------------------
  Instance Constructors From scala.collection.parallel.IterableSplitter.Zipped
--------------------------------------------------------------------------------


### `new Zipped(that: SeqSplitter[S])`                                       ###
...
### `def dup: IterableSplitter[(T, S)]`                                      ###

Creates a copy of this iterator.

* Definition Classes
  * Zipped → IterableSplitter

(defined at scala.collection.parallel.IterableSplitter.Zipped)


### `def split: scala.Seq[IterableSplitter[(T, S)]]`                         ###
...
* Definition Classes
  * Zipped → IterableSplitter → Splitter
