...
### `def transform(f: (T) ⇒ T): ofRef.this.type`                             ###
...
--------------------------------------------------------------------------------
     Instance Constructors From scala.collection.mutable.WrappedArray.ofRef
--------------------------------------------------------------------------------


### `new ofRef(array: Array[T])`                                             ###

(defined at scala.collection.mutable.WrappedArray.ofRef)


--------------------------------------------------------------------------------
         Value Members From scala.collection.mutable.WrappedArray.ofRef
--------------------------------------------------------------------------------
...
* Definition Classes
  * ofRef → WrappedArray → SeqLike → GenSeqLike → Function1
...
* Definition Classes
  * ofRef → WrappedArray → IndexedSeqLike → SeqLike
