...
### `def dropRight(n: Int): Array[Float]`                                    ###
...
### `def dropWhile(p: (Float) ⇒ Boolean): Array[Float]`                      ###
...
### `def slice(from: Int, until: Int): Array[Float]`                         ###
...
### `def span(p: (Float) ⇒ Boolean): (Array[Float], Array[Float])`           ###
...
### `def splitAt(n: Int): (Array[Float], Array[Float])`                      ###
...
### `def takeRight(n: Int): Array[Float]`                                    ###
...
### `def takeWhile(p: (Float) ⇒ Boolean): Array[Float]`                      ###
...
### `def zip[A1 >: Float, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[Array[Float], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[Array[Float]]`                         ###
...
### `def sliding(size: Int): Iterator[Array[Float]]`                         ###
...
### `def sliding(size: Int, step: Int): Iterator[Array[Float]]`              ###
...
### `def zipAll[B, A1 >: Float, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[Array[Float], (A1, B), That]): That` ###
...
### `def +:[B >: Float, That](elem: B)(implicit bf: CanBuildFrom[Array[Float], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[Array[Float]]`                       ###
...
### `def diff[B >: Float](that: GenSeq[B]): Array[Float]`                    ###
...
### `def intersect[B >: Float](that: GenSeq[B]): Array[Float]`               ###
...
### `def padTo[B >: Float, That](len: Int, elem: B)(implicit bf: CanBuildFrom[Array[Float], B, That]): That` ###
...
### `def patch[B >: Float, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[Array[Float], B, That]): That` ###
...
### `def permutations: Iterator[Array[Float]]`                               ###
...
### `def sortBy[B](f: (Float) ⇒ B)(implicit ord: math.Ordering[B]): Array[Float]` ###
...
### `def sortWith(lt: (Float, Float) ⇒ Boolean): Array[Float]`               ###
...
### `def sorted[B >: Float](implicit ord: math.Ordering[B]): Array[Float]`   ###
...
### `def union[B >: Float, That](that: GenSeq[B])(implicit bf: CanBuildFrom[Array[Float], B, That]): That` ###
...
### `def updated[B >: Float, That](index: Int, elem: B)(implicit bf: CanBuildFrom[Array[Float], B, That]): That` ###
...
### `def ++:[B >: Float, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[Array[Float], B, That]): That` ###
...
### `def ++:[B >: Float, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[Array[Float], B, That]): That` ###
...
### `def ++[B >: Float, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[Array[Float], B, That]): That` ###
...
### `def filter(p: (Float) ⇒ Boolean): Array[Float]`                         ###
...
### `def filterNot(p: (Float) ⇒ Boolean): Array[Float]`                      ###
...
### `def groupBy[K](f: (Float) ⇒ K): immutable.Map[K, Array[Float]]`         ###
...
### `def inits: Iterator[Array[Float]]`                                      ###
...
### `def partition(p: (Float) ⇒ Boolean): (Array[Float], Array[Float])`      ###
...
### `def scanLeft[B, That](z: B)(op: (B, Float) ⇒ B)(implicit bf: CanBuildFrom[Array[Float], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Float, B) ⇒ B)(implicit bf: CanBuildFrom[Array[Float], B, That]): That` ###
...
### `def scan[B >: Float, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[Array[Float], B, That]): That` ###
...
### `def tails: Iterator[Array[Float]]`                                      ###
...
### `def withFilter(p: (Float) ⇒ Boolean): FilterMonadic[Float, Array[Float]]` ###
...
### `def +:[B >: Float](elem: B)(implicit arg0: ClassTag[B]): Array[B]`      ###
...
### `def copyToArray[U >: Float](xs: Array[U], start: Int, len: Int): Unit`  ###
...
### `def flatten[U](implicit asTrav: (Float) ⇒ collection.Traversable[U], m: ClassTag[U]): Array[U]` ###
...
### `def transpose[U](implicit asArray: (Float) ⇒ Array[U]): Array[Array[U]]` ###
...
### `def unzip3[T1, T2, T3](implicit asTriple: (Float) ⇒ (T1, T2, T3), ct1: ClassTag[T1], ct2: ClassTag[T2], ct3: ClassTag[T3]): (Array[T1], Array[T2], Array[T3])` ###
...
### `def unzip[T1, T2](implicit asPair: (Float) ⇒ (T1, T2), ct1: ClassTag[T1], ct2: ClassTag[T2]): (Array[T1], Array[T2])` ###
...
--------------------------------------------------------------------------------
      Instance Constructors From scala.collection.mutable.ArrayOps.ofFloat
--------------------------------------------------------------------------------


### `new ofFloat(repr: Array[Float])`                                        ###

(defined at scala.collection.mutable.ArrayOps.ofFloat)


--------------------------------------------------------------------------------
          Value Members From scala.collection.mutable.ArrayOps.ofFloat
--------------------------------------------------------------------------------
...
### `def newBuilder: ArrayBuilder.ofFloat`                                   ###
...
* Attributes
  * protected[this]
* Definition Classes
  * ofFloat → TraversableLike → HasNewBuilder
...
* Attributes
  * protected[this]
* Definition Classes
  * ofFloat → IndexedSeqLike → IndexedSeqLike → SeqLike → IterableLike →
    TraversableLike

(defined at scala.collection.mutable.ArrayOps.ofFloat)


### `def toCollection(repr: Array[Float]): WrappedArray[Float]`              ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Float, Array[Float]]`   ###
...
### `def view: IndexedSeqView[Float, Array[Float]]`                          ###
