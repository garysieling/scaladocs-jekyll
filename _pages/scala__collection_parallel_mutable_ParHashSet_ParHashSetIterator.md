...
--------------------------------------------------------------------------------
Value Members From scala.collection.parallel.mutable.ParFlatHashTable.ParFlatHashTableIterator
--------------------------------------------------------------------------------
...
* Attributes
  * protected
* Definition Classes
  * ParFlatHashTableIterator → SizeMapUtils

(defined at scala.collection.parallel.mutable.ParFlatHashTable.ParFlatHashTableIterator)
...
* Definition Classes
  * ParFlatHashTableIterator → IterableSplitter
...
* Definition Classes
  * ParFlatHashTableIterator → IterableSplitter → Splitter

(defined at scala.collection.parallel.mutable.ParFlatHashTable.ParFlatHashTableIterator)


--------------------------------------------------------------------------------
Instance Constructors From scala.collection.parallel.mutable.ParHashSet.ParHashSetIterator
--------------------------------------------------------------------------------


### `new ParHashSetIterator(start: Int, iteratesUntil: Int, totalElements: Int)` ###

(defined at scala.collection.parallel.mutable.ParHashSet.ParHashSetIterator)


--------------------------------------------------------------------------------
Value Members From scala.collection.parallel.mutable.ParHashSet.ParHashSetIterator
--------------------------------------------------------------------------------


### `def newIterator(start: Int, until: Int, total: Int): ParHashSetIterator` ###

* Definition Classes
  * ParHashSetIterator → ParFlatHashTableIterator

(defined at scala.collection.parallel.mutable.ParHashSet.ParHashSetIterator)


--------------------------------------------------------------------------------
       Value Members From scala.collection.parallel.mutable.SizeMapUtils
--------------------------------------------------------------------------------
...
* Implicit information
  * This member is added by an implicit conversion from ParHashSetIterator to
    CollectionsHaveToParArray [ParHashSetIterator, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ParHashSetIterator) ⇒
