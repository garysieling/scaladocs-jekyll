...
### `type Self = IterableView[(A1, B), Coll]`                                ###
...
### `def thisCollection: Iterable[(A1, B)]`                                  ###
...
### `def toCollection(repr: IterableView[(A1, B), Coll]): Iterable[(A1, B)]` ###
...
### `def view(from: Int, until: Int): IterableView[(A1, B), IterableView[(A1, B), Coll]]` ###
...
### `def view: IterableView[(A1, B), IterableView[(A1, B), Coll]]`           ###
...
### `def drop(n: Int): IterableView[(A1, B), Coll]`                          ###
...
### `def dropRight(n: Int): IterableView[(A1, B), Coll]`                     ###
...
### `def grouped(size: Int): Iterator[IterableView[(A1, B), Coll]]`          ###
...
### `def sliding(size: Int): Iterator[IterableView[(A1, B), Coll]]`          ###
...
### `def sliding(size: Int, step: Int): Iterator[IterableView[(A1, B), Coll]]` ###
...
### `def take(n: Int): IterableView[(A1, B), Coll]`                          ###
...
### `def takeRight(n: Int): IterableView[(A1, B), Coll]`                     ###
...
### `def zipAll[B, A1 >: (A1, B), That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[IterableView[(A1, B), Coll], (A1, B), That]): That` ###
...
### `def zip[A1 >: (A1, B), B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[IterableView[(A1, B), Coll], (A1, B), That]): That` ###
...
### `def parCombiner: Combiner[(A1, B), ParIterable[(A1, B)]]`               ###
...
### `def repr: IterableView[(A1, B), Coll]`                                  ###
...
### `def scan[B >: (A1, B), That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[IterableView[(A1, B), Coll], B, That]): That` ###
...
### `def ++:[B >: (A1, B), That](xs: Traversable[B])(implicit bf: CanBuildFrom[IterableView[(A1, B), Coll], B, That]): That` ###
...
### `def ++:[B >: (A1, B), That](xs: TraversableOnce[B])(implicit bf: CanBuildFrom[IterableView[(A1, B), Coll], B, That]): That` ###
...
### `def ++[B >: (A1, B), That](xs: GenTraversableOnce[B])(implicit bf: CanBuildFrom[IterableView[(A1, B), Coll], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[(A1, B), B])(implicit bf: CanBuildFrom[IterableView[(A1, B), Coll], B, That]): That` ###
...
### `def dropWhile(p: ((A1, B)) ⇒ Boolean): IterableView[(A1, B), Coll]`     ###
...
### `def filter(p: ((A1, B)) ⇒ Boolean): IterableView[(A1, B), Coll]`        ###
...
### `def filterNot(p: ((A1, B)) ⇒ Boolean): IterableView[(A1, B), Coll]`     ###
...
### `def flatMap[B, That](f: ((A1, B)) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[IterableView[(A1, B), Coll], B, That]): That` ###
...
### `def groupBy[K](f: ((A1, B)) ⇒ K): immutable.Map[K, IterableView[(A1, B), Coll]]` ###
...
### `def init: IterableView[(A1, B), Coll]`                                  ###
...
### `def inits: Iterator[IterableView[(A1, B), Coll]]`                       ###
...
### `def map[B, That](f: ((A1, B)) ⇒ B)(implicit bf: CanBuildFrom[IterableView[(A1, B), Coll], B, That]): That` ###
...
### `def newBuilder: Builder[(A1, B), IterableView[(A1, B), Coll]]`          ###
...
### `def partition(p: ((A1, B)) ⇒ Boolean): (IterableView[(A1, B), Coll], IterableView[(A1, B), Coll])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, (A1, B)) ⇒ B)(implicit bf: CanBuildFrom[IterableView[(A1, B), Coll], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: ((A1, B), B) ⇒ B)(implicit bf: CanBuildFrom[IterableView[(A1, B), Coll], B, That]): That` ###
...
### `def slice(from: Int, until: Int): IterableView[(A1, B), Coll]`          ###
...
### `def span(p: ((A1, B)) ⇒ Boolean): (IterableView[(A1, B), Coll], IterableView[(A1, B), Coll])` ###
...
### `def splitAt(n: Int): (IterableView[(A1, B), Coll], IterableView[(A1, B), Coll])` ###
...
### `def tail: IterableView[(A1, B), Coll]`                                  ###
...
### `def tails: Iterator[IterableView[(A1, B), Coll]]`                       ###
...
### `def takeWhile(p: ((A1, B)) ⇒ Boolean): IterableView[(A1, B), Coll]`     ###
...
### `def withFilter(p: ((A1, B)) ⇒ Boolean): IterableView[(A1, B), Coll]`    ###
...
### `def transpose[B](implicit asTraversable: ((A1, B)) ⇒ GenTraversableOnce[B]): Iterable[Iterable[B]]` ###
