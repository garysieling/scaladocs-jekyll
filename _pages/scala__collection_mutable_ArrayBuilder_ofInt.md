...
### `def +=(elem1: Int, elem2: Int, elems: Int*): ofInt.this.type`           ###
...
--------------------------------------------------------------------------------
     Instance Constructors From scala.collection.mutable.ArrayBuilder.ofInt
--------------------------------------------------------------------------------


### `new ofInt()`                                                            ###

(defined at scala.collection.mutable.ArrayBuilder.ofInt)


--------------------------------------------------------------------------------
         Value Members From scala.collection.mutable.ArrayBuilder.ofInt
--------------------------------------------------------------------------------


### `def ++=(xs: TraversableOnce[Int]): ofInt.this.type`                     ###
...
### `def mapResult[NewTo](f: (Array[Int]) ⇒ NewTo): Builder[Int, NewTo]`     ###
