...
--------------------------------------------------------------------------------
     Abstract Value Members From scala.collection.parallel.PreciseSplitter
--------------------------------------------------------------------------------


### `abstract def psplit(sizes: Int*): Seq[PreciseSplitter[T]]`              ###
...
(defined at scala.collection.parallel.PreciseSplitter)


### `abstract def split: Seq[PreciseSplitter[T]]`                            ###
...
* Implicit information
  * This member is added by an implicit conversion from PreciseSplitter [T] to
    CollectionsHaveToParArray [PreciseSplitter [T], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (PreciseSplitter [T]) ⇒
