...
### `def ++=(xs: TraversableOnce[A]): AbstractBuffer.this.type`              ###
...
### `def +=(elem1: A, elem2: A, elems: A*): AbstractBuffer.this.type`        ###
...
--------------------------------------------------------------------------------
       Instance Constructors From scala.collection.mutable.AbstractBuffer
--------------------------------------------------------------------------------


### `new AbstractBuffer()`                                                   ###

(defined at scala.collection.mutable.AbstractBuffer)
...
### `abstract def +=(elem: A): AbstractBuffer.this.type`                     ###
...
### `abstract def insertAll(n: Int, elems: collection.Traversable[A]): Unit` ###
...
### `def -=(x: A): AbstractBuffer.this.type`                                 ###
...
### `def transform(f: (A) ⇒ A): AbstractBuffer.this.type`                    ###
...
* Implicit information
  * This member is added by an implicit conversion from AbstractBuffer [A] to
    CollectionsHaveToParArray [AbstractBuffer [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (AbstractBuffer [A]) ⇒
