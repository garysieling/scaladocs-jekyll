...
--------------------------------------------------------------------------------
         Instance Constructors From scala.collection.immutable.Map.Map3
--------------------------------------------------------------------------------


### `new Map3(key1: A, value1: B, key2: A, value2: B, key3: A, value3: B)`   ###

(defined at scala.collection.immutable.Map.Map3)


--------------------------------------------------------------------------------
             Value Members From scala.collection.immutable.Map.Map3
--------------------------------------------------------------------------------
...
* Definition Classes
  * Map3 → Map → MapLike → MapLike → GenMapLike
...
* Definition Classes
  * Map3 → MapLike → Subtractable → GenMapLike
...
* Definition Classes
  * Map3 → MapLike → Function1 → GenMapLike
...
* Definition Classes
  * Map3 → IterableLike → GenericTraversableTemplate → TraversableLike →
...
* Definition Classes
  * Map3 → Map → MapLike → MapLike → GenMap
...
* Implicit information
  * This member is added by an implicit conversion from Map3 [A, B] to
    CollectionsHaveToParArray [Map3 [A, B], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Map3 [A, B]) ⇒
