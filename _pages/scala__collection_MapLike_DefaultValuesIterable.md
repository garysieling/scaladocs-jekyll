...
### `def dropRight(n: Int): Iterable[B]`                                     ###
...
### `def grouped(size: Int): Iterator[Iterable[B]]`                          ###
...
### `def slice(from: Int, until: Int): Iterable[B]`                          ###
...
### `def sliding(size: Int): Iterator[Iterable[B]]`                          ###
...
### `def sliding(size: Int, step: Int): Iterator[Iterable[B]]`               ###
...
### `def takeRight(n: Int): Iterable[B]`                                     ###
...
### `def takeWhile(p: (B) ⇒ Boolean): Iterable[B]`                           ###
...
### `def toCollection(repr: Iterable[B]): Iterable[B]`                       ###
...
### `def view(from: Int, until: Int): IterableView[B, Iterable[B]]`          ###
...
### `def view: IterableView[B, Iterable[B]]`                                 ###
...
### `def zipAll[B, A1 >: B, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[Iterable[B], (A1, B), That]): That` ###
...
### `def zip[A1 >: B, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[Iterable[B], (A1, B), That]): That` ###
...
--------------------------------------------------------------------------------
   Instance Constructors From scala.collection.MapLike.DefaultValuesIterable
--------------------------------------------------------------------------------


### `new DefaultValuesIterable()`                                            ###

(defined at scala.collection.MapLike.DefaultValuesIterable)


--------------------------------------------------------------------------------
       Value Members From scala.collection.MapLike.DefaultValuesIterable
--------------------------------------------------------------------------------
...
* Definition Classes
  * DefaultValuesIterable → IterableLike → GenericTraversableTemplate →
...
### `def ++:[B >: B, That](that: Traversable[B])(implicit bf: CanBuildFrom[Iterable[B], B, That]): That` ###
...
### `def ++:[B >: B, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[Iterable[B], B, That]): That` ###
...
### `def ++[B >: B, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[Iterable[B], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[B, B])(implicit bf: CanBuildFrom[Iterable[B], B, That]): That` ###
...
### `def dropWhile(p: (B) ⇒ Boolean): Iterable[B]`                           ###
...
### `def filter(p: (B) ⇒ Boolean): Iterable[B]`                              ###
...
### `def filterNot(p: (B) ⇒ Boolean): Iterable[B]`                           ###
...
### `def flatMap[B, That](f: (B) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[Iterable[B], B, That]): That` ###
...
### `def groupBy[K](f: (B) ⇒ K): immutable.Map[K, Iterable[B]]`              ###
...
### `def map[B, That](f: (B) ⇒ B)(implicit bf: CanBuildFrom[Iterable[B], B, That]): That` ###
...
### `def partition(p: (B) ⇒ Boolean): (Iterable[B], Iterable[B])`            ###
...
### `def scanLeft[B, That](z: B)(op: (B, B) ⇒ B)(implicit bf: CanBuildFrom[Iterable[B], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (B, B) ⇒ B)(implicit bf: CanBuildFrom[Iterable[B], B, That]): That` ###
...
### `def scan[B >: B, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[Iterable[B], B, That]): That` ###
...
### `def span(p: (B) ⇒ Boolean): (Iterable[B], Iterable[B])`                 ###
...
### `def splitAt(n: Int): (Iterable[B], Iterable[B])`                        ###
...
### `def withFilter(p: (B) ⇒ Boolean): FilterMonadic[B, Iterable[B]]`        ###
...
### `def newBuilder: Builder[B, Iterable[B]]`                                ###
...
### `def transpose[B](implicit asTraversable: (B) ⇒ GenTraversableOnce[B]): Iterable[Iterable[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (B) ⇒ (A1, A2, A3)): (Iterable[A1], Iterable[A2], Iterable[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (B) ⇒ (A1, A2)): (Iterable[A1], Iterable[A2])` ###
