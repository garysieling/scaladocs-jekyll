...
* Implicit information
  * This member is added by an implicit conversion from SeqLike [A, Repr] to
    CollectionsHaveToParArray [SeqLike [A, Repr], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (SeqLike [A, Repr]) ⇒
