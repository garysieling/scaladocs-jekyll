...
### `def toCollection(repr: This): collection.Iterable[(A, B)]`              ###
...
### `def ++:[B >: (A, B), That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[This, B, That]): That` ###
...
### `def groupBy[K](f: ((A, B)) ⇒ K): Map[K, This]`                          ###
...
--------------------------------------------------------------------------------
         Abstract Value Members From scala.collection.immutable.MapLike
--------------------------------------------------------------------------------
...
* Implicit information
  * This member is added by an implicit conversion from MapLike [A, B, This] to
    CollectionsHaveToParArray [MapLike [A, B, This], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (MapLike [A, B, This]) ⇒
