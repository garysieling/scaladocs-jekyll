...
order as this general iterable collection.
...
Returns a general iterable collection formed from this general iterable
...
* returns
  * a new general iterable collection containing pairs consisting of
    corresponding elements of this general iterable collection and `that` . The
    length of the returned collection is the maximum of the lengths of this
    general iterable collection and `that` . If this general iterable collection
    is shorter than `that` , `thisElem` values are used to pad the result. If
     `that` is shorter than this general iterable collection, `thatElem` values
...
* returns
  * a new general iterable collection containing pairs consisting of
    ...
    general iterable collection and `that` .
...
Returns a new general iterable collection containing the elements from the left
hand operand followed by the elements from the right hand operand. The element
type of the general iterable collection is the most specific superclass
...
* returns
  * a new general iterable collection which contains all elements of this
    general iterable collection followed by all elements of `that` .
...
* returns
  * a new general iterable collection resulting from applying the given
    collection-valued function `f` to each element of this general iterable
...
* returns
  * a new general iterable collection resulting from applying the given function
     `f` to each element of this general iterable collection and collecting the
    results.
...
given array `xs` with values of this general iterable collection. Copying will
...
Copies the elements of this general iterable collection to an array. Fills the
given array `xs` with values of this general iterable collection, beginning at
index `start` . Copying will stop once either the end of the current general
...
Copies the elements of this general iterable collection to an array. Fills the
given array `xs` with at most `len` elements of this general iterable collection,
...
* returns
  * the first element of this general iterable collection with the largest value
...
* f
  * The measuring function.
* returns
  * the first element of this general iterable collection with the smallest
...
Converts this general iterable collection to a map. This method is unavailable
...
* returns
  * a map of type `immutable.Map[T, U]` containing all key/value pairs of type
     `(T, U)` of this general iterable collection.
...
* Implicit information
  * This member is added by an implicit conversion from GenIterableLike [A, Repr]
    to CollectionsHaveToParArray [GenIterableLike [A, Repr], T] performed by
    ...
    GenIterableLike [A, Repr]) ⇒ GenTraversableOnce [T] is in scope.
* Definition Classes
