...
### `def drop(n: Int): WrappedArray[Int]`                                    ###
...
### `def dropRight(n: Int): WrappedArray[Int]`                               ###
...
### `def dropWhile(p: (Int) ⇒ Boolean): WrappedArray[Int]`                   ###
...
### `def slice(from: Int, until: Int): WrappedArray[Int]`                    ###
...
### `def span(p: (Int) ⇒ Boolean): (WrappedArray[Int], WrappedArray[Int])`   ###
...
### `def splitAt(n: Int): (WrappedArray[Int], WrappedArray[Int])`            ###
...
### `def take(n: Int): WrappedArray[Int]`                                    ###
...
### `def takeRight(n: Int): WrappedArray[Int]`                               ###
...
### `def takeWhile(p: (Int) ⇒ Boolean): WrappedArray[Int]`                   ###
...
### `def zipWithIndex[A1 >: Int, That](implicit bf: CanBuildFrom[WrappedArray[Int], (A1, Int), That]): That` ###
...
### `def zip[A1 >: Int, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[WrappedArray[Int], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[WrappedArray[Int]]`                    ###
...
### `def sliding(size: Int): Iterator[WrappedArray[Int]]`                    ###
...
### `def sliding(size: Int, step: Int): Iterator[WrappedArray[Int]]`         ###
...
### `def zipAll[B, A1 >: Int, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[WrappedArray[Int], (A1, B), That]): That` ###
...
### `def +:[B >: Int, That](elem: B)(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[WrappedArray[Int]]`                  ###
...
### `def diff[B >: Int](that: GenSeq[B]): WrappedArray[Int]`                 ###
...
### `def intersect[B >: Int](that: GenSeq[B]): WrappedArray[Int]`            ###
...
### `def padTo[B >: Int, That](len: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def patch[B >: Int, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def permutations: Iterator[WrappedArray[Int]]`                          ###
...
### `def reverseMap[B, That](f: (Int) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def sortBy[B](f: (Int) ⇒ B)(implicit ord: math.Ordering[B]): WrappedArray[Int]` ###
...
### `def sortWith(lt: (Int, Int) ⇒ Boolean): WrappedArray[Int]`              ###
...
### `def sorted[B >: Int](implicit ord: math.Ordering[B]): WrappedArray[Int]` ###
...
### `def union[B >: Int, That](that: GenSeq[B])(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def updated[B >: Int, That](index: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def ++:[B >: Int, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def ++:[B >: Int, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def ++[B >: Int, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[Int, B])(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def filter(p: (Int) ⇒ Boolean): WrappedArray[Int]`                      ###
...
### `def filterNot(p: (Int) ⇒ Boolean): WrappedArray[Int]`                   ###
...
### `def flatMap[B, That](f: (Int) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def groupBy[K](f: (Int) ⇒ K): immutable.Map[K, WrappedArray[Int]]`      ###
...
### `def inits: Iterator[WrappedArray[Int]]`                                 ###
...
### `def map[B, That](f: (Int) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def partition(p: (Int) ⇒ Boolean): (WrappedArray[Int], WrappedArray[Int])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, Int) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Int, B) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def scan[B >: Int, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[WrappedArray[Int], B, That]): That` ###
...
### `def tails: Iterator[WrappedArray[Int]]`                                 ###
...
### `def withFilter(p: (Int) ⇒ Boolean): FilterMonadic[Int, WrappedArray[Int]]` ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Int, WrappedArray[Int]]` ###
...
### `def view: IndexedSeqView[Int, WrappedArray[Int]]`                       ###
...
### `def transform(f: (Int) ⇒ Int): ofInt.this.type`                         ###
...
### `def newBuilder: Builder[Int, WrappedArray[Int]]`                        ###
...
### `def toCollection(repr: WrappedArray[Int]): WrappedArray[Int]`           ###
...
--------------------------------------------------------------------------------
     Instance Constructors From scala.collection.mutable.WrappedArray.ofInt
--------------------------------------------------------------------------------


### `new ofInt(array: Array[Int])`                                           ###

(defined at scala.collection.mutable.WrappedArray.ofInt)


--------------------------------------------------------------------------------
         Value Members From scala.collection.mutable.WrappedArray.ofInt
--------------------------------------------------------------------------------
...
* Definition Classes
  * ofInt → WrappedArray → SeqLike → GenSeqLike → Function1
...
* Definition Classes
  * ofInt → WrappedArray → IndexedSeqLike → SeqLike
...
* Implicit information
  * This member is added by an implicit conversion from ofInt to
    CollectionsHaveToParArray [ofInt, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ofInt) ⇒ GenTraversableOnce [T]
    is in scope.
* Definition Classes
