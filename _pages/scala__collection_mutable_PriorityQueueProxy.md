...
Copies the elements of this priority queue to an array. Fills the given array
 `xs` with at most `len` elements of this priority queue, starting at position
 `start` . Copying will stop once either the end of the current priority queue
...
Returns a priority queue formed from this priority queue and another iterable
...
* thisElem
  * the element to be used to fill up the result if this priority queue is
    shorter than `that` .
* thatElem
  * the element to be used to fill up the result if `that` is shorter than this
    priority queue.
* returns
  * a new priority queue containing pairs consisting of corresponding elements
    of this priority queue and `that` . The length of the returned collection is
    the maximum of the lengths of this priority queue and `that` . If this
    priority queue is shorter than `that` , `thisElem` values are used to pad
    the result. If `that` is shorter than this priority queue, `thatElem` values
...
* returns
  * a new priority queue containing pairs consisting of corresponding elements
    of this priority queue and `that` . The length of the returned collection is
    the minimum of the lengths of this priority queue and `that` .
...
Returns a new priority queue containing the elements from the left hand operand
followed by the elements from the right hand operand. The element type of the
priority queue is the most specific superclass encompassing the element types of
the two operands.
...
priority queue on which the function is defined.
...
Builds a new collection by applying a function to all elements of this priority
...
The type of the resulting collection is guided by the static type of priority
...
* returns
  * a new priority queue resulting from applying the given collection-valued
    function `f` to each element of this priority queue and concatenating the
    results.
...
* f
  * the function to apply to each element.
* returns
  * a new priority queue resulting from applying the given function `f` to each
    element of this priority queue and collecting the results.
...
Copies the elements of this priority queue to an array. Fills the given array
 `xs` with values of this priority queue. Copying will stop once either the end
of the current priority queue is reached, or the end of the target array is
reached.
...
Copies the elements of this priority queue to an array. Fills the given array
 `xs` with values of this priority queue, beginning at index `start` . Copying
will stop once either the end of the current priority queue is reached, or the
...
* returns
  * the first element of this priority queue with the largest value measured by
    function f.
...
* f
  * The measuring function.
* returns
  * the first element of this priority queue with the smallest value measured by
    function f.
...
Converts this priority queue to a map. This method is unavailable unless the
...
Converts this priority queue of traversable collections into a priority queue
formed by the elements of these traversable collections.

The resulting collection's type will be guided by the static type of priority
queue. For example:
...
* returns
  * a new priority queue resulting from concatenating all element priority
    queues.
...
### `def +=(elem1: A, elem2: A, elems: A*): PriorityQueueProxy.this.type`    ###
...
--------------------------------------------------------------------------------
       Concrete Value Members From scala.collection.mutable.PriorityQueue
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
    Abstract Value Members From scala.collection.mutable.PriorityQueueProxy
--------------------------------------------------------------------------------
...
* Definition Classes
  * PriorityQueueProxy → Proxy

(defined at scala.collection.mutable.PriorityQueueProxy)


--------------------------------------------------------------------------------
    Concrete Value Members From scala.collection.mutable.PriorityQueueProxy
--------------------------------------------------------------------------------


### `def ++=(it: TraversableOnce[A]): PriorityQueueProxy.this.type`          ###
...
* Definition Classes
  * PriorityQueueProxy → Growable

(defined at scala.collection.mutable.PriorityQueueProxy)


### `def +=(elem: A): PriorityQueueProxy.this.type`                          ###
...
* Definition Classes
  * PriorityQueueProxy → PriorityQueue → Builder → Growable
...
* Definition Classes
  * PriorityQueueProxy → PriorityQueue → AnyRef
...
* Definition Classes
  * PriorityQueueProxy → PriorityQueue
...
--------------------------------------------------------------------------------
     Instance Constructors From scala.collection.mutable.PriorityQueueProxy
--------------------------------------------------------------------------------


### `new PriorityQueueProxy()(implicit ord: Ordering[A])`                    ###
...
* Implicit information
  * This member is added by an implicit conversion from PriorityQueueProxy [A]
    to CollectionsHaveToParArray [PriorityQueueProxy [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (PriorityQueueProxy [A]) ⇒
