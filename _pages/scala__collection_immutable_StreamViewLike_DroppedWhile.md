...
### `def slice(from: Int, until: Int): StreamView[A, Coll]`                  ###
...
### `def takeWhile(p: (A) ⇒ Boolean): StreamView[A, Coll]`                   ###
...
### `def drop(n: Int): StreamView[A, Coll]`                                  ###
...
### `def dropRight(n: Int): StreamView[A, Coll]`                             ###
...
### `def grouped(size: Int): Iterator[StreamView[A, Coll]]`                  ###
...
### `def sliding(size: Int): Iterator[StreamView[A, Coll]]`                  ###
...
### `def sliding(size: Int, step: Int): Iterator[StreamView[A, Coll]]`       ###
...
### `def take(n: Int): StreamView[A, Coll]`                                  ###
...
### `def takeRight(n: Int): StreamView[A, Coll]`                             ###
...
### `def zipAll[B, A1 >: A, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[StreamView[A, Coll], (A1, B), That]): That` ###
...
### `def zipWithIndex[A1 >: A, That](implicit bf: CanBuildFrom[StreamView[A, Coll], (A1, Int), That]): That` ###
...
### `def zip[A1 >: A, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[StreamView[A, Coll], (A1, B), That]): That` ###
...
### `def toCollection(repr: StreamView[A, Coll]): collection.Seq[A]`         ###
...
### `def view(from: Int, until: Int): SeqView[A, StreamView[A, Coll]]`       ###
...
### `def view: SeqView[A, StreamView[A, Coll]]`                              ###
...
### `def +:[B >: A, That](elem: B)(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[StreamView[A, Coll]]`                ###
...
### `def diff[B >: A](that: GenSeq[B]): StreamView[A, Coll]`                 ###
...
### `def distinct: StreamView[A, Coll]`                                      ###
...
### `def intersect[B >: A](that: GenSeq[B]): StreamView[A, Coll]`            ###
...
### `def newDropped(n: Int): DroppedWhile.Transformed[A]`                    ###
...
### `def newTaken(n: Int): DroppedWhile.Transformed[A]`                      ###
...
### `def padTo[B >: A, That](len: Int, elem: B)(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def patch[B >: A, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def permutations: Iterator[StreamView[A, Coll]]`                        ###
...
### `def reverseMap[B, That](f: (A) ⇒ B)(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def sortBy[B](f: (A) ⇒ B)(implicit ord: Ordering[B]): StreamView[A, Coll]` ###
...
### `def sortWith(lt: (A, A) ⇒ Boolean): StreamView[A, Coll]`                ###
...
### `def sorted[B >: A](implicit ord: Ordering[B]): StreamView[A, Coll]`     ###
...
### `def union[B >: A, That](that: GenSeq[B])(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def updated[B >: A, That](index: Int, elem: B)(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
--------------------------------------------------------------------------------
     Concrete Value Members From scala.collection.SeqViewLike.DroppedWhile
--------------------------------------------------------------------------------
...
* Definition Classes
  * DroppedWhile → Transformed → SeqLike → GenSeqLike → Function1
* Exceptions thrown
  * IndexOutOfBoundsException if `idx` does not satisfy `0 <= idx < length` .

(defined at scala.collection.SeqViewLike.DroppedWhile)
...
### `def scan[B >: A, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def ++:[B >: A, That](xs: collection.Traversable[B])(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def ++:[B >: A, That](xs: TraversableOnce[B])(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def ++[B >: A, That](xs: GenTraversableOnce[B])(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[A, B])(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def dropWhile(p: (A) ⇒ Boolean): StreamView[A, Coll]`                   ###
...
### `def filter(p: (A) ⇒ Boolean): StreamView[A, Coll]`                      ###
...
### `def filterNot(p: (A) ⇒ Boolean): StreamView[A, Coll]`                   ###
...
### `def flatMap[B, That](f: (A) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def flatten[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): DroppedWhile.Transformed[B]` ###
...
### `def groupBy[K](f: (A) ⇒ K): Map[K, StreamView[A, Coll]]`                ###
...
### `def inits: Iterator[StreamView[A, Coll]]`                               ###
...
### `def map[B, That](f: (A) ⇒ B)(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def newBuilder: Builder[A, StreamView[A, Coll]]`                        ###
...
### `def partition(p: (A) ⇒ Boolean): (StreamView[A, Coll], StreamView[A, Coll])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, A) ⇒ B)(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (A, B) ⇒ B)(implicit bf: CanBuildFrom[StreamView[A, Coll], B, That]): That` ###
...
### `def span(p: (A) ⇒ Boolean): (StreamView[A, Coll], StreamView[A, Coll])` ###
...
### `def splitAt(n: Int): (StreamView[A, Coll], StreamView[A, Coll])`        ###
...
### `def tails: Iterator[StreamView[A, Coll]]`                               ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (A) ⇒ (A1, A2, A3)): (DroppedWhile.Transformed[A1], DroppedWhile.Transformed[A2], DroppedWhile.Transformed[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (A) ⇒ (A1, A2)): (DroppedWhile.Transformed[A1], DroppedWhile.Transformed[A2])` ###
...
### `def withFilter(p: (A) ⇒ Boolean): StreamView[A, Coll]`                  ###
...
--------------------------------------------------------------------------------
 Abstract Value Members From scala.collection.TraversableViewLike.DroppedWhile
--------------------------------------------------------------------------------
...
(defined at scala.collection.TraversableViewLike.DroppedWhile)
...
### `def transpose[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): collection.Seq[collection.Seq[B]]` ###
...
* Implicit information
  * This member is added by an implicit conversion from DroppedWhile to
    CollectionsHaveToParArray [DroppedWhile, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (DroppedWhile) ⇒
