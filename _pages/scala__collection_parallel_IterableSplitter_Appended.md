...
### `def indexWhere(p: (U) ⇒ Boolean): Int`                                  ###
...
### `def appendParIterable[U >: U, PI <: IterableSplitter[U]](that: PI): Appended[U, PI]` ###
...
### `def slice(from1: Int, until1: Int): IterableSplitter[U]`                ###
...
### `def splitWithSignalling: scala.Seq[IterableSplitter[U]]`                ###
...
### `def take(n: Int): IterableSplitter[U]`                                  ###
...
--------------------------------------------------------------------------------
 Instance Constructors From scala.collection.parallel.IterableSplitter.Appended
--------------------------------------------------------------------------------


### `new Appended(that: PI)`                                                 ###

(defined at scala.collection.parallel.IterableSplitter.Appended)


--------------------------------------------------------------------------------
     Value Members From scala.collection.parallel.IterableSplitter.Appended
--------------------------------------------------------------------------------


### `var curr: IterableSplitter[U]`                                          ###
...
### `def dup: IterableSplitter[U]`                                           ###

Creates a copy of this iterator.

* Definition Classes
  * Appended → IterableSplitter

(defined at scala.collection.parallel.IterableSplitter.Appended)


### `def split: scala.Seq[IterableSplitter[U]]`                              ###
...
* Definition Classes
  * Appended → IterableSplitter → Splitter
...
* Implicit information
  * This member is added by an implicit conversion from Appended [U, PI] to
    CollectionsHaveToParArray [Appended [U, PI], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Appended [U, PI]) ⇒
