...
* Implicit information
  * This member is added by an implicit conversion from SeqLike [A, This] to
    CollectionsHaveToParArray [SeqLike [A, This], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (SeqLike [A, This]) ⇒
