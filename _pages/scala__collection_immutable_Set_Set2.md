...
--------------------------------------------------------------------------------
             Value Members From scala.collection.immutable.Set.Set2
--------------------------------------------------------------------------------
...
* Definition Classes
  * Set2 → SetLike → GenSetLike

(defined at scala.collection.immutable.Set.Set2)
...
* Definition Classes
  * Set2 → SetLike → Subtractable → GenSetLike
...
* Definition Classes
  * Set2 → IterableLike → TraversableLike → TraversableOnce → GenTraversableOnce
...
* Definition Classes
  * Set2 → IterableLike → GenericTraversableTemplate → TraversableLike →
...
* Definition Classes
  * Set2 → Set → TraversableOnce → GenTraversableOnce
* Annotations
...
* Implicit information
  * This member is added by an implicit conversion from Set2 [A] to
    CollectionsHaveToParArray [Set2 [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Set2 [A]) ⇒ GenTraversableOnce
    [T] is in scope.
* Definition Classes
