...
### `def andThen[C](k: (C) ⇒ C): PartialFunction[A, C]`                      ###
...
### `def applyOrElse[A1 <: A, B1 >: C](x: A1, default: (A1) ⇒ B1): B1`       ###
...
### `def orElse[A1 <: A, B1 >: C](that: PartialFunction[A1, B1]): PartialFunction[A1, B1]` ###
...
### `def runWith[U](action: (C) ⇒ U): (A) ⇒ Boolean`                         ###
...
--------------------------------------------------------------------------------
                 Value Members From scala.collection.DefaultMap
--------------------------------------------------------------------------------


### `def +[B1 >: C](kv: (A, B1)): collection.Map[A, B1]`                     ###
...
### `def copyToArray[B >: (A, C)](xs: Array[B], start: Int, len: Int): Unit` ###
...
### `def drop(n: Int): collection.Map[A, C]`                                 ###
...
### `def dropRight(n: Int): collection.Map[A, C]`                            ###
...
### `def exists(p: ((A, C)) ⇒ Boolean): Boolean`                             ###
...
### `def find(p: ((A, C)) ⇒ Boolean): Option[(A, C)]`                        ###
...
### `def foldRight[B](z: B)(op: ((A, C), B) ⇒ B): B`                         ###
...
### `def forall(p: ((A, C)) ⇒ Boolean): Boolean`                             ###
...
### `def grouped(size: Int): Iterator[collection.Map[A, C]]`                 ###
...
### `def reduceRight[B >: (A, C)](op: ((A, C), B) ⇒ B): B`                   ###
...
### `def sameElements[B >: (A, C)](that: GenIterable[B]): Boolean`           ###
...
### `def slice(from: Int, until: Int): collection.Map[A, C]`                 ###
...
### `def sliding(size: Int): Iterator[collection.Map[A, C]]`                 ###
...
### `def sliding(size: Int, step: Int): Iterator[collection.Map[A, C]]`      ###
...
### `def take(n: Int): collection.Map[A, C]`                                 ###
...
### `def takeRight(n: Int): collection.Map[A, C]`                            ###
...
### `def takeWhile(p: ((A, C)) ⇒ Boolean): collection.Map[A, C]`             ###
...
### `def thisCollection: collection.Iterable[(A, C)]`                        ###
...
### `def toCollection(repr: collection.Map[A, C]): collection.Iterable[(A, C)]` ###
...
### `def toIterable: collection.Iterable[(A, C)]`                            ###
...
### `def toStream: immutable.Stream[(A, C)]`                                 ###
...
### `def view(from: Int, until: Int): IterableView[(A, C), collection.Map[A, C]]` ###
...
### `def view: IterableView[(A, C), collection.Map[A, C]]`                   ###
...
### `def zipAll[B, A1 >: (A, C), That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[collection.Map[A, C], (A1, B), That]): That` ###
...
### `def zipWithIndex[A1 >: (A, C), That](implicit bf: CanBuildFrom[collection.Map[A, C], (A1, Int), That]): That` ###
...
### `def zip[A1 >: (A, C), B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[collection.Map[A, C], (A1, B), That]): That` ###
...
### `def +[B1 >: C](kv1: (A, B1), kv2: (A, B1), kvs: (A, B1)*): collection.Map[A, B1]` ###
...
### `def ++[B1 >: C](xs: GenTraversableOnce[(A, B1)]): collection.Map[A, B1]` ###
...
### `def filterKeys(p: (A) ⇒ Boolean): collection.Map[A, C]`                 ###
...
### `def filterNot(p: ((A, C)) ⇒ Boolean): collection.Map[A, C]`             ###
...
### `def getOrElse[B1 >: C](key: A, default: ⇒ B1): B1`                      ###
...
### `def mapValues[C](f: (C) ⇒ C): collection.Map[A, C]`                     ###
...
### `def newBuilder: Builder[(A, C), collection.Map[A, C]]`                  ###
...
### `def parCombiner: Combiner[(A, C), ParMap[A, C]]`                        ###
...
### `def updated[B1 >: C](key: A, value: B1): collection.Map[A, B1]`         ###
...
### `def values: collection.Iterable[C]`                                     ###
...
--------------------------------------------------------------------------------
            Value Members From scala.collection.MapLike.MappedValues
--------------------------------------------------------------------------------
...
* Definition Classes
  * MappedValues → MapLike → GenMapLike

(defined at scala.collection.MapLike.MappedValues)


### `def foreach[U](g: ((A, C)) ⇒ U): Unit`                                  ###
...
* Definition Classes
  * MappedValues → IterableLike → GenericTraversableTemplate → TraversableLike →
    GenTraversableLike → TraversableOnce → GenTraversableOnce → FilterMonadic

(defined at scala.collection.MapLike.MappedValues)


### `def get(key: A): Option[C]`                                             ###
...
### `def ++:[B >: (A, C), That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[collection.Map[A, C], B, That]): That` ###
...
### `def ++:[B >: (A, C), That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[collection.Map[A, C], B, That]): That` ###
...
### `def ++[B >: (A, C), That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[collection.Map[A, C], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[(A, C), B])(implicit bf: CanBuildFrom[collection.Map[A, C], B, That]): That` ###
...
### `def dropWhile(p: ((A, C)) ⇒ Boolean): collection.Map[A, C]`             ###
...
### `def filter(p: ((A, C)) ⇒ Boolean): collection.Map[A, C]`                ###
...
### `def flatMap[B, That](f: ((A, C)) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[collection.Map[A, C], B, That]): That` ###
...
### `def groupBy[K](f: ((A, C)) ⇒ K): immutable.Map[K, collection.Map[A, C]]` ###
...
### `def inits: Iterator[collection.Map[A, C]]`                              ###
...
### `def map[B, That](f: ((A, C)) ⇒ B)(implicit bf: CanBuildFrom[collection.Map[A, C], B, That]): That` ###
...
### `def partition(p: ((A, C)) ⇒ Boolean): (collection.Map[A, C], collection.Map[A, C])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, (A, C)) ⇒ B)(implicit bf: CanBuildFrom[collection.Map[A, C], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: ((A, C), B) ⇒ B)(implicit bf: CanBuildFrom[collection.Map[A, C], B, That]): That` ###
...
### `def scan[B >: (A, C), That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[collection.Map[A, C], B, That]): That` ###
...
### `def span(p: ((A, C)) ⇒ Boolean): (collection.Map[A, C], collection.Map[A, C])` ###
...
### `def splitAt(n: Int): (collection.Map[A, C], collection.Map[A, C])`      ###
...
### `def tails: Iterator[collection.Map[A, C]]`                              ###
...
### `def toTraversable: collection.Traversable[(A, C)]`                      ###
...
### `def withFilter(p: ((A, C)) ⇒ Boolean): FilterMonadic[(A, C), collection.Map[A, C]]` ###
...
### `def aggregate[B](z: ⇒ B)(seqop: (B, (A, C)) ⇒ B, combop: (B, B) ⇒ B): B` ###
...
### `def collectFirst[B](pf: PartialFunction[(A, C), B]): Option[B]`         ###
...
### `def copyToArray[B >: (A, C)](xs: Array[B]): Unit`                       ###
...
### `def copyToArray[B >: (A, C)](xs: Array[B], start: Int): Unit`           ###
...
### `def copyToBuffer[B >: (A, C)](dest: Buffer[B]): Unit`                   ###
...
### `def foldLeft[B](z: B)(op: (B, (A, C)) ⇒ B): B`                          ###
...
### `def fold[A1 >: (A, C)](z: A1)(op: (A1, A1) ⇒ A1): A1`                   ###
...
### `def maxBy[B](f: ((A, C)) ⇒ B)(implicit cmp: Ordering[B]): (A, C)`       ###
...
### `def minBy[B](f: ((A, C)) ⇒ B)(implicit cmp: Ordering[B]): (A, C)`       ###
...
### `def reduceLeftOption[B >: (A, C)](op: (B, (A, C)) ⇒ B): Option[B]`      ###
...
### `def reduceLeft[B >: (A, C)](op: (B, (A, C)) ⇒ B): B`                    ###
...
### `def reduceOption[A1 >: (A, C)](op: (A1, A1) ⇒ A1): Option[A1]`          ###
...
### `def reduceRightOption[B >: (A, C)](op: ((A, C), B) ⇒ B): Option[B]`     ###
...
### `def reduce[A1 >: (A, C)](op: (A1, A1) ⇒ A1): A1`                        ###
...
### `def toIndexedSeq: immutable.IndexedSeq[(A, C)]`                         ###
...
### `def toMap[T, U](implicit ev: <:<[(A, C), (T, U)]): immutable.Map[T, U]` ###
...
### `def toSet[B >: (A, C)]: immutable.Set[B]`                               ###
...
### `def flatten[B](implicit asTraversable: ((A, C)) ⇒ GenTraversableOnce[B]): collection.Iterable[B]` ###
...
### `def transpose[B](implicit asTraversable: ((A, C)) ⇒ GenTraversableOnce[B]): collection.Iterable[collection.Iterable[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: ((A, C)) ⇒ (A1, A2, A3)): (collection.Iterable[A1], collection.Iterable[A2], collection.Iterable[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: ((A, C)) ⇒ (A1, A2)): (collection.Iterable[A1], collection.Iterable[A2])` ###
...
### `def -(elem1: A, elem2: A, elems: A*): collection.Map[A, C]`             ###
...
### `def --(xs: GenTraversableOnce[A]): collection.Map[A, C]`                ###
...
--------------------------------------------------------------------------------
 Instance Constructors From scala.collection.mutable.LinkedHashMap.MappedValues
--------------------------------------------------------------------------------


### `new MappedValues(f: (B) ⇒ C)`                                           ###

(defined at scala.collection.mutable.LinkedHashMap.MappedValues)


--------------------------------------------------------------------------------
     Value Members From scala.collection.mutable.LinkedHashMap.MappedValues
--------------------------------------------------------------------------------


### `def empty: LinkedHashMap[A, Nothing]`                                   ###
...
* Implicit information
  * This member is added by an implicit conversion from MappedValues [C] to
    CollectionsHaveToParArray [LinkedHashMap.MappedValues [C], T] performed by
    ...
    LinkedHashMap.MappedValues [C]) ⇒ GenTraversableOnce [T] is in scope.
* Definition Classes
