...
### `def parCombiner: Combiner[K, ParSet[K]]`                                ###
...
### `def intersect(that: GenSet[K]): ParSet[K]`                              ###
...
### `def subsetOf(that: GenSet[K]): Boolean`                                 ###
...
### `def newBuilder: Builder[K, ParSet[K]]`                                  ###
...
### `def newCombiner: Combiner[K, ParSet[K]]`                                ###
...
### `def flatten[B](implicit asTraversable: (K) ⇒ GenTraversableOnce[B]): ParSet[B]` ###

[use case]

Converts this parallel set of traversable collections into a parallel set formed
...
* returns
  * a new parallel set resulting from concatenating all element parallel set s.
...
### `def transpose[B](implicit asTraversable: (K) ⇒ GenTraversableOnce[B]): ParSet[ParSet[B]]` ###
...
### `def ++[U >: K, That](that: GenTraversableOnce[U])(implicit bf: CanBuildFrom[ParSet[K], U, That]): That` ###
...
### `def bf2seq[S, That](bf: CanBuildFrom[ParSet[K], S, That]): CanBuildFrom[Set[K], S, That]` ###
...
### `def collect[S, That](pf: PartialFunction[K, S])(implicit bf: CanBuildFrom[ParSet[K], S, That]): That` ###
...
### `def combinerFactory: CombinerFactory[K, ParSet[K]]`                     ###
...
### `def flatMap[S, That](f: (K) ⇒ GenTraversableOnce[S])(implicit bf: CanBuildFrom[ParSet[K], S, That]): That` ###
...
### `def groupBy[K](f: (K) ⇒ K): immutable.ParMap[K, ParSet[K]]`             ###
...
### `def map[S, That](f: (K) ⇒ S)(implicit bf: CanBuildFrom[ParSet[K], S, That]): That` ###
...
### `def sameElements[U >: K](that: GenIterable[U]): Boolean`                ###
...
### `def scan[U >: K, That](z: U)(op: (U, U) ⇒ U)(implicit bf: CanBuildFrom[ParSet[K], U, That]): That` ###
...
### `def scanLeft[S, That](z: S)(op: (S, K) ⇒ S)(implicit bf: CanBuildFrom[ParSet[K], S, That]): That` ###
...
### `def scanRight[S, That](z: S)(op: (K, S) ⇒ S)(implicit bf: CanBuildFrom[ParSet[K], S, That]): That` ###
...
### `def sequentially[S, That <: Parallel](b: (Set[K]) ⇒ Parallelizable[S, That]): ParSet[K]` ###
...
### `def toIterator: scala.Iterator[K]`                                      ###
...
### `def toMap[K, V](implicit ev: <:<[K, (K, V)]): immutable.ParMap[K, V]`   ###
...
### `def toParCollection[U >: K, That](cbf: () ⇒ Combiner[U, That]): That`   ###
...
### `def toParMap[K, V, That](cbf: () ⇒ Combiner[(K, V), That])(implicit ev: <:<[K, (K, V)]): That` ###
...
### `def toSet[U >: K]: immutable.ParSet[U]`                                 ###
...
### `def toTraversable: GenTraversable[K]`                                   ###
...
### `def zipAll[S, U >: K, That](that: GenIterable[S], thisElem: U, thatElem: S)(implicit bf: CanBuildFrom[ParSet[K], (U, S), That]): That` ###
...
### `def zipWithIndex[U >: K, That](implicit bf: CanBuildFrom[ParSet[K], (U, Int), That]): That` ###
...
### `def zip[U >: K, S, That](that: GenIterable[S])(implicit bf: CanBuildFrom[ParSet[K], (U, S), That]): That` ###
...
--------------------------------------------------------------------------------
 Instance Constructors From scala.collection.parallel.ParMapLike.DefaultKeySet
--------------------------------------------------------------------------------


### `new DefaultKeySet()`                                                    ###

(defined at scala.collection.parallel.ParMapLike.DefaultKeySet)


--------------------------------------------------------------------------------
     Value Members From scala.collection.parallel.ParMapLike.DefaultKeySet
--------------------------------------------------------------------------------
...
Applies a function `f` to all the elements of parallel set in an undefined
order.
...
* Definition Classes
  * DefaultKeySet → ParIterableLike → GenericTraversableTemplate →
...
* Definition Classes
  * DefaultKeySet → ParIterableLike → GenSet → GenIterable → GenTraversable →
    GenSetLike → Parallelizable → GenTraversableOnce

(defined at scala.collection.parallel.ParMapLike.DefaultKeySet)


### `def splitter: IterableSplitter[K]`                                      ###
...
The factory companion object that builds instances of class `ParSet` . (or its
 `Iterable` superclass where class `ParSet` is not a `Seq` .)

* Definition Classes
  * ParSet → ParIterable → GenericParTemplate → GenSet → GenIterable →
...
* Definition Classes
  * ParSet → ParSetLike → GenericSetTemplate
...
### `def diff(that: GenSet[K]): ParSet[K]`                                   ###
...
### `def union(that: GenSet[K]): ParSet[K]`                                  ###
