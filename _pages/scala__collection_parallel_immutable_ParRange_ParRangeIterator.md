...
### `def ++[B >: Int](that: ⇒ GenTraversableOnce[B]): Iterator[B]`           ###
...
### `def corresponds[B](that: GenTraversableOnce[B])(p: (Int, B) ⇒ Boolean): Boolean` ###
...
### `def filter(p: (Int) ⇒ Boolean): Iterator[Int]`                          ###
...
### `def flatMap[B](f: (Int) ⇒ GenTraversableOnce[B]): Iterator[B]`          ###
...
### `def padTo[A1 >: Int](len: Int, elem: A1): Iterator[A1]`                 ###
...
### `def sliding[B >: Int](size: Int, step: Int = 1): GroupedIterator[B]`    ###
...
### `def zipAll[B, A1 >: Int, B1 >: B](that: Iterator[B], thisElem: A1, thatElem: B1): Iterator[(A1, B1)]` ###
...
### `def zip[B](that: Iterator[B]): Iterator[(Int, B)]`                      ###
...
### `def copy2builder[U >: Int, Coll, Bld <: Builder[U, Coll]](b: Bld): Bld` ###
...
### `def copyToArray[U >: Int](array: Array[U], from: Int, len: Int): Unit`  ###
...
### `def drop2combiner[U >: Int, This](n: Int, cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def filter2combiner[U >: Int, This](pred: (Int) ⇒ Boolean, cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def flatmap2combiner[S, That](f: (Int) ⇒ GenTraversableOnce[S], cb: Combiner[S, That]): Combiner[S, That]` ###
...
### `def reduceLeft[U >: Int](howmany: Int, op: (U, U) ⇒ U): U`              ###
...
### `def scanToArray[U >: Int, A >: U](z: U, op: (U, U) ⇒ U, array: Array[A], from: Int): Unit` ###
...
### `def slice2combiner[U >: Int, This](from: Int, until: Int, cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def take2combiner[U >: Int, This](n: Int, cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def corresponds[S](corr: (Int, S) ⇒ Boolean)(that: scala.Iterator[S]): Boolean` ###
...
### `def indexWhere(pred: (Int) ⇒ Boolean): Int`                             ###
...
### `def lastIndexWhere(pred: (Int) ⇒ Boolean): Int`                         ###
...
### `def prefixLength(pred: (Int) ⇒ Boolean): Int`                           ###
...
### `def reverse2combiner[U >: Int, This](cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def reverseMap2combiner[S, That](f: (Int) ⇒ S, cb: Combiner[S, That]): Combiner[S, That]` ###
...
### `def updated2combiner[U >: Int, That](index: Int, elem: U, cb: Combiner[U, That]): Combiner[U, That]` ###
...
### `def appendParIterable[U >: Int, PI <: IterableSplitter[U]](that: PI): ParRangeIterator.Appended[U, PI]` ###
...
### `def drop(n: Int): IterableSplitter[Int]`                                ###
...
### `def appendParSeq[U >: Int, PI <: SeqSplitter[U]](that: PI): Appended[U, PI]` ###
...
### `def patchParSeq[U >: Int](from: Int, patchElems: SeqSplitter[U], replaced: Int): Patched[U]` ###
...
### `def psplitWithSignalling(sizes: Int*): scala.Seq[SeqSplitter[Int]]`     ###
...
### `def slice(from1: Int, until1: Int): SeqSplitter[Int]`                   ###
...
### `def splitWithSignalling: scala.Seq[SeqSplitter[Int]]`                   ###
...
### `def take(n: Int): SeqSplitter[Int]`                                     ###
...
### `def zipAllParSeq[S, U >: Int, R >: S](that: SeqSplitter[S], thisElem: U, thatElem: R): ZippedAll[U, R]` ###
...
--------------------------------------------------------------------------------
Instance Constructors From scala.collection.parallel.immutable.ParRange.ParRangeIterator
--------------------------------------------------------------------------------


### `new ParRangeIterator(range: immutable.Range = self.range)`              ###

(defined at scala.collection.parallel.immutable.ParRange.ParRangeIterator)


--------------------------------------------------------------------------------
Value Members From scala.collection.parallel.immutable.ParRange.ParRangeIterator
--------------------------------------------------------------------------------


### `def dup: ParRangeIterator`                                              ###
...
* Definition Classes
  * ParRangeIterator → Iterator → TraversableOnce → GenTraversableOnce

(defined at scala.collection.parallel.immutable.ParRange.ParRangeIterator)


### `def map2combiner[S, That](f: (Int) ⇒ S, cb: Combiner[S, That]): Combiner[S, That]` ###
...
### `def psplit(sizes: Int*): scala.Seq[SeqSplitter[Int]]`                   ###
...
* Definition Classes
  * ParRangeIterator → AugmentedIterableIterator → TraversableOnce →
    GenTraversableOnce
* Exceptions thrown
  * UnsupportedOperationException if this traversable or iterator is empty.
...
### `def split: scala.Seq[SeqSplitter[Int]]`                                 ###
...
* Definition Classes
  * ParRangeIterator → SeqSplitter → PreciseSplitter → IterableSplitter →
    Splitter
...
* Implicit information
  * This member is added by an implicit conversion from ParRangeIterator to
    CollectionsHaveToParArray [ParRangeIterator, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ParRangeIterator) ⇒
