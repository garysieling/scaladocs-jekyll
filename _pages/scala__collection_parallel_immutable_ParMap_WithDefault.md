...
--------------------------------------------------------------------------------
Instance Constructors From scala.collection.parallel.immutable.ParMap.WithDefault
--------------------------------------------------------------------------------


### `new WithDefault(underlying: ParMap[K, V], d: (K) ⇒ V)`                  ###

(defined at scala.collection.parallel.immutable.ParMap.WithDefault)


--------------------------------------------------------------------------------
   Value Members From scala.collection.parallel.immutable.ParMap.WithDefault
--------------------------------------------------------------------------------
...
* Definition Classes
  * WithDefault → ParMap → ParMap → GenMapLike
...
### `def seq: immutable.Map[K, V]`                                           ###

* Definition Classes
  * WithDefault → ParIterableLike → GenMap → GenIterable → GenTraversable →
