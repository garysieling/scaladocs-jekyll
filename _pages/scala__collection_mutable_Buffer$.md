...
### `def concat[A](xss: collection.Traversable[A]*): Buffer[A]`              ###
...
### `def fill[A](n: Int)(elem: ⇒ A): Buffer[A]`                              ###
...
### `def fill[A](n1: Int, n2: Int)(elem: ⇒ A): Buffer[Buffer[A]]`            ###
...
### `def fill[A](n1: Int, n2: Int, n3: Int)(elem: ⇒ A): Buffer[Buffer[Buffer[A]]]` ###
...
### `def fill[A](n1: Int, n2: Int, n3: Int, n4: Int)(elem: ⇒ A): Buffer[Buffer[Buffer[Buffer[A]]]]` ###
...
### `def fill[A](n1: Int, n2: Int, n3: Int, n4: Int, n5: Int)(elem: ⇒ A): Buffer[Buffer[Buffer[Buffer[Buffer[A]]]]]` ###
...
### `def iterate[A](start: A, len: Int)(f: (A) ⇒ A): Buffer[A]`              ###
...
### `def range[T](start: T, end: T)(implicit arg0: Integral[T]): Buffer[T]`  ###
...
### `def range[T](start: T, end: T, step: T)(implicit arg0: Integral[T]): Buffer[T]` ###
...
### `def tabulate[A](n: Int)(f: (Int) ⇒ A): Buffer[A]`                       ###
...
### `def tabulate[A](n1: Int, n2: Int)(f: (Int, Int) ⇒ A): Buffer[Buffer[A]]` ###
...
### `def tabulate[A](n1: Int, n2: Int, n3: Int)(f: (Int, Int, Int) ⇒ A): Buffer[Buffer[Buffer[A]]]` ###
...
### `def tabulate[A](n1: Int, n2: Int, n3: Int, n4: Int)(f: (Int, Int, Int, Int) ⇒ A): Buffer[Buffer[Buffer[Buffer[A]]]]` ###
...
### `def tabulate[A](n1: Int, n2: Int, n3: Int, n4: Int, n5: Int)(f: (Int, Int, Int, Int, Int) ⇒ A): Buffer[Buffer[Buffer[Buffer[Buffer[A]]]]]` ###
...
### `def unapplySeq[A](x: Buffer[A]): Some[Buffer[A]]`                       ###
...
The default builder for `Buffer` objects.

* A
  * the type of the buffer's elements

* Definition Classes
  * Buffer → GenericCompanion
(defined at scala.collection.mutable.Buffer)
