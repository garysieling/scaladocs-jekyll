...
--------------------------------------------------------------------------------
  Instance Constructors From scala.collection.immutable.NumericRange.Inclusive
--------------------------------------------------------------------------------


### `new Inclusive(start: T, end: T, step: T)(implicit num: Integral[T])`    ###

(defined at scala.collection.immutable.NumericRange.Inclusive)


--------------------------------------------------------------------------------
      Value Members From scala.collection.immutable.NumericRange.Inclusive
--------------------------------------------------------------------------------
...
* Definition Classes
  * Inclusive → NumericRange

(defined at scala.collection.immutable.NumericRange.Inclusive)


### `def exclusive: Exclusive[T]`                                            ###
...
* Implicit information
  * This member is added by an implicit conversion from Inclusive [T] to
...
* Implicit information
  * This member is added by an implicit conversion from Inclusive [T] to
    CollectionsHaveToParArray [Inclusive [T], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Inclusive [T]) ⇒
