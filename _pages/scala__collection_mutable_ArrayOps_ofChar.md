...
### `def dropRight(n: Int): Array[Char]`                                     ###
...
### `def dropWhile(p: (Char) ⇒ Boolean): Array[Char]`                        ###
...
### `def slice(from: Int, until: Int): Array[Char]`                          ###
...
### `def span(p: (Char) ⇒ Boolean): (Array[Char], Array[Char])`              ###
...
### `def splitAt(n: Int): (Array[Char], Array[Char])`                        ###
...
### `def takeRight(n: Int): Array[Char]`                                     ###
...
### `def takeWhile(p: (Char) ⇒ Boolean): Array[Char]`                        ###
...
### `def zip[A1 >: Char, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[Array[Char], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[Array[Char]]`                          ###
...
### `def sliding(size: Int): Iterator[Array[Char]]`                          ###
...
### `def sliding(size: Int, step: Int): Iterator[Array[Char]]`               ###
...
### `def zipAll[B, A1 >: Char, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[Array[Char], (A1, B), That]): That` ###
...
### `def +:[B >: Char, That](elem: B)(implicit bf: CanBuildFrom[Array[Char], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[Array[Char]]`                        ###
...
### `def diff[B >: Char](that: GenSeq[B]): Array[Char]`                      ###
...
### `def intersect[B >: Char](that: GenSeq[B]): Array[Char]`                 ###
...
### `def padTo[B >: Char, That](len: Int, elem: B)(implicit bf: CanBuildFrom[Array[Char], B, That]): That` ###
...
### `def patch[B >: Char, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[Array[Char], B, That]): That` ###
...
### `def permutations: Iterator[Array[Char]]`                                ###
...
### `def sortBy[B](f: (Char) ⇒ B)(implicit ord: math.Ordering[B]): Array[Char]` ###
...
### `def sortWith(lt: (Char, Char) ⇒ Boolean): Array[Char]`                  ###
...
### `def sorted[B >: Char](implicit ord: math.Ordering[B]): Array[Char]`     ###
...
### `def union[B >: Char, That](that: GenSeq[B])(implicit bf: CanBuildFrom[Array[Char], B, That]): That` ###
...
### `def updated[B >: Char, That](index: Int, elem: B)(implicit bf: CanBuildFrom[Array[Char], B, That]): That` ###
...
### `def ++:[B >: Char, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[Array[Char], B, That]): That` ###
...
### `def ++:[B >: Char, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[Array[Char], B, That]): That` ###
...
### `def ++[B >: Char, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[Array[Char], B, That]): That` ###
...
### `def filter(p: (Char) ⇒ Boolean): Array[Char]`                           ###
...
### `def filterNot(p: (Char) ⇒ Boolean): Array[Char]`                        ###
...
### `def groupBy[K](f: (Char) ⇒ K): immutable.Map[K, Array[Char]]`           ###
...
### `def partition(p: (Char) ⇒ Boolean): (Array[Char], Array[Char])`         ###
...
### `def scanLeft[B, That](z: B)(op: (B, Char) ⇒ B)(implicit bf: CanBuildFrom[Array[Char], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Char, B) ⇒ B)(implicit bf: CanBuildFrom[Array[Char], B, That]): That` ###
...
### `def scan[B >: Char, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[Array[Char], B, That]): That` ###
...
### `def withFilter(p: (Char) ⇒ Boolean): FilterMonadic[Char, Array[Char]]`  ###
...
### `def +:[B >: Char](elem: B)(implicit arg0: ClassTag[B]): Array[B]`       ###
...
### `def copyToArray[U >: Char](xs: Array[U], start: Int, len: Int): Unit`   ###
...
### `def flatten[U](implicit asTrav: (Char) ⇒ collection.Traversable[U], m: ClassTag[U]): Array[U]` ###
...
### `def transpose[U](implicit asArray: (Char) ⇒ Array[U]): Array[Array[U]]` ###
...
### `def unzip3[T1, T2, T3](implicit asTriple: (Char) ⇒ (T1, T2, T3), ct1: ClassTag[T1], ct2: ClassTag[T2], ct3: ClassTag[T3]): (Array[T1], Array[T2], Array[T3])` ###
...
### `def unzip[T1, T2](implicit asPair: (Char) ⇒ (T1, T2), ct1: ClassTag[T1], ct2: ClassTag[T2]): (Array[T1], Array[T2])` ###
...
--------------------------------------------------------------------------------
      Instance Constructors From scala.collection.mutable.ArrayOps.ofChar
--------------------------------------------------------------------------------


### `new ofChar(repr: Array[Char])`                                          ###

(defined at scala.collection.mutable.ArrayOps.ofChar)


--------------------------------------------------------------------------------
          Value Members From scala.collection.mutable.ArrayOps.ofChar
--------------------------------------------------------------------------------
...
### `def newBuilder: ArrayBuilder.ofChar`                                    ###
...
* Attributes
  * protected[this]
* Definition Classes
  * ofChar → TraversableLike → HasNewBuilder
...
* Attributes
  * protected[this]
* Definition Classes
  * ofChar → IndexedSeqLike → IndexedSeqLike → SeqLike → IterableLike →
    TraversableLike

(defined at scala.collection.mutable.ArrayOps.ofChar)


### `def toCollection(repr: Array[Char]): WrappedArray[Char]`                ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Char, Array[Char]]`     ###
...
### `def view: IndexedSeqView[Char, Array[Char]]`                            ###
