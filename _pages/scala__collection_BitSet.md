...
--------------------------------------------------------------------------------
              Concrete Value Members From scala.collection.BitSet
--------------------------------------------------------------------------------
...
* Definition Classes
  * BitSet → BitSetLike → SortedSet → SetLike → GenericSetTemplate
...
### `abstract def fromBitMaskNoCopy(elems: Array[Long]): BitSet`             ###
...
### `def toCollection(repr: BitSet): Iterable[Int]`                          ###
...
### `def ++:[B >: Int, That](that: Traversable[B])(implicit bf: CanBuildFrom[BitSet, B, That]): That` ###
