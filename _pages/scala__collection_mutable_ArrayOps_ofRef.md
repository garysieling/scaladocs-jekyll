...
### `def zip[A1 >: T, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[Array[T], (A1, B), That]): That` ###
...
### `def zipAll[B, A1 >: T, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[Array[T], (A1, B), That]): That` ###
...
### `def +:[B >: T, That](elem: B)(implicit bf: CanBuildFrom[Array[T], B, That]): That` ###
...
### `def diff[B >: T](that: GenSeq[B]): Array[T]`                            ###
...
### `def intersect[B >: T](that: GenSeq[B]): Array[T]`                       ###
...
### `def padTo[B >: T, That](len: Int, elem: B)(implicit bf: CanBuildFrom[Array[T], B, That]): That` ###
...
### `def patch[B >: T, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[Array[T], B, That]): That` ###
...
### `def union[B >: T, That](that: GenSeq[B])(implicit bf: CanBuildFrom[Array[T], B, That]): That` ###
...
### `def updated[B >: T, That](index: Int, elem: B)(implicit bf: CanBuildFrom[Array[T], B, That]): That` ###
...
### `def ++:[B >: T, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[Array[T], B, That]): That` ###
...
### `def ++[B >: T, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[Array[T], B, That]): That` ###
...
--------------------------------------------------------------------------------
       Instance Constructors From scala.collection.mutable.ArrayOps.ofRef
--------------------------------------------------------------------------------


### `new ofRef(repr: Array[T])`                                              ###

(defined at scala.collection.mutable.ArrayOps.ofRef)


--------------------------------------------------------------------------------
           Value Members From scala.collection.mutable.ArrayOps.ofRef
--------------------------------------------------------------------------------
...
### `def newBuilder: ArrayBuilder.ofRef[T]`                                  ###
...
* Attributes
  * protected[this]
* Definition Classes
  * ofRef → TraversableLike → HasNewBuilder
...
* Attributes
  * protected[this]
* Definition Classes
  * ofRef → IndexedSeqLike → IndexedSeqLike → SeqLike → IterableLike →
    TraversableLike

(defined at scala.collection.mutable.ArrayOps.ofRef)


### `def toCollection(repr: Array[T]): WrappedArray[T]`                      ###
...
* Implicit information
  * This member is added by an implicit conversion from ofRef [T] to
    CollectionsHaveToParArray [ofRef [T], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ofRef [T]) ⇒
