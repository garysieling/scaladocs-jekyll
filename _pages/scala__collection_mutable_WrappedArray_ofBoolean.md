...
### `type Self = WrappedArray[Boolean]`                                      ###
...
### `def andThen[C](k: (Boolean) ⇒ C): PartialFunction[Int, C]`              ###
...
### `def applyOrElse[A1 <: Int, B1 >: Boolean](x: A1, default: (A1) ⇒ B1): B1` ###
...
### `def orElse[A1 <: Int, B1 >: Boolean](that: PartialFunction[A1, B1]): PartialFunction[A1, B1]` ###
...
### `def runWith[U](action: (Boolean) ⇒ U): (Int) ⇒ Boolean`                 ###
...
### `def parCombiner: Combiner[Boolean, ParArray[Boolean]]`                  ###
...
### `def indexOf[B >: Boolean](elem: B): Int`                                ###
...
### `def indexOf[B >: Boolean](elem: B, from: Int): Int`                     ###
...
### `def indexWhere(p: (Boolean) ⇒ Boolean): Int`                            ###
...
### `def lastIndexOf[B >: Boolean](elem: B): Int`                            ###
...
### `def lastIndexOf[B >: Boolean](elem: B, end: Int): Int`                  ###
...
### `def lastIndexWhere(p: (Boolean) ⇒ Boolean): Int`                        ###
...
### `def prefixLength(p: (Boolean) ⇒ Boolean): Int`                          ###
...
### `def toBuffer[A1 >: Boolean]: Buffer[A1]`                                ###
...
### `def copyToArray[B >: Boolean](xs: Array[B], start: Int, len: Int): Unit` ###
...
### `def drop(n: Int): WrappedArray[Boolean]`                                ###
...
### `def dropRight(n: Int): WrappedArray[Boolean]`                           ###
...
### `def dropWhile(p: (Boolean) ⇒ Boolean): WrappedArray[Boolean]`           ###
...
### `def exists(p: (Boolean) ⇒ Boolean): Boolean`                            ###
...
### `def find(p: (Boolean) ⇒ Boolean): Option[Boolean]`                      ###
...
### `def foldLeft[B](z: B)(op: (B, Boolean) ⇒ B): B`                         ###
...
### `def foldRight[B](z: B)(op: (Boolean, B) ⇒ B): B`                        ###
...
### `def forall(p: (Boolean) ⇒ Boolean): Boolean`                            ###
...
### `def indexWhere(p: (Boolean) ⇒ Boolean, from: Int): Int`                 ###
...
### `def lastIndexWhere(p: (Boolean) ⇒ Boolean, end: Int): Int`              ###
...
### `def reduceLeft[B >: Boolean](op: (B, Boolean) ⇒ B): B`                  ###
...
### `def reduceRight[B >: Boolean](op: (Boolean, B) ⇒ B): B`                 ###
...
### `def reverse: WrappedArray[Boolean]`                                     ###
...
### `def reverseIterator: Iterator[Boolean]`                                 ###
...
### `def sameElements[B >: Boolean](that: GenIterable[B]): Boolean`          ###
...
### `def segmentLength(p: (Boolean) ⇒ Boolean, from: Int): Int`              ###
...
### `def slice(from: Int, until: Int): WrappedArray[Boolean]`                ###
...
### `def span(p: (Boolean) ⇒ Boolean): (WrappedArray[Boolean], WrappedArray[Boolean])` ###
...
### `def splitAt(n: Int): (WrappedArray[Boolean], WrappedArray[Boolean])`    ###
...
### `def take(n: Int): WrappedArray[Boolean]`                                ###
...
### `def takeRight(n: Int): WrappedArray[Boolean]`                           ###
...
### `def takeWhile(p: (Boolean) ⇒ Boolean): WrappedArray[Boolean]`           ###
...
### `def zipWithIndex[A1 >: Boolean, That](implicit bf: CanBuildFrom[WrappedArray[Boolean], (A1, Int), That]): That` ###
...
### `def zip[A1 >: Boolean, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[WrappedArray[Boolean], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[WrappedArray[Boolean]]`                ###
...
### `def sliding(size: Int): Iterator[WrappedArray[Boolean]]`                ###
...
### `def sliding(size: Int, step: Int): Iterator[WrappedArray[Boolean]]`     ###
...
### `def toIterable: collection.Iterable[Boolean]`                           ###
...
### `def toStream: immutable.Stream[Boolean]`                                ###
...
### `def zipAll[B, A1 >: Boolean, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[WrappedArray[Boolean], (A1, B), That]): That` ###
...
### `def +:[B >: Boolean, That](elem: B)(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[WrappedArray[Boolean]]`              ###
...
### `def contains[A1 >: Boolean](elem: A1): Boolean`                         ###
...
### `def corresponds[B](that: GenSeq[B])(p: (Boolean, B) ⇒ Boolean): Boolean` ###
...
### `def diff[B >: Boolean](that: GenSeq[B]): WrappedArray[Boolean]`         ###
...
### `def distinct: WrappedArray[Boolean]`                                    ###
...
### `def indexOfSlice[B >: Boolean](that: GenSeq[B]): Int`                   ###
...
### `def indexOfSlice[B >: Boolean](that: GenSeq[B], from: Int): Int`        ###
...
### `def intersect[B >: Boolean](that: GenSeq[B]): WrappedArray[Boolean]`    ###
...
### `def lastIndexOfSlice[B >: Boolean](that: GenSeq[B]): Int`               ###
...
### `def lastIndexOfSlice[B >: Boolean](that: GenSeq[B], end: Int): Int`     ###
...
### `def padTo[B >: Boolean, That](len: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def patch[B >: Boolean, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def permutations: Iterator[WrappedArray[Boolean]]`                      ###
...
### `def reverseMap[B, That](f: (Boolean) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def sortBy[B](f: (Boolean) ⇒ B)(implicit ord: math.Ordering[B]): WrappedArray[Boolean]` ###
...
### `def sortWith(lt: (Boolean, Boolean) ⇒ Boolean): WrappedArray[Boolean]`  ###
...
### `def sorted[B >: Boolean](implicit ord: math.Ordering[B]): WrappedArray[Boolean]` ###
...
### `def toSeq: collection.Seq[Boolean]`                                     ###
...
### `def union[B >: Boolean, That](that: GenSeq[B])(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def updated[B >: Boolean, That](index: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def ++:[B >: Boolean, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def ++:[B >: Boolean, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def ++[B >: Boolean, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[Boolean, B])(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def filter(p: (Boolean) ⇒ Boolean): WrappedArray[Boolean]`              ###
...
### `def filterNot(p: (Boolean) ⇒ Boolean): WrappedArray[Boolean]`           ###
...
### `def flatMap[B, That](f: (Boolean) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def groupBy[K](f: (Boolean) ⇒ K): immutable.Map[K, WrappedArray[Boolean]]` ###
...
### `def inits: Iterator[WrappedArray[Boolean]]`                             ###
...
### `def map[B, That](f: (Boolean) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def partition(p: (Boolean) ⇒ Boolean): (WrappedArray[Boolean], WrappedArray[Boolean])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, Boolean) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Boolean, B) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def scan[B >: Boolean, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[WrappedArray[Boolean], B, That]): That` ###
...
### `def tails: Iterator[WrappedArray[Boolean]]`                             ###
...
### `def toTraversable: collection.Traversable[Boolean]`                     ###
...
### `def withFilter(p: (Boolean) ⇒ Boolean): FilterMonadic[Boolean, WrappedArray[Boolean]]` ###
...
### `def aggregate[B](z: ⇒ B)(seqop: (B, Boolean) ⇒ B, combop: (B, B) ⇒ B): B` ###
...
### `def collectFirst[B](pf: PartialFunction[Boolean, B]): Option[B]`        ###
...
### `def copyToBuffer[B >: Boolean](dest: Buffer[B]): Unit`                  ###
...
### `def count(p: (Boolean) ⇒ Boolean): Int`                                 ###
...
### `def fold[A1 >: Boolean](z: A1)(op: (A1, A1) ⇒ A1): A1`                  ###
...
### `def reduceLeftOption[B >: Boolean](op: (B, Boolean) ⇒ B): Option[B]`    ###
...
### `def reduceOption[A1 >: Boolean](op: (A1, A1) ⇒ A1): Option[A1]`         ###
...
### `def reduceRightOption[B >: Boolean](op: (Boolean, B) ⇒ B): Option[B]`   ###
...
### `def reduce[A1 >: Boolean](op: (A1, A1) ⇒ A1): A1`                       ###
...
### `def toIndexedSeq: immutable.IndexedSeq[Boolean]`                        ###
...
### `def toMap[T, U](implicit ev: <:<[Boolean, (T, U)]): immutable.Map[T, U]` ###
...
### `def toSet[B >: Boolean]: immutable.Set[B]`                              ###
...
### `def flatten[B](implicit asTraversable: (Boolean) ⇒ GenTraversableOnce[B]): IndexedSeq[B]` ###
...
### `def transpose[B](implicit asTraversable: (Boolean) ⇒ GenTraversableOnce[B]): IndexedSeq[IndexedSeq[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (Boolean) ⇒ (A1, A2, A3)): (IndexedSeq[A1], IndexedSeq[A2], IndexedSeq[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (Boolean) ⇒ (A1, A2)): (IndexedSeq[A1], IndexedSeq[A2])` ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Boolean, WrappedArray[Boolean]]` ###
...
### `def view: IndexedSeqView[Boolean, WrappedArray[Boolean]]`               ###
...
### `def transform(f: (Boolean) ⇒ Boolean): ofBoolean.this.type`             ###
...
### `def clone(): WrappedArray[Boolean]`                                     ###
...
### `def newBuilder: Builder[Boolean, WrappedArray[Boolean]]`                ###
...
### `def thisCollection: WrappedArray[Boolean]`                              ###
...
### `def toCollection(repr: WrappedArray[Boolean]): WrappedArray[Boolean]`   ###
...
--------------------------------------------------------------------------------
   Instance Constructors From scala.collection.mutable.WrappedArray.ofBoolean
--------------------------------------------------------------------------------


### `new ofBoolean(array: Array[Boolean])`                                   ###

(defined at scala.collection.mutable.WrappedArray.ofBoolean)


--------------------------------------------------------------------------------
       Value Members From scala.collection.mutable.WrappedArray.ofBoolean
--------------------------------------------------------------------------------
...
* Definition Classes
  * ofBoolean → WrappedArray → SeqLike → GenSeqLike → Function1
...
* Definition Classes
  * ofBoolean → WrappedArray → IndexedSeqLike → SeqLike
...
* Implicit information
  * This member is added by an implicit conversion from ofBoolean to
    CollectionsHaveToParArray [ofBoolean, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ofBoolean) ⇒
