...
### `def parCombiner: Combiner[Char, ParArray[Char]]`                        ###
...
### `def drop(n: Int): WrappedArray[Char]`                                   ###
...
### `def dropRight(n: Int): WrappedArray[Char]`                              ###
...
### `def dropWhile(p: (Char) ⇒ Boolean): WrappedArray[Char]`                 ###
...
### `def slice(from: Int, until: Int): WrappedArray[Char]`                   ###
...
### `def span(p: (Char) ⇒ Boolean): (WrappedArray[Char], WrappedArray[Char])` ###
...
### `def splitAt(n: Int): (WrappedArray[Char], WrappedArray[Char])`          ###
...
### `def take(n: Int): WrappedArray[Char]`                                   ###
...
### `def takeRight(n: Int): WrappedArray[Char]`                              ###
...
### `def takeWhile(p: (Char) ⇒ Boolean): WrappedArray[Char]`                 ###
...
### `def zipWithIndex[A1 >: Char, That](implicit bf: CanBuildFrom[WrappedArray[Char], (A1, Int), That]): That` ###
...
### `def zip[A1 >: Char, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[WrappedArray[Char], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[WrappedArray[Char]]`                   ###
...
### `def sliding(size: Int): Iterator[WrappedArray[Char]]`                   ###
...
### `def sliding(size: Int, step: Int): Iterator[WrappedArray[Char]]`        ###
...
### `def zipAll[B, A1 >: Char, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[WrappedArray[Char], (A1, B), That]): That` ###
...
### `def +:[B >: Char, That](elem: B)(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[WrappedArray[Char]]`                 ###
...
### `def diff[B >: Char](that: GenSeq[B]): WrappedArray[Char]`               ###
...
### `def distinct: WrappedArray[Char]`                                       ###
...
### `def intersect[B >: Char](that: GenSeq[B]): WrappedArray[Char]`          ###
...
### `def padTo[B >: Char, That](len: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def patch[B >: Char, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def permutations: Iterator[WrappedArray[Char]]`                         ###
...
### `def reverseMap[B, That](f: (Char) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def sortBy[B](f: (Char) ⇒ B)(implicit ord: math.Ordering[B]): WrappedArray[Char]` ###
...
### `def sortWith(lt: (Char, Char) ⇒ Boolean): WrappedArray[Char]`           ###
...
### `def sorted[B >: Char](implicit ord: math.Ordering[B]): WrappedArray[Char]` ###
...
### `def union[B >: Char, That](that: GenSeq[B])(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def updated[B >: Char, That](index: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def ++:[B >: Char, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def ++:[B >: Char, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def ++[B >: Char, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[Char, B])(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def filter(p: (Char) ⇒ Boolean): WrappedArray[Char]`                    ###
...
### `def filterNot(p: (Char) ⇒ Boolean): WrappedArray[Char]`                 ###
...
### `def flatMap[B, That](f: (Char) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def groupBy[K](f: (Char) ⇒ K): immutable.Map[K, WrappedArray[Char]]`    ###
...
### `def inits: Iterator[WrappedArray[Char]]`                                ###
...
### `def map[B, That](f: (Char) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def partition(p: (Char) ⇒ Boolean): (WrappedArray[Char], WrappedArray[Char])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, Char) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Char, B) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def scan[B >: Char, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[WrappedArray[Char], B, That]): That` ###
...
### `def tails: Iterator[WrappedArray[Char]]`                                ###
...
### `def withFilter(p: (Char) ⇒ Boolean): FilterMonadic[Char, WrappedArray[Char]]` ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Char, WrappedArray[Char]]` ###
...
### `def view: IndexedSeqView[Char, WrappedArray[Char]]`                     ###
...
### `def transform(f: (Char) ⇒ Char): ofChar.this.type`                      ###
...
### `def newBuilder: Builder[Char, WrappedArray[Char]]`                      ###
...
### `def thisCollection: WrappedArray[Char]`                                 ###
...
### `def toCollection(repr: WrappedArray[Char]): WrappedArray[Char]`         ###
...
--------------------------------------------------------------------------------
    Instance Constructors From scala.collection.mutable.WrappedArray.ofChar
--------------------------------------------------------------------------------


### `new ofChar(array: Array[Char])`                                         ###

(defined at scala.collection.mutable.WrappedArray.ofChar)


--------------------------------------------------------------------------------
        Value Members From scala.collection.mutable.WrappedArray.ofChar
--------------------------------------------------------------------------------
...
* Definition Classes
  * ofChar → WrappedArray → SeqLike → GenSeqLike → Function1
...
* Definition Classes
  * ofChar → WrappedArray → IndexedSeqLike → SeqLike
...
* Implicit information
  * This member is added by an implicit conversion from ofChar to
    SeqCharSequence performed by method SeqCharSequence in scala.Predef.
* Definition Classes
...
* Implicit information
  * This member is added by an implicit conversion from ofChar to
    CollectionsHaveToParArray [ofChar, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ofChar) ⇒ GenTraversableOnce [
    T] is in scope.
* Definition Classes
