...
### `def newDropped(n: Int): StreamViewLike.Transformed[A]`                  ###
...
### `def newTaken(n: Int): StreamViewLike.Transformed[A]`                    ###
...
### `def ++:[B >: A, That](xs: collection.Traversable[B])(implicit bf: CanBuildFrom[This, B, That]): That` ###
...
### `def flatten[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): StreamViewLike.Transformed[B]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (A) ⇒ (A1, A2, A3)): (StreamViewLike.Transformed[A1], StreamViewLike.Transformed[A2], StreamViewLike.Transformed[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (A) ⇒ (A1, A2)): (StreamViewLike.Transformed[A1], StreamViewLike.Transformed[A2])` ###
...
* Implicit information
  * This member is added by an implicit conversion from StreamViewLike [A, Coll,
    This] to CollectionsHaveToParArray [StreamViewLike [A, Coll, This], T]
    ...
    StreamViewLike [A, Coll, This]) ⇒ GenTraversableOnce [T] is in scope.
* Definition Classes
