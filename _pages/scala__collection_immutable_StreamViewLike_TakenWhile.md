...
### `def newDropped(n: Int): TakenWhile.Transformed[A]`                      ###
...
### `def newTaken(n: Int): TakenWhile.Transformed[A]`                        ###
...
--------------------------------------------------------------------------------
      Concrete Value Members From scala.collection.SeqViewLike.TakenWhile
--------------------------------------------------------------------------------
...
* Definition Classes
  * TakenWhile → Transformed → SeqLike → GenSeqLike → Function1
* Exceptions thrown
  * IndexOutOfBoundsException if `idx` does not satisfy `0 <= idx < length` .

(defined at scala.collection.SeqViewLike.TakenWhile)
...
### `def flatten[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): TakenWhile.Transformed[B]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (A) ⇒ (A1, A2, A3)): (TakenWhile.Transformed[A1], TakenWhile.Transformed[A2], TakenWhile.Transformed[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (A) ⇒ (A1, A2)): (TakenWhile.Transformed[A1], TakenWhile.Transformed[A2])` ###
...
--------------------------------------------------------------------------------
  Abstract Value Members From scala.collection.TraversableViewLike.TakenWhile
--------------------------------------------------------------------------------
...
(defined at scala.collection.TraversableViewLike.TakenWhile)
...
* Implicit information
  * This member is added by an implicit conversion from TakenWhile to
    CollectionsHaveToParArray [TakenWhile, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (TakenWhile) ⇒
