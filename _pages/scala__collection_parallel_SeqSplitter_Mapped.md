...
### `def corresponds[S](corr: (S, S) ⇒ Boolean)(that: scala.Iterator[S]): Boolean` ###
...
### `def indexWhere(pred: (S) ⇒ Boolean): Int`                               ###
...
### `def lastIndexWhere(pred: (S) ⇒ Boolean): Int`                           ###
...
### `def prefixLength(pred: (S) ⇒ Boolean): Int`                             ###
...
### `def reverse2combiner[U >: S, This](cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def reverseMap2combiner[S, That](f: (S) ⇒ S, cb: Combiner[S, That]): Combiner[S, That]` ###
...
### `def updated2combiner[U >: S, That](index: Int, elem: U, cb: Combiner[U, That]): Combiner[U, That]` ###
...
### `def appendParIterable[U >: S, PI <: IterableSplitter[U]](that: PI): Mapped.Appended[U, PI]` ###
...
### `def appendParSeq[U >: S, PI <: SeqSplitter[U]](that: PI): Appended[U, PI]` ###
...
### `def patchParSeq[U >: S](from: Int, patchElems: SeqSplitter[U], replaced: Int): Patched[U]` ###
...
### `def psplitWithSignalling(sizes: Int*): scala.Seq[SeqSplitter[S]]`       ###
...
### `def slice(from1: Int, until1: Int): SeqSplitter[S]`                     ###
...
### `def splitWithSignalling: scala.Seq[SeqSplitter[S]]`                     ###
...
--------------------------------------------------------------------------------
    Instance Constructors From scala.collection.parallel.SeqSplitter.Mapped
--------------------------------------------------------------------------------


### `new Mapped(f: (T) ⇒ S)`                                                 ###

(defined at scala.collection.parallel.SeqSplitter.Mapped)


--------------------------------------------------------------------------------
        Value Members From scala.collection.parallel.SeqSplitter.Mapped
--------------------------------------------------------------------------------


### `def dup: SeqSplitter[S]`                                                ###

Creates a copy of this iterator.

* Definition Classes
  * Mapped → SeqSplitter → Mapped → IterableSplitter

(defined at scala.collection.parallel.SeqSplitter.Mapped)


### `def psplit(sizes: Int*): scala.Seq[SeqSplitter[S]]`                     ###
...
* Definition Classes
  * Mapped → SeqSplitter → PreciseSplitter

(defined at scala.collection.parallel.SeqSplitter.Mapped)


### `def split: scala.Seq[SeqSplitter[S]]`                                   ###
...
* Definition Classes
  * Mapped → SeqSplitter → PreciseSplitter → Mapped → IterableSplitter →
    Splitter
