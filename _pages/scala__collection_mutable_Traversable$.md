...
--------------------------------------------------------------------------------
            Value Members From scala.collection.mutable.Traversable
--------------------------------------------------------------------------------


### `implicit def canBuildFrom[A]: CanBuildFrom[Coll, A, Traversable[A]]`    ###

(defined at scala.collection.mutable.Traversable)


### `def newBuilder[A]: Builder[A, Traversable[A]]`                          ###

The default builder for `mutable.Traversable` objects.

* A
  * the type of the mutable traversable collection's elements
