...
### `def dropRight(n: Int): Array[Boolean]`                                  ###
...
### `def dropWhile(p: (Boolean) ⇒ Boolean): Array[Boolean]`                  ###
...
### `def slice(from: Int, until: Int): Array[Boolean]`                       ###
...
### `def span(p: (Boolean) ⇒ Boolean): (Array[Boolean], Array[Boolean])`     ###
...
### `def splitAt(n: Int): (Array[Boolean], Array[Boolean])`                  ###
...
### `def takeRight(n: Int): Array[Boolean]`                                  ###
...
### `def takeWhile(p: (Boolean) ⇒ Boolean): Array[Boolean]`                  ###
...
### `def zip[A1 >: Boolean, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[Array[Boolean], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[Array[Boolean]]`                       ###
...
### `def sliding(size: Int): Iterator[Array[Boolean]]`                       ###
...
### `def sliding(size: Int, step: Int): Iterator[Array[Boolean]]`            ###
...
### `def zipAll[B, A1 >: Boolean, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[Array[Boolean], (A1, B), That]): That` ###
...
### `def +:[B >: Boolean, That](elem: B)(implicit bf: CanBuildFrom[Array[Boolean], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[Array[Boolean]]`                     ###
...
### `def diff[B >: Boolean](that: GenSeq[B]): Array[Boolean]`                ###
...
### `def intersect[B >: Boolean](that: GenSeq[B]): Array[Boolean]`           ###
...
### `def padTo[B >: Boolean, That](len: Int, elem: B)(implicit bf: CanBuildFrom[Array[Boolean], B, That]): That` ###
...
### `def patch[B >: Boolean, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[Array[Boolean], B, That]): That` ###
...
### `def permutations: Iterator[Array[Boolean]]`                             ###
...
### `def sortBy[B](f: (Boolean) ⇒ B)(implicit ord: math.Ordering[B]): Array[Boolean]` ###
...
### `def sortWith(lt: (Boolean, Boolean) ⇒ Boolean): Array[Boolean]`         ###
...
### `def sorted[B >: Boolean](implicit ord: math.Ordering[B]): Array[Boolean]` ###
...
### `def union[B >: Boolean, That](that: GenSeq[B])(implicit bf: CanBuildFrom[Array[Boolean], B, That]): That` ###
...
### `def updated[B >: Boolean, That](index: Int, elem: B)(implicit bf: CanBuildFrom[Array[Boolean], B, That]): That` ###
...
### `def ++:[B >: Boolean, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[Array[Boolean], B, That]): That` ###
...
### `def ++:[B >: Boolean, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[Array[Boolean], B, That]): That` ###
...
### `def ++[B >: Boolean, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[Array[Boolean], B, That]): That` ###
...
### `def filter(p: (Boolean) ⇒ Boolean): Array[Boolean]`                     ###
...
### `def filterNot(p: (Boolean) ⇒ Boolean): Array[Boolean]`                  ###
...
### `def groupBy[K](f: (Boolean) ⇒ K): immutable.Map[K, Array[Boolean]]`     ###
...
### `def inits: Iterator[Array[Boolean]]`                                    ###
...
### `def partition(p: (Boolean) ⇒ Boolean): (Array[Boolean], Array[Boolean])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, Boolean) ⇒ B)(implicit bf: CanBuildFrom[Array[Boolean], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Boolean, B) ⇒ B)(implicit bf: CanBuildFrom[Array[Boolean], B, That]): That` ###
...
### `def scan[B >: Boolean, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[Array[Boolean], B, That]): That` ###
...
### `def tails: Iterator[Array[Boolean]]`                                    ###
...
### `def withFilter(p: (Boolean) ⇒ Boolean): FilterMonadic[Boolean, Array[Boolean]]` ###
...
### `def +:[B >: Boolean](elem: B)(implicit arg0: ClassTag[B]): Array[B]`    ###
...
### `def copyToArray[U >: Boolean](xs: Array[U], start: Int, len: Int): Unit` ###
...
### `def flatten[U](implicit asTrav: (Boolean) ⇒ collection.Traversable[U], m: ClassTag[U]): Array[U]` ###
...
### `def transpose[U](implicit asArray: (Boolean) ⇒ Array[U]): Array[Array[U]]` ###
...
### `def unzip3[T1, T2, T3](implicit asTriple: (Boolean) ⇒ (T1, T2, T3), ct1: ClassTag[T1], ct2: ClassTag[T2], ct3: ClassTag[T3]): (Array[T1], Array[T2], Array[T3])` ###
...
### `def unzip[T1, T2](implicit asPair: (Boolean) ⇒ (T1, T2), ct1: ClassTag[T1], ct2: ClassTag[T2]): (Array[T1], Array[T2])` ###
...
--------------------------------------------------------------------------------
     Instance Constructors From scala.collection.mutable.ArrayOps.ofBoolean
--------------------------------------------------------------------------------


### `new ofBoolean(repr: Array[Boolean])`                                    ###

(defined at scala.collection.mutable.ArrayOps.ofBoolean)


--------------------------------------------------------------------------------
         Value Members From scala.collection.mutable.ArrayOps.ofBoolean
--------------------------------------------------------------------------------
...
### `def newBuilder: ArrayBuilder.ofBoolean`                                 ###
...
* Attributes
  * protected[this]
* Definition Classes
  * ofBoolean → TraversableLike → HasNewBuilder
...
* Attributes
  * protected[this]
* Definition Classes
  * ofBoolean → IndexedSeqLike → IndexedSeqLike → SeqLike → IterableLike →
    TraversableLike

(defined at scala.collection.mutable.ArrayOps.ofBoolean)


### `def toCollection(repr: Array[Boolean]): WrappedArray[Boolean]`          ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Boolean, Array[Boolean]]` ###
...
### `def view: IndexedSeqView[Boolean, Array[Boolean]]`                      ###
