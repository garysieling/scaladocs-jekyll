...
Copies the elements of this immutable iterable collection to an array. Fills the
given array `xs` with at most `len` elements of this immutable iterable
collection, starting at position `start` . Copying will stop once either the end
of the current immutable iterable collection is reached, or the end of the
...
order as this immutable iterable collection.
...
Returns a immutable iterable collection formed from this immutable iterable
collection and another iterable collection by combining corresponding elements
in pairs. If one of the two collections is shorter than the other, placeholder
...
* thisElem
  * the element to be used to fill up the result if this immutable iterable
    collection is shorter than `that` .
* thatElem
  * the element to be used to fill up the result if `that` is shorter than this
    immutable iterable collection.
* returns
  * a new immutable iterable collection containing pairs consisting of
    corresponding elements of this immutable iterable collection and `that` .
    The length of the returned collection is the maximum of the lengths of this
    immutable iterable collection and `that` . If this immutable iterable
    collection is shorter than `that` , `thisElem` values are used to pad the
    result. If `that` is shorter than this immutable iterable collection,
...
Zips this immutable iterable collection with its indices.

Note: might return different results for different runs, unless the underlying
collection type is ordered.

* returns
  * A new immutable iterable collection containing pairs consisting of all
    elements of this immutable iterable collection paired with their index.
    Indices start at `0` .
...
Returns a immutable iterable collection formed from this immutable iterable
collection and another iterable collection by combining corresponding elements
in pairs. If one of the two collections is longer than the other, its remaining
...
* returns
  * a new immutable iterable collection containing pairs consisting of
    corresponding elements of this immutable iterable collection and `that` .
    The length of the returned collection is the minimum of the lengths of this
    immutable iterable collection and `that` .
...
* that
  * the traversable to append.
* returns
  * a new immutable iterable collection which contains all elements of this
    immutable iterable collection followed by all elements of `that` .
...
Returns a new immutable iterable collection containing the elements from the
left hand operand followed by the elements from the right hand operand. The
element type of the immutable iterable collection is the most specific
...
immutable iterable collection on which the function is defined.

* B
  * the element type of the returned collection.
* pf
  * the partial function which filters and maps the immutable iterable
    collection.
* returns
  * a new immutable iterable collection resulting from applying the given
    partial function `pf` to each element on which it is defined and collecting
    the results. The order of the elements is preserved.
...
iterable collection and using the elements of the resulting collections.
...
iterable collection. This might cause unexpected results sometimes. For example:
...
* returns
  * a new immutable iterable collection resulting from applying the given
    collection-valued function `f` to each element of this immutable iterable
...
* returns
  * a new immutable iterable collection resulting from applying the given
    function `f` to each element of this immutable iterable collection and
...
Copies the elements of this immutable iterable collection to an array. Fills the
given array `xs` with values of this immutable iterable collection. Copying will
stop once either the end of the current immutable iterable collection is
...
Copies the elements of this immutable iterable collection to an array. Fills the
given array `xs` with values of this immutable iterable collection, beginning at
...
* returns
  * the first element of this immutable iterable collection with the largest
...
* f
  * The measuring function.
* returns
  * the first element of this immutable iterable collection with the smallest
    value measured by function f.
...
Converts this immutable iterable collection to a map. This method is unavailable
...
* returns
  * a map of type `immutable.Map[T, U]` containing all key/value pairs of type
     `(T, U)` of this immutable iterable collection.
...
Converts this immutable iterable collection of traversable collections into a
immutable iterable collection formed by the elements of these traversable
collections.
...
* returns
  * a new immutable iterable collection resulting from concatenating all element
    immutable iterable collections.
...
--------------------------------------------------------------------------------
        Concrete Value Members From scala.collection.immutable.Iterable
--------------------------------------------------------------------------------
...
* Implicit information
  * This member is added by an implicit conversion from Iterable [A] to
    CollectionsHaveToParArray [Iterable [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Iterable [A]) ⇒
