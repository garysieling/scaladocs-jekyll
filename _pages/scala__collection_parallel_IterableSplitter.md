...
* Implicit information
  * This member is added by an implicit conversion from IterableSplitter [T] to
    CollectionsHaveToParArray [IterableSplitter [T], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (IterableSplitter [T]) ⇒
