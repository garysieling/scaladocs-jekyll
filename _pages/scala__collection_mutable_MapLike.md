...
### `def ++=(xs: TraversableOnce[(A, B)]): MapLike.this.type`                ###
...
### `def +=(elem1: (A, B), elem2: (A, B), elems: (A, B)*): MapLike.this.type` ###
...
### `def --=(xs: TraversableOnce[A]): MapLike.this.type`                     ###
...
### `def -=(elem1: A, elem2: A, elems: A*): MapLike.this.type`               ###
...
### `def mapResult[NewTo](f: (This) ⇒ NewTo): Builder[(A, B), NewTo]`        ###
...
### `abstract def +=(kv: (A, B)): MapLike.this.type`                         ###
...
### `abstract def -=(key: A): MapLike.this.type`                             ###
