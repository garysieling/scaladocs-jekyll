...
### `def indexWhere(pred: (U) ⇒ Boolean): Int`                               ###
...
### `def appendParIterable[U >: U, PI <: IterableSplitter[U]](that: PI): Appended.Appended[U, PI]` ###
...
--------------------------------------------------------------------------------
   Instance Constructors From scala.collection.parallel.SeqSplitter.Appended
--------------------------------------------------------------------------------


### `new Appended(it: PI)`                                                   ###

(defined at scala.collection.parallel.SeqSplitter.Appended)


--------------------------------------------------------------------------------
       Value Members From scala.collection.parallel.SeqSplitter.Appended
--------------------------------------------------------------------------------
...
* Definition Classes
  * Appended → SeqSplitter → Appended → IterableSplitter
...
* Definition Classes
  * Appended → SeqSplitter → PreciseSplitter
...
* Definition Classes
  * Appended → SeqSplitter → PreciseSplitter → Appended → IterableSplitter →
    Splitter
