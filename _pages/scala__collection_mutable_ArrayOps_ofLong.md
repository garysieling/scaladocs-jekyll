...
### `def dropRight(n: Int): Array[Long]`                                     ###
...
### `def dropWhile(p: (Long) ⇒ Boolean): Array[Long]`                        ###
...
### `def slice(from: Int, until: Int): Array[Long]`                          ###
...
### `def span(p: (Long) ⇒ Boolean): (Array[Long], Array[Long])`              ###
...
### `def splitAt(n: Int): (Array[Long], Array[Long])`                        ###
...
### `def takeRight(n: Int): Array[Long]`                                     ###
...
### `def takeWhile(p: (Long) ⇒ Boolean): Array[Long]`                        ###
...
### `def zip[A1 >: Long, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[Array[Long], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[Array[Long]]`                          ###
...
### `def sliding(size: Int): Iterator[Array[Long]]`                          ###
...
### `def sliding(size: Int, step: Int): Iterator[Array[Long]]`               ###
...
### `def zipAll[B, A1 >: Long, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[Array[Long], (A1, B), That]): That` ###
...
### `def +:[B >: Long, That](elem: B)(implicit bf: CanBuildFrom[Array[Long], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[Array[Long]]`                        ###
...
### `def diff[B >: Long](that: GenSeq[B]): Array[Long]`                      ###
...
### `def intersect[B >: Long](that: GenSeq[B]): Array[Long]`                 ###
...
### `def padTo[B >: Long, That](len: Int, elem: B)(implicit bf: CanBuildFrom[Array[Long], B, That]): That` ###
...
### `def patch[B >: Long, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[Array[Long], B, That]): That` ###
...
### `def permutations: Iterator[Array[Long]]`                                ###
...
### `def sortBy[B](f: (Long) ⇒ B)(implicit ord: math.Ordering[B]): Array[Long]` ###
...
### `def sortWith(lt: (Long, Long) ⇒ Boolean): Array[Long]`                  ###
...
### `def sorted[B >: Long](implicit ord: math.Ordering[B]): Array[Long]`     ###
...
### `def union[B >: Long, That](that: GenSeq[B])(implicit bf: CanBuildFrom[Array[Long], B, That]): That` ###
...
### `def updated[B >: Long, That](index: Int, elem: B)(implicit bf: CanBuildFrom[Array[Long], B, That]): That` ###
...
### `def ++:[B >: Long, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[Array[Long], B, That]): That` ###
...
### `def ++:[B >: Long, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[Array[Long], B, That]): That` ###
...
### `def ++[B >: Long, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[Array[Long], B, That]): That` ###
...
### `def filter(p: (Long) ⇒ Boolean): Array[Long]`                           ###
...
### `def filterNot(p: (Long) ⇒ Boolean): Array[Long]`                        ###
...
### `def groupBy[K](f: (Long) ⇒ K): immutable.Map[K, Array[Long]]`           ###
...
### `def partition(p: (Long) ⇒ Boolean): (Array[Long], Array[Long])`         ###
...
### `def scanLeft[B, That](z: B)(op: (B, Long) ⇒ B)(implicit bf: CanBuildFrom[Array[Long], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Long, B) ⇒ B)(implicit bf: CanBuildFrom[Array[Long], B, That]): That` ###
...
### `def scan[B >: Long, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[Array[Long], B, That]): That` ###
...
### `def withFilter(p: (Long) ⇒ Boolean): FilterMonadic[Long, Array[Long]]`  ###
...
### `def +:[B >: Long](elem: B)(implicit arg0: ClassTag[B]): Array[B]`       ###
...
### `def copyToArray[U >: Long](xs: Array[U], start: Int, len: Int): Unit`   ###
...
### `def flatten[U](implicit asTrav: (Long) ⇒ collection.Traversable[U], m: ClassTag[U]): Array[U]` ###
...
### `def transpose[U](implicit asArray: (Long) ⇒ Array[U]): Array[Array[U]]` ###
...
### `def unzip3[T1, T2, T3](implicit asTriple: (Long) ⇒ (T1, T2, T3), ct1: ClassTag[T1], ct2: ClassTag[T2], ct3: ClassTag[T3]): (Array[T1], Array[T2], Array[T3])` ###
...
### `def unzip[T1, T2](implicit asPair: (Long) ⇒ (T1, T2), ct1: ClassTag[T1], ct2: ClassTag[T2]): (Array[T1], Array[T2])` ###
...
--------------------------------------------------------------------------------
      Instance Constructors From scala.collection.mutable.ArrayOps.ofLong
--------------------------------------------------------------------------------


### `new ofLong(repr: Array[Long])`                                          ###

(defined at scala.collection.mutable.ArrayOps.ofLong)


--------------------------------------------------------------------------------
          Value Members From scala.collection.mutable.ArrayOps.ofLong
--------------------------------------------------------------------------------
...
### `def newBuilder: ArrayBuilder.ofLong`                                    ###
...
* Attributes
  * protected[this]
* Definition Classes
  * ofLong → TraversableLike → HasNewBuilder
...
* Attributes
  * protected[this]
* Definition Classes
  * ofLong → IndexedSeqLike → IndexedSeqLike → SeqLike → IterableLike →
    TraversableLike

(defined at scala.collection.mutable.ArrayOps.ofLong)


### `def toCollection(repr: Array[Long]): WrappedArray[Long]`                ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Long, Array[Long]]`     ###
...
### `def view: IndexedSeqView[Long, Array[Long]]`                            ###
