...
### `def newDropped(n: Int): FlatMapped.Transformed[B]`                      ###
...
### `def newTaken(n: Int): FlatMapped.Transformed[B]`                        ###
...
### `def flatten[B](implicit asTraversable: (B) ⇒ GenTraversableOnce[B]): FlatMapped.Transformed[B]` ###
