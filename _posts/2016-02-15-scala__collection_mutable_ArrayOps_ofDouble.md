...
### `def dropRight(n: Int): Array[Double]`                                   ###
...
### `def dropWhile(p: (Double) ⇒ Boolean): Array[Double]`                    ###
...
### `def slice(from: Int, until: Int): Array[Double]`                        ###
...
### `def span(p: (Double) ⇒ Boolean): (Array[Double], Array[Double])`        ###
...
### `def splitAt(n: Int): (Array[Double], Array[Double])`                    ###
...
### `def takeRight(n: Int): Array[Double]`                                   ###
...
### `def takeWhile(p: (Double) ⇒ Boolean): Array[Double]`                    ###
...
### `def zip[A1 >: Double, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[Array[Double], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[Array[Double]]`                        ###
...
### `def sliding(size: Int): Iterator[Array[Double]]`                        ###
...
### `def sliding(size: Int, step: Int): Iterator[Array[Double]]`             ###
...
### `def zipAll[B, A1 >: Double, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[Array[Double], (A1, B), That]): That` ###
...
### `def +:[B >: Double, That](elem: B)(implicit bf: CanBuildFrom[Array[Double], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[Array[Double]]`                      ###
...
### `def diff[B >: Double](that: GenSeq[B]): Array[Double]`                  ###
...
### `def intersect[B >: Double](that: GenSeq[B]): Array[Double]`             ###
...
### `def padTo[B >: Double, That](len: Int, elem: B)(implicit bf: CanBuildFrom[Array[Double], B, That]): That` ###
...
### `def patch[B >: Double, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[Array[Double], B, That]): That` ###
...
### `def permutations: Iterator[Array[Double]]`                              ###
...
### `def sortBy[B](f: (Double) ⇒ B)(implicit ord: math.Ordering[B]): Array[Double]` ###
...
### `def sortWith(lt: (Double, Double) ⇒ Boolean): Array[Double]`            ###
...
### `def sorted[B >: Double](implicit ord: math.Ordering[B]): Array[Double]` ###
...
### `def union[B >: Double, That](that: GenSeq[B])(implicit bf: CanBuildFrom[Array[Double], B, That]): That` ###
...
### `def updated[B >: Double, That](index: Int, elem: B)(implicit bf: CanBuildFrom[Array[Double], B, That]): That` ###
...
### `def ++:[B >: Double, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[Array[Double], B, That]): That` ###
...
### `def ++:[B >: Double, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[Array[Double], B, That]): That` ###
...
### `def ++[B >: Double, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[Array[Double], B, That]): That` ###
...
### `def filterNot(p: (Double) ⇒ Boolean): Array[Double]`                    ###
...
### `def groupBy[K](f: (Double) ⇒ K): immutable.Map[K, Array[Double]]`       ###
...
### `def inits: Iterator[Array[Double]]`                                     ###
...
### `def partition(p: (Double) ⇒ Boolean): (Array[Double], Array[Double])`   ###
...
### `def scanLeft[B, That](z: B)(op: (B, Double) ⇒ B)(implicit bf: CanBuildFrom[Array[Double], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Double, B) ⇒ B)(implicit bf: CanBuildFrom[Array[Double], B, That]): That` ###
...
### `def scan[B >: Double, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[Array[Double], B, That]): That` ###
...
### `def tails: Iterator[Array[Double]]`                                     ###
...
### `def withFilter(p: (Double) ⇒ Boolean): FilterMonadic[Double, Array[Double]]` ###
...
### `def +:[B >: Double](elem: B)(implicit arg0: ClassTag[B]): Array[B]`     ###
...
### `def copyToArray[U >: Double](xs: Array[U], start: Int, len: Int): Unit` ###
...
### `def flatten[U](implicit asTrav: (Double) ⇒ collection.Traversable[U], m: ClassTag[U]): Array[U]` ###
...
### `def transpose[U](implicit asArray: (Double) ⇒ Array[U]): Array[Array[U]]` ###
...
### `def unzip3[T1, T2, T3](implicit asTriple: (Double) ⇒ (T1, T2, T3), ct1: ClassTag[T1], ct2: ClassTag[T2], ct3: ClassTag[T3]): (Array[T1], Array[T2], Array[T3])` ###
...
### `def unzip[T1, T2](implicit asPair: (Double) ⇒ (T1, T2), ct1: ClassTag[T1], ct2: ClassTag[T2]): (Array[T1], Array[T2])` ###
...
--------------------------------------------------------------------------------
     Instance Constructors From scala.collection.mutable.ArrayOps.ofDouble
--------------------------------------------------------------------------------


### `new ofDouble(repr: Array[Double])`                                      ###

(defined at scala.collection.mutable.ArrayOps.ofDouble)


--------------------------------------------------------------------------------
         Value Members From scala.collection.mutable.ArrayOps.ofDouble
--------------------------------------------------------------------------------
...
### `def newBuilder: ArrayBuilder.ofDouble`                                  ###
...
* Attributes
  * protected[this]
* Definition Classes
  * ofDouble → TraversableLike → HasNewBuilder
...
* Attributes
  * protected[this]
* Definition Classes
  * ofDouble → IndexedSeqLike → IndexedSeqLike → SeqLike → IterableLike →
    TraversableLike

(defined at scala.collection.mutable.ArrayOps.ofDouble)


### `def toCollection(repr: Array[Double]): WrappedArray[Double]`            ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Double, Array[Double]]` ###
...
### `def view: IndexedSeqView[Double, Array[Double]]`                        ###
