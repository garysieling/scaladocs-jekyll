...
### `abstract def seq: scala.Iterable[T]`                                    ###
...
### `def bf2seq[S, That](bf: CanBuildFrom[ParIterable[T], S, That]): CanBuildFrom[scala.Iterable[T], S, That]` ###
...
### `def sequentially[S, That <: Parallel](b: (scala.Iterable[T]) ⇒ Parallelizable[S, That]): ParIterable[T]` ###
...
### `def view: IterableView[T, scala.Iterable[T]]`                           ###
