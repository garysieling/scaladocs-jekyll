...
### `def toStream: immutable.Stream[(A1, B)]`                                ###
...
### `def drop(n: Int): SeqView[(A1, B), Coll]`                               ###
...
### `def dropRight(n: Int): SeqView[(A1, B), Coll]`                          ###
...
### `def grouped(size: Int): Iterator[SeqView[(A1, B), Coll]]`               ###
...
### `def sliding(size: Int): Iterator[SeqView[(A1, B), Coll]]`               ###
...
### `def sliding(size: Int, step: Int): Iterator[SeqView[(A1, B), Coll]]`    ###
...
### `def take(n: Int): SeqView[(A1, B), Coll]`                               ###
...
### `def takeRight(n: Int): SeqView[(A1, B), Coll]`                          ###
...
### `def zipAll[B, A1 >: (A1, B), That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], (A1, B), That]): That` ###
...
### `def zip[A1 >: (A1, B), B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], (A1, B), That]): That` ###
...
### `def toCollection(repr: SeqView[(A1, B), Coll]): Seq[(A1, B)]`           ###
...
### `def view(from: Int, until: Int): SeqView[(A1, B), SeqView[(A1, B), Coll]]` ###
...
### `def view: SeqView[(A1, B), SeqView[(A1, B), Coll]]`                     ###
...
### `def +:[B >: (A1, B), That](elem: B)(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[SeqView[(A1, B), Coll]]`             ###
...
### `def diff[B >: (A1, B)](that: GenSeq[B]): SeqView[(A1, B), Coll]`        ###
...
### `def distinct: SeqView[(A1, B), Coll]`                                   ###
...
### `def intersect[B >: (A1, B)](that: GenSeq[B]): SeqView[(A1, B), Coll]`   ###
...
### `def newDropped(n: Int): Transformed[(A1, B)]`                           ###
...
### `def newTaken(n: Int): Transformed[(A1, B)]`                             ###
...
### `def padTo[B >: (A1, B), That](len: Int, elem: B)(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def patch[B >: (A1, B), That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def permutations: Iterator[SeqView[(A1, B), Coll]]`                     ###
...
### `def reverseMap[B, That](f: ((A1, B)) ⇒ B)(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def sortBy[B](f: ((A1, B)) ⇒ B)(implicit ord: Ordering[B]): SeqView[(A1, B), Coll]` ###
...
### `def sortWith(lt: ((A1, B), (A1, B)) ⇒ Boolean): SeqView[(A1, B), Coll]` ###
...
### `def sorted[B >: (A1, B)](implicit ord: Ordering[B]): SeqView[(A1, B), Coll]` ###
...
### `def union[B >: (A1, B), That](that: GenSeq[B])(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def updated[B >: (A1, B), That](index: Int, elem: B)(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def scan[B >: (A1, B), That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def toTraversable: Traversable[(A1, B)]`                                ###
...
### `def toIndexedSeq: immutable.IndexedSeq[(A1, B)]`                        ###
...
### `def toMap[T, U](implicit ev: <:<[(A1, B), (T, U)]): immutable.Map[T, U]` ###
...
### `def toSet[B >: (A1, B)]: immutable.Set[B]`                              ###
...
### `def ++:[B >: (A1, B), That](xs: Traversable[B])(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def ++:[B >: (A1, B), That](xs: TraversableOnce[B])(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def ++[B >: (A1, B), That](xs: GenTraversableOnce[B])(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[(A1, B), B])(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def dropWhile(p: ((A1, B)) ⇒ Boolean): SeqView[(A1, B), Coll]`          ###
...
### `def filter(p: ((A1, B)) ⇒ Boolean): SeqView[(A1, B), Coll]`             ###
...
### `def filterNot(p: ((A1, B)) ⇒ Boolean): SeqView[(A1, B), Coll]`          ###
...
### `def flatMap[B, That](f: ((A1, B)) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def groupBy[K](f: ((A1, B)) ⇒ K): immutable.Map[K, SeqView[(A1, B), Coll]]` ###
...
### `def inits: Iterator[SeqView[(A1, B), Coll]]`                            ###
...
### `def map[B, That](f: ((A1, B)) ⇒ B)(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def newBuilder: Builder[(A1, B), SeqView[(A1, B), Coll]]`               ###
...
### `def partition(p: ((A1, B)) ⇒ Boolean): (SeqView[(A1, B), Coll], SeqView[(A1, B), Coll])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, (A1, B)) ⇒ B)(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: ((A1, B), B) ⇒ B)(implicit bf: CanBuildFrom[SeqView[(A1, B), Coll], B, That]): That` ###
...
### `def slice(from: Int, until: Int): SeqView[(A1, B), Coll]`               ###
...
### `def span(p: ((A1, B)) ⇒ Boolean): (SeqView[(A1, B), Coll], SeqView[(A1, B), Coll])` ###
...
### `def splitAt(n: Int): (SeqView[(A1, B), Coll], SeqView[(A1, B), Coll])`  ###
...
### `def tails: Iterator[SeqView[(A1, B), Coll]]`                            ###
...
### `def takeWhile(p: ((A1, B)) ⇒ Boolean): SeqView[(A1, B), Coll]`          ###
...
### `def withFilter(p: ((A1, B)) ⇒ Boolean): SeqView[(A1, B), Coll]`         ###
...
### `def transpose[B](implicit asTraversable: ((A1, B)) ⇒ GenTraversableOnce[B]): Seq[Seq[B]]` ###
