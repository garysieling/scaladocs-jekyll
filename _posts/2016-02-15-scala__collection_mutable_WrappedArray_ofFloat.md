...
### `def andThen[C](k: (Float) ⇒ C): PartialFunction[Int, C]`                ###
...
### `def applyOrElse[A1 <: Int, B1 >: Float](x: A1, default: (A1) ⇒ B1): B1` ###
...
### `def orElse[A1 <: Int, B1 >: Float](that: PartialFunction[A1, B1]): PartialFunction[A1, B1]` ###
...
### `def runWith[U](action: (Float) ⇒ U): (Int) ⇒ Boolean`                   ###
...
### `def parCombiner: Combiner[Float, ParArray[Float]]`                      ###
...
### `def indexOf[B >: Float](elem: B): Int`                                  ###
...
### `def indexOf[B >: Float](elem: B, from: Int): Int`                       ###
...
### `def indexWhere(p: (Float) ⇒ Boolean): Int`                              ###
...
### `def lastIndexOf[B >: Float](elem: B): Int`                              ###
...
### `def lastIndexOf[B >: Float](elem: B, end: Int): Int`                    ###
...
### `def lastIndexWhere(p: (Float) ⇒ Boolean): Int`                          ###
...
### `def prefixLength(p: (Float) ⇒ Boolean): Int`                            ###
...
### `def toBuffer[A1 >: Float]: Buffer[A1]`                                  ###
...
### `def drop(n: Int): WrappedArray[Float]`                                  ###
...
### `def dropRight(n: Int): WrappedArray[Float]`                             ###
...
### `def dropWhile(p: (Float) ⇒ Boolean): WrappedArray[Float]`               ###
...
### `def exists(p: (Float) ⇒ Boolean): Boolean`                              ###
...
### `def find(p: (Float) ⇒ Boolean): Option[Float]`                          ###
...
### `def foldLeft[B](z: B)(op: (B, Float) ⇒ B): B`                           ###
...
### `def foldRight[B](z: B)(op: (Float, B) ⇒ B): B`                          ###
...
### `def forall(p: (Float) ⇒ Boolean): Boolean`                              ###
...
### `def indexWhere(p: (Float) ⇒ Boolean, from: Int): Int`                   ###
...
### `def lastIndexWhere(p: (Float) ⇒ Boolean, end: Int): Int`                ###
...
### `def reduceLeft[B >: Float](op: (B, Float) ⇒ B): B`                      ###
...
### `def reduceRight[B >: Float](op: (Float, B) ⇒ B): B`                     ###
...
### `def reverse: WrappedArray[Float]`                                       ###
...
### `def reverseIterator: Iterator[Float]`                                   ###
...
### `def sameElements[B >: Float](that: GenIterable[B]): Boolean`            ###
...
### `def segmentLength(p: (Float) ⇒ Boolean, from: Int): Int`                ###
...
### `def slice(from: Int, until: Int): WrappedArray[Float]`                  ###
...
### `def span(p: (Float) ⇒ Boolean): (WrappedArray[Float], WrappedArray[Float])` ###
...
### `def splitAt(n: Int): (WrappedArray[Float], WrappedArray[Float])`        ###
...
### `def take(n: Int): WrappedArray[Float]`                                  ###
...
### `def takeRight(n: Int): WrappedArray[Float]`                             ###
...
### `def takeWhile(p: (Float) ⇒ Boolean): WrappedArray[Float]`               ###
...
### `def zipWithIndex[A1 >: Float, That](implicit bf: CanBuildFrom[WrappedArray[Float], (A1, Int), That]): That` ###
...
### `def zip[A1 >: Float, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[WrappedArray[Float], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[WrappedArray[Float]]`                  ###
...
### `def sliding(size: Int): Iterator[WrappedArray[Float]]`                  ###
...
### `def sliding(size: Int, step: Int): Iterator[WrappedArray[Float]]`       ###
...
### `def toIterable: collection.Iterable[Float]`                             ###
...
### `def toStream: immutable.Stream[Float]`                                  ###
...
### `def zipAll[B, A1 >: Float, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[WrappedArray[Float], (A1, B), That]): That` ###
...
### `def +:[B >: Float, That](elem: B)(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[WrappedArray[Float]]`                ###
...
### `def contains[A1 >: Float](elem: A1): Boolean`                           ###
...
### `def corresponds[B](that: GenSeq[B])(p: (Float, B) ⇒ Boolean): Boolean`  ###
...
### `def diff[B >: Float](that: GenSeq[B]): WrappedArray[Float]`             ###
...
### `def distinct: WrappedArray[Float]`                                      ###
...
### `def indexOfSlice[B >: Float](that: GenSeq[B]): Int`                     ###
...
### `def indexOfSlice[B >: Float](that: GenSeq[B], from: Int): Int`          ###
...
### `def intersect[B >: Float](that: GenSeq[B]): WrappedArray[Float]`        ###
...
### `def lastIndexOfSlice[B >: Float](that: GenSeq[B]): Int`                 ###
...
### `def lastIndexOfSlice[B >: Float](that: GenSeq[B], end: Int): Int`       ###
...
### `def padTo[B >: Float, That](len: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def patch[B >: Float, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def permutations: Iterator[WrappedArray[Float]]`                        ###
...
### `def reverseMap[B, That](f: (Float) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def sortBy[B](f: (Float) ⇒ B)(implicit ord: math.Ordering[B]): WrappedArray[Float]` ###
...
### `def sortWith(lt: (Float, Float) ⇒ Boolean): WrappedArray[Float]`        ###
...
### `def sorted[B >: Float](implicit ord: math.Ordering[B]): WrappedArray[Float]` ###
...
### `def toSeq: collection.Seq[Float]`                                       ###
...
### `def union[B >: Float, That](that: GenSeq[B])(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def updated[B >: Float, That](index: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def ++:[B >: Float, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def ++:[B >: Float, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def ++[B >: Float, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[Float, B])(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def filter(p: (Float) ⇒ Boolean): WrappedArray[Float]`                  ###
...
### `def filterNot(p: (Float) ⇒ Boolean): WrappedArray[Float]`               ###
...
### `def flatMap[B, That](f: (Float) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def groupBy[K](f: (Float) ⇒ K): immutable.Map[K, WrappedArray[Float]]`  ###
...
### `def inits: Iterator[WrappedArray[Float]]`                               ###
...
### `def map[B, That](f: (Float) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def partition(p: (Float) ⇒ Boolean): (WrappedArray[Float], WrappedArray[Float])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, Float) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Float, B) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def scan[B >: Float, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[WrappedArray[Float], B, That]): That` ###
...
### `def tails: Iterator[WrappedArray[Float]]`                               ###
...
### `def toTraversable: collection.Traversable[Float]`                       ###
...
### `def withFilter(p: (Float) ⇒ Boolean): FilterMonadic[Float, WrappedArray[Float]]` ###
...
### `def aggregate[B](z: ⇒ B)(seqop: (B, Float) ⇒ B, combop: (B, B) ⇒ B): B` ###
...
### `def collectFirst[B](pf: PartialFunction[Float, B]): Option[B]`          ###
...
### `def copyToArray[B >: Float](xs: Array[B]): Unit`                        ###
...
### `def copyToArray[B >: Float](xs: Array[B], start: Int): Unit`            ###
...
### `def copyToBuffer[B >: Float](dest: Buffer[B]): Unit`                    ###
...
### `def fold[A1 >: Float](z: A1)(op: (A1, A1) ⇒ A1): A1`                    ###
...
### `def reduceLeftOption[B >: Float](op: (B, Float) ⇒ B): Option[B]`        ###
...
### `def reduceOption[A1 >: Float](op: (A1, A1) ⇒ A1): Option[A1]`           ###
...
### `def reduceRightOption[B >: Float](op: (Float, B) ⇒ B): Option[B]`       ###
...
### `def reduce[A1 >: Float](op: (A1, A1) ⇒ A1): A1`                         ###
...
### `def toIndexedSeq: immutable.IndexedSeq[Float]`                          ###
...
### `def toMap[T, U](implicit ev: <:<[Float, (T, U)]): immutable.Map[T, U]`  ###
...
### `def toSet[B >: Float]: immutable.Set[B]`                                ###
...
### `def flatten[B](implicit asTraversable: (Float) ⇒ GenTraversableOnce[B]): IndexedSeq[B]` ###
...
### `def transpose[B](implicit asTraversable: (Float) ⇒ GenTraversableOnce[B]): IndexedSeq[IndexedSeq[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (Float) ⇒ (A1, A2, A3)): (IndexedSeq[A1], IndexedSeq[A2], IndexedSeq[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (Float) ⇒ (A1, A2)): (IndexedSeq[A1], IndexedSeq[A2])` ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Float, WrappedArray[Float]]` ###
...
### `def view: IndexedSeqView[Float, WrappedArray[Float]]`                   ###
...
### `def transform(f: (Float) ⇒ Float): ofFloat.this.type`                   ###
...
### `def newBuilder: Builder[Float, WrappedArray[Float]]`                    ###
...
### `def thisCollection: WrappedArray[Float]`                                ###
...
### `def toCollection(repr: WrappedArray[Float]): WrappedArray[Float]`       ###
...
--------------------------------------------------------------------------------
    Instance Constructors From scala.collection.mutable.WrappedArray.ofFloat
--------------------------------------------------------------------------------


### `new ofFloat(array: Array[Float])`                                       ###

(defined at scala.collection.mutable.WrappedArray.ofFloat)


--------------------------------------------------------------------------------
        Value Members From scala.collection.mutable.WrappedArray.ofFloat
--------------------------------------------------------------------------------
...
* Definition Classes
  * ofFloat → WrappedArray → SeqLike → GenSeqLike → Function1
...
* Definition Classes
  * ofFloat → WrappedArray → IndexedSeqLike → SeqLike
...
* Implicit information
  * This member is added by an implicit conversion from ofFloat to
    CollectionsHaveToParArray [ofFloat, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ofFloat) ⇒ GenTraversableOnce
    [T] is in scope.
* Definition Classes
