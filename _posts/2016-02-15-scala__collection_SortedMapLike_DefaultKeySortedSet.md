...
--------------------------------------------------------------------------------
 Instance Constructors From scala.collection.SortedMapLike.DefaultKeySortedSet
--------------------------------------------------------------------------------
...
* Definition Classes
  * DefaultKeySortedSet → DefaultKeySet → SetLike → GenSetLike
...
* Definition Classes
  * DefaultKeySortedSet → DefaultKeySet → SetLike → Subtractable → GenSetLike
...
* Definition Classes
  * DefaultKeySortedSet → SortedSetLike → Sorted
...
* Definition Classes
  * SortedSet → SetLike → GenericSetTemplate
