...
--------------------------------------------------------------------------------
         Instance Constructors From scala.collection.immutable.Map.Map4
--------------------------------------------------------------------------------


### `new Map4(key1: A, value1: B, key2: A, value2: B, key3: A, value3: B, key4: A, value4: B)` ###

(defined at scala.collection.immutable.Map.Map4)


--------------------------------------------------------------------------------
             Value Members From scala.collection.immutable.Map.Map4
--------------------------------------------------------------------------------
...
* Definition Classes
  * Map4 → Map → MapLike → MapLike → GenMapLike
...
* Definition Classes
  * Map4 → MapLike → Subtractable → GenMapLike
...
* Definition Classes
  * Map4 → MapLike → Function1 → GenMapLike
...
* Definition Classes
  * Map4 → IterableLike → GenericTraversableTemplate → TraversableLike →
...
* Definition Classes
  * Map4 → Map → MapLike → MapLike → GenMap
...
* Implicit information
  * This member is added by an implicit conversion from Map4 [A, B] to
    CollectionsHaveToParArray [Map4 [A, B], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Map4 [A, B]) ⇒
