...
### `def dropWhile(p: (Int) ⇒ Boolean): Array[Int]`                          ###
...
### `def span(p: (Int) ⇒ Boolean): (Array[Int], Array[Int])`                 ###
...
### `def takeWhile(p: (Int) ⇒ Boolean): Array[Int]`                          ###
...
### `def zip[A1 >: Int, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[Array[Int], (A1, B), That]): That` ###
...
### `def zipAll[B, A1 >: Int, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[Array[Int], (A1, B), That]): That` ###
...
### `def +:[B >: Int, That](elem: B)(implicit bf: CanBuildFrom[Array[Int], B, That]): That` ###
...
### `def diff[B >: Int](that: GenSeq[B]): Array[Int]`                        ###
...
### `def intersect[B >: Int](that: GenSeq[B]): Array[Int]`                   ###
...
### `def padTo[B >: Int, That](len: Int, elem: B)(implicit bf: CanBuildFrom[Array[Int], B, That]): That` ###
...
### `def patch[B >: Int, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[Array[Int], B, That]): That` ###
...
### `def sortBy[B](f: (Int) ⇒ B)(implicit ord: math.Ordering[B]): Array[Int]` ###
...
### `def union[B >: Int, That](that: GenSeq[B])(implicit bf: CanBuildFrom[Array[Int], B, That]): That` ###
...
### `def updated[B >: Int, That](index: Int, elem: B)(implicit bf: CanBuildFrom[Array[Int], B, That]): That` ###
...
### `def ++:[B >: Int, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[Array[Int], B, That]): That` ###
...
### `def groupBy[K](f: (Int) ⇒ K): immutable.Map[K, Array[Int]]`             ###
...
### `def scanLeft[B, That](z: B)(op: (B, Int) ⇒ B)(implicit bf: CanBuildFrom[Array[Int], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Int, B) ⇒ B)(implicit bf: CanBuildFrom[Array[Int], B, That]): That` ###
...
### `def scan[B >: Int, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[Array[Int], B, That]): That` ###
...
### `def withFilter(p: (Int) ⇒ Boolean): FilterMonadic[Int, Array[Int]]`     ###
...
### `def flatten[U](implicit asTrav: (Int) ⇒ collection.Traversable[U], m: ClassTag[U]): Array[U]` ###
...
### `def unzip3[T1, T2, T3](implicit asTriple: (Int) ⇒ (T1, T2, T3), ct1: ClassTag[T1], ct2: ClassTag[T2], ct3: ClassTag[T3]): (Array[T1], Array[T2], Array[T3])` ###
...
### `def unzip[T1, T2](implicit asPair: (Int) ⇒ (T1, T2), ct1: ClassTag[T1], ct2: ClassTag[T2]): (Array[T1], Array[T2])` ###
...
--------------------------------------------------------------------------------
       Instance Constructors From scala.collection.mutable.ArrayOps.ofInt
--------------------------------------------------------------------------------


### `new ofInt(repr: Array[Int])`                                            ###

(defined at scala.collection.mutable.ArrayOps.ofInt)


--------------------------------------------------------------------------------
           Value Members From scala.collection.mutable.ArrayOps.ofInt
--------------------------------------------------------------------------------
...
* Attributes
  * protected[this]
* Definition Classes
  * ofInt → TraversableLike → HasNewBuilder
...
* Attributes
  * protected[this]
* Definition Classes
  * ofInt → IndexedSeqLike → IndexedSeqLike → SeqLike → IterableLike →
    TraversableLike
