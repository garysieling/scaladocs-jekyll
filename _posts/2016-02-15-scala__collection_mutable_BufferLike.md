...
### `def ++=(xs: TraversableOnce[A]): BufferLike.this.type`                  ###
...
### `def +=(elem1: A, elem2: A, elems: A*): BufferLike.this.type`            ###
...
### `abstract def +=(elem: A): BufferLike.this.type`                         ###
...
### `def transform(f: (A) ⇒ A): BufferLike.this.type`                        ###
...
* Implicit information
  * This member is added by an implicit conversion from BufferLike [A, This] to
    CollectionsHaveToParArray [BufferLike [A, This], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (BufferLike [A, This]) ⇒
