...
* Implicit information
  * This member is added by an implicit conversion from BitSetLike [This] to
    CollectionsHaveToParArray [BitSetLike [This], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (BitSetLike [This]) ⇒
