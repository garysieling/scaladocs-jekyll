...
--------------------------------------------------------------------------------
Instance Constructors From scala.collection.parallel.immutable.ParHashSet.ParHashSetIterator
--------------------------------------------------------------------------------


### `new ParHashSetIterator(triter: scala.Iterator[T], sz: Int)`             ###

(defined at scala.collection.parallel.immutable.ParHashSet.ParHashSetIterator)


--------------------------------------------------------------------------------
Value Members From scala.collection.parallel.immutable.ParHashSet.ParHashSetIterator
--------------------------------------------------------------------------------
...
* Definition Classes
  * ParHashSetIterator → IterableSplitter
...
* Definition Classes
  * ParHashSetIterator → IterableSplitter → Splitter
