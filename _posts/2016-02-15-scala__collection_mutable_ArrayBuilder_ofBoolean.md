...
### `def +=(elem1: Boolean, elem2: Boolean, elems: Boolean*): ofBoolean.this.type` ###
...
--------------------------------------------------------------------------------
   Instance Constructors From scala.collection.mutable.ArrayBuilder.ofBoolean
--------------------------------------------------------------------------------


### `new ofBoolean()`                                                        ###

(defined at scala.collection.mutable.ArrayBuilder.ofBoolean)


--------------------------------------------------------------------------------
       Value Members From scala.collection.mutable.ArrayBuilder.ofBoolean
--------------------------------------------------------------------------------


### `def ++=(xs: TraversableOnce[Boolean]): ofBoolean.this.type`             ###
...
### `def mapResult[NewTo](f: (Array[Boolean]) ⇒ NewTo): Builder[Boolean, NewTo]` ###
