...
Converts this immutable set of traversable collections into a immutable set
...
--------------------------------------------------------------------------------
             Value Members From scala.collection.immutable.Set.Set1
--------------------------------------------------------------------------------
...
* Definition Classes
  * Set1 → SetLike → GenSetLike

(defined at scala.collection.immutable.Set.Set1)
...
* Definition Classes
  * Set1 → SetLike → Subtractable → GenSetLike
...
* p
  * the predicate used to test elements.
* returns
  * `false` if this immutable set is empty, otherwise `true` if the given
    predicate `p` holds for some of the elements of this immutable set,
    otherwise `false`

* Definition Classes
  * Set1 → IterableLike → TraversableLike → TraversableOnce → GenTraversableOnce
...
* p
  * the predicate used to test elements.
* returns
  * an option value containing the first element in the immutable set that
...
* p
  * the predicate used to test elements.
* returns
  * `true` if this immutable set is empty or the given predicate `p` holds for
    all elements of this immutable set, otherwise `false` .
...
* Definition Classes
  * Set1 → IterableLike → GenericTraversableTemplate → TraversableLike →
...
* Definition Classes
  * Set1 → Set → TraversableOnce → GenTraversableOnce
* Annotations
  * @ deprecatedOverriding (message =..., since = "2.11.8")
...
* Implicit information
  * This member is added by an implicit conversion from Set1 [A] to
    CollectionsHaveToParArray [Set1 [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Set1 [A]) ⇒ GenTraversableOnce
    [T] is in scope.
* Definition Classes
