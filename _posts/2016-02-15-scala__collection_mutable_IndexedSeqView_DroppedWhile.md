...
### `def newAppended[B >: A](that: GenTraversable[B]): DroppedWhile.Transformed[B]` ###
...
### `def newFlatMapped[B](f: (A) ⇒ GenTraversableOnce[B]): DroppedWhile.Transformed[B]` ###
...
### `def newForced[B](xs: ⇒ GenSeq[B]): DroppedWhile.Transformed[B]`         ###
...
### `def newMapped[B](f: (A) ⇒ B): DroppedWhile.Transformed[B]`              ###
...
### `def newPatched[B >: A](_from: Int, _patch: GenSeq[B], _replaced: Int): DroppedWhile.Transformed[B]` ###
...
### `def newPrepended[B >: A](that: GenTraversable[B]): DroppedWhile.Transformed[B]` ###
...
### `def newZippedAll[A1 >: A, B](that: GenIterable[B], _thisElem: A1, _thatElem: B): DroppedWhile.Transformed[(A1, B)]` ###
...
### `def newZipped[B](that: GenIterable[B]): DroppedWhile.Transformed[(A, B)]` ###
...
--------------------------------------------------------------------------------
Concrete Value Members From scala.collection.mutable.IndexedSeqView.DroppedWhile
--------------------------------------------------------------------------------
...
* Definition Classes
  * DroppedWhile → Transformed → IndexedSeqView → IndexedSeqLike → SeqLike
* Exceptions thrown
  * IndexOutOfBoundsException if the index is not valid.

(defined at scala.collection.mutable.IndexedSeqView.DroppedWhile)
...
### `def transform(f: (A) ⇒ A): DroppedWhile.this.type`                      ###
