...
### `def ++[B >: (T, S)](that: ⇒ GenTraversableOnce[B]): Iterator[B]`        ###
...
### `def buffered: BufferedIterator[(T, S)]`                                 ###
...
### `def collect[B](pf: PartialFunction[(T, S), B]): Iterator[B]`            ###
...
### `def corresponds[B](that: GenTraversableOnce[B])(p: ((T, S), B) ⇒ Boolean): Boolean` ###
...
### `def dropWhile(p: ((T, S)) ⇒ Boolean): Iterator[(T, S)]`                 ###
...
### `def duplicate: (Iterator[(T, S)], Iterator[(T, S)])`                    ###
...
### `def exists(p: ((T, S)) ⇒ Boolean): Boolean`                             ###
...
### `def filter(p: ((T, S)) ⇒ Boolean): Iterator[(T, S)]`                    ###
...
### `def filterNot(p: ((T, S)) ⇒ Boolean): Iterator[(T, S)]`                 ###
...
### `def find(p: ((T, S)) ⇒ Boolean): Option[(T, S)]`                        ###
...
### `def flatMap[B](f: ((T, S)) ⇒ GenTraversableOnce[B]): Iterator[B]`       ###
...
### `def forall(p: ((T, S)) ⇒ Boolean): Boolean`                             ###
...
### `def grouped[B >: (T, S)](size: Int): GroupedIterator[B]`                ###
...
### `def indexOf[B >: (T, S)](elem: B, from: Int): Int`                      ###
...
### `def indexWhere(p: ((T, S)) ⇒ Boolean, from: Int): Int`                  ###
...
### `def padTo[A1 >: (T, S)](len: Int, elem: A1): Iterator[A1]`              ###
...
### `def partition(p: ((T, S)) ⇒ Boolean): (Iterator[(T, S)], Iterator[(T, S)])` ###
...
### `def patch[B >: (T, S)](from: Int, patchElems: Iterator[B], replaced: Int): Iterator[B]` ###
...
### `def scanLeft[B](z: B)(op: (B, (T, S)) ⇒ B): Iterator[B]`                ###
...
### `def scanRight[B](z: B)(op: ((T, S), B) ⇒ B): Iterator[B]`               ###
...
### `def sliceIterator(from: Int, until: Int): Iterator[(T, S)]`             ###
...
### `def sliding[B >: (T, S)](size: Int, step: Int = 1): GroupedIterator[B]` ###
...
### `def span(p: ((T, S)) ⇒ Boolean): (Iterator[(T, S)], Iterator[(T, S)])`  ###
...
### `def takeWhile(p: ((T, S)) ⇒ Boolean): Iterator[(T, S)]`                 ###
...
### `def toStream: immutable.Stream[(T, S)]`                                 ###
...
### `def toTraversable: Traversable[(T, S)]`                                 ###
...
### `def withFilter(p: ((T, S)) ⇒ Boolean): Iterator[(T, S)]`                ###
...
### `def zipAll[B, A1 >: (T, S), B1 >: B](that: Iterator[B], thisElem: A1, thatElem: B1): Iterator[(A1, B1)]` ###
...
### `def zipWithIndex: Iterator[((T, S), Int)]`                              ###
...
### `def zip[B](that: Iterator[B]): Iterator[((T, S), B)]`                   ###
...
### `def aggregate[B](z: ⇒ B)(seqop: (B, (T, S)) ⇒ B, combop: (B, B) ⇒ B): B` ###
...
### `def collectFirst[B](pf: PartialFunction[(T, S), B]): Option[B]`         ###
...
### `def copyToArray[B >: (T, S)](xs: Array[B]): Unit`                       ###
...
### `def copyToArray[B >: (T, S)](xs: Array[B], start: Int): Unit`           ###
...
### `def copyToBuffer[B >: (T, S)](dest: Buffer[B]): Unit`                   ###
...
### `def foldLeft[B](z: B)(op: (B, (T, S)) ⇒ B): B`                          ###
...
### `def foldRight[B](z: B)(op: ((T, S), B) ⇒ B): B`                         ###
...
### `def maxBy[B](f: ((T, S)) ⇒ B)(implicit cmp: Ordering[B]): (T, S)`       ###
...
### `def minBy[B](f: ((T, S)) ⇒ B)(implicit cmp: Ordering[B]): (T, S)`       ###
...
### `def reduceLeftOption[B >: (T, S)](op: (B, (T, S)) ⇒ B): Option[B]`      ###
...
### `def reduceLeft[B >: (T, S)](op: (B, (T, S)) ⇒ B): B`                    ###
...
### `def reduceOption[A1 >: (T, S)](op: (A1, A1) ⇒ A1): Option[A1]`          ###
...
### `def reduceRightOption[B >: (T, S)](op: ((T, S), B) ⇒ B): Option[B]`     ###
...
### `def reduceRight[B >: (T, S)](op: ((T, S), B) ⇒ B): B`                   ###
...
### `def toIndexedSeq: immutable.IndexedSeq[(T, S)]`                         ###
...
### `def toMap[T, U](implicit ev: <:<[(T, S), (T, U)]): immutable.Map[T, U]` ###
...
### `def toSet[B >: (T, S)]: immutable.Set[B]`                               ###
...
### `def collect2combiner[S, That](pf: PartialFunction[(T, S), S], cb: Combiner[S, That]): Combiner[S, That]` ###
...
### `def copy2builder[U >: (T, S), Coll, Bld <: Builder[U, Coll]](b: Bld): Bld` ###
...
### `def copyToArray[U >: (T, S)](array: Array[U], from: Int, len: Int): Unit` ###
...
### `def drop2combiner[U >: (T, S), This](n: Int, cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def filter2combiner[U >: (T, S), This](pred: ((T, S)) ⇒ Boolean, cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def filterNot2combiner[U >: (T, S), This](pred: ((T, S)) ⇒ Boolean, cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def flatmap2combiner[S, That](f: ((T, S)) ⇒ GenTraversableOnce[S], cb: Combiner[S, That]): Combiner[S, That]` ###
...
### `def map2combiner[S, That](f: ((T, S)) ⇒ S, cb: Combiner[S, That]): Combiner[S, That]` ###
...
### `def partition2combiners[U >: (T, S), This](pred: ((T, S)) ⇒ Boolean, btrue: Combiner[U, This], bfalse: Combiner[U, This]): (Combiner[U, This], Combiner[U, This])` ###
...
### `def reduceLeft[U >: (T, S)](howmany: Int, op: (U, U) ⇒ U): U`           ###
...
### `def scanToArray[U >: (T, S), A >: U](z: U, op: (U, U) ⇒ U, array: Array[A], from: Int): Unit` ###
...
### `def scanToCombiner[U >: (T, S), That](howmany: Int, startValue: U, op: (U, U) ⇒ U, cb: Combiner[U, That]): Combiner[U, That]` ###
...
### `def scanToCombiner[U >: (T, S), That](startValue: U, op: (U, U) ⇒ U, cb: Combiner[U, That]): Combiner[U, That]` ###
...
### `def slice2combiner[U >: (T, S), This](from: Int, until: Int, cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def span2combiners[U >: (T, S), This](p: ((T, S)) ⇒ Boolean, before: Combiner[U, This], after: Combiner[U, This]): (Combiner[U, This], Combiner[U, This])` ###
...
### `def splitAt2combiners[U >: (T, S), This](at: Int, before: Combiner[U, This], after: Combiner[U, This]): (Combiner[U, This], Combiner[U, This])` ###
...
### `def take2combiner[U >: (T, S), This](n: Int, cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def takeWhile2combiner[U >: (T, S), This](p: ((T, S)) ⇒ Boolean, cb: Combiner[U, This]): (Combiner[U, This], Boolean)` ###
...
### `def zip2combiner[U >: (T, S), S, That](otherpit: RemainsIterator[S], cb: Combiner[(U, S), That]): Combiner[(U, S), That]` ###
...
### `def zipAll2combiner[U >: (T, S), S, That](that: RemainsIterator[S], thiselem: U, thatelem: S, cb: Combiner[(U, S), That]): Combiner[(U, S), That]` ###
...
### `def corresponds[S](corr: ((T, S), S) ⇒ Boolean)(that: scala.Iterator[S]): Boolean` ###
...
### `def indexWhere(pred: ((T, S)) ⇒ Boolean): Int`                          ###
...
### `def lastIndexWhere(pred: ((T, S)) ⇒ Boolean): Int`                      ###
...
### `def prefixLength(pred: ((T, S)) ⇒ Boolean): Int`                        ###
...
### `def reverse2combiner[U >: (T, S), This](cb: Combiner[U, This]): Combiner[U, This]` ###
...
### `def reverseMap2combiner[S, That](f: ((T, S)) ⇒ S, cb: Combiner[S, That]): Combiner[S, That]` ###
...
### `def updated2combiner[U >: (T, S), That](index: Int, elem: U, cb: Combiner[U, That]): Combiner[U, That]` ###
...
### `def appendParIterable[U >: (T, S), PI <: IterableSplitter[U]](that: PI): Zipped.Appended[U, PI]` ###
...
### `def drop(n: Int): IterableSplitter[(T, S)]`                             ###
...
--------------------------------------------------------------------------------
      Value Members From scala.collection.parallel.IterableSplitter.Zipped
--------------------------------------------------------------------------------
...
(defined at scala.collection.parallel.IterableSplitter.Zipped)
...
### `def appendParSeq[U >: (T, S), PI <: SeqSplitter[U]](that: PI): Appended[U, PI]` ###
...
### `def patchParSeq[U >: (T, S)](from: Int, patchElems: SeqSplitter[U], replaced: Int): Patched[U]` ###
...
### `def psplitWithSignalling(sizes: Int*): scala.Seq[SeqSplitter[(T, S)]]`  ###
...
### `def slice(from1: Int, until1: Int): SeqSplitter[(T, S)]`                ###
...
### `def splitWithSignalling: scala.Seq[SeqSplitter[(T, S)]]`                ###
...
### `def take(n: Int): SeqSplitter[(T, S)]`                                  ###
...
### `def zipAllParSeq[S, U >: (T, S), R >: S](that: SeqSplitter[S], thisElem: U, thatElem: R): ZippedAll[U, R]` ###
...
--------------------------------------------------------------------------------
    Instance Constructors From scala.collection.parallel.SeqSplitter.Zipped
--------------------------------------------------------------------------------


### `new Zipped(ti: SeqSplitter[S])`                                         ###

(defined at scala.collection.parallel.SeqSplitter.Zipped)


--------------------------------------------------------------------------------
        Value Members From scala.collection.parallel.SeqSplitter.Zipped
--------------------------------------------------------------------------------


### `def dup: SeqSplitter[(T, S)]`                                           ###

Creates a copy of this iterator.

* Definition Classes
  * Zipped → SeqSplitter → Zipped → IterableSplitter

(defined at scala.collection.parallel.SeqSplitter.Zipped)


### `def psplit(szs: Int*): scala.Seq[SeqSplitter[(T, S)]]`                  ###
...
* Definition Classes
  * Zipped → SeqSplitter → PreciseSplitter

(defined at scala.collection.parallel.SeqSplitter.Zipped)


### `def split: scala.Seq[SeqSplitter[(T, S)]]`                              ###
...
* Definition Classes
  * Zipped → SeqSplitter → PreciseSplitter → Zipped → IterableSplitter →
    Splitter
...
* Implicit information
  * This member is added by an implicit conversion from Zipped [S] to
    CollectionsHaveToParArray [Zipped [S], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Zipped [S]) ⇒
