...
### `def +=(elem1: Double, elem2: Double, elems: Double*): ofDouble.this.type` ###
...
--------------------------------------------------------------------------------
   Instance Constructors From scala.collection.mutable.ArrayBuilder.ofDouble
--------------------------------------------------------------------------------


### `new ofDouble()`                                                         ###

(defined at scala.collection.mutable.ArrayBuilder.ofDouble)


--------------------------------------------------------------------------------
       Value Members From scala.collection.mutable.ArrayBuilder.ofDouble
--------------------------------------------------------------------------------


### `def ++=(xs: TraversableOnce[Double]): ofDouble.this.type`               ###
...
### `def mapResult[NewTo](f: (Array[Double]) ⇒ NewTo): Builder[Double, NewTo]` ###
