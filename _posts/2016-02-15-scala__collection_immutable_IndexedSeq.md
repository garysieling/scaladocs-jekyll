...
* Implicit information
  * This member is added by an implicit conversion from IndexedSeq [A] to
...
* Implicit information
  * This member is added by an implicit conversion from IndexedSeq [A] to
    CollectionsHaveToParArray [IndexedSeq [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (IndexedSeq [A]) ⇒
