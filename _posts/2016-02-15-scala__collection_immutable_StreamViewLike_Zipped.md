...
### `def lastIndexOf[B >: (A, B)](elem: B): Int`                             ###
...
### `def prefixLength(p: ((A, B)) ⇒ Boolean): Int`                           ###
...
### `def drop(n: Int): StreamView[(A, B), Coll]`                             ###
...
### `def dropRight(n: Int): StreamView[(A, B), Coll]`                        ###
...
### `def grouped(size: Int): Iterator[StreamView[(A, B), Coll]]`             ###
...
### `def sliding(size: Int): Iterator[StreamView[(A, B), Coll]]`             ###
...
### `def sliding(size: Int, step: Int): Iterator[StreamView[(A, B), Coll]]`  ###
...
### `def take(n: Int): StreamView[(A, B), Coll]`                             ###
...
### `def takeRight(n: Int): StreamView[(A, B), Coll]`                        ###
...
### `def zipAll[B, A1 >: (A, B), That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], (A1, B), That]): That` ###
...
### `def zipWithIndex[A1 >: (A, B), That](implicit bf: CanBuildFrom[StreamView[(A, B), Coll], (A1, Int), That]): That` ###
...
### `def zip[A1 >: (A, B), B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], (A1, B), That]): That` ###
...
--------------------------------------------------------------------------------
      Abstract Value Members From scala.collection.IterableViewLike.Zipped
--------------------------------------------------------------------------------
...
(defined at scala.collection.IterableViewLike.Zipped)
...
### `def corresponds[B](that: GenSeq[B])(p: ((A, B), B) ⇒ Boolean): Boolean` ###
...
### `def indexOfSlice[B >: (A, B)](that: GenSeq[B]): Int`                    ###
...
### `def indexOfSlice[B >: (A, B)](that: GenSeq[B], from: Int): Int`         ###
...
### `def lastIndexOfSlice[B >: (A, B)](that: GenSeq[B]): Int`                ###
...
### `def lastIndexOfSlice[B >: (A, B)](that: GenSeq[B], end: Int): Int`      ###
...
### `def parCombiner: Combiner[(A, B), ParSeq[(A, B)]]`                      ###
...
### `def thisCollection: collection.Seq[(A, B)]`                             ###
...
### `def toCollection(repr: StreamView[(A, B), Coll]): collection.Seq[(A, B)]` ###
...
### `def view(from: Int, until: Int): SeqView[(A, B), StreamView[(A, B), Coll]]` ###
...
### `def view: SeqView[(A, B), StreamView[(A, B), Coll]]`                    ###
...
### `def +:[B >: (A, B), That](elem: B)(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[StreamView[(A, B), Coll]]`           ###
...
### `def diff[B >: (A, B)](that: GenSeq[B]): StreamView[(A, B), Coll]`       ###
...
### `def distinct: StreamView[(A, B), Coll]`                                 ###
...
### `def intersect[B >: (A, B)](that: GenSeq[B]): StreamView[(A, B), Coll]`  ###
...
### `def newDropped(n: Int): Zipped.Transformed[(A, B)]`                     ###
...
### `def newTaken(n: Int): Zipped.Transformed[(A, B)]`                       ###
...
### `def padTo[B >: (A, B), That](len: Int, elem: B)(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def patch[B >: (A, B), That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def permutations: Iterator[StreamView[(A, B), Coll]]`                   ###
...
### `def reverse: StreamView[(A, B), Coll]`                                  ###
...
### `def reverseMap[B, That](f: ((A, B)) ⇒ B)(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def sortBy[B](f: ((A, B)) ⇒ B)(implicit ord: Ordering[B]): StreamView[(A, B), Coll]` ###
...
### `def sortWith(lt: ((A, B), (A, B)) ⇒ Boolean): StreamView[(A, B), Coll]` ###
...
### `def sorted[B >: (A, B)](implicit ord: Ordering[B]): StreamView[(A, B), Coll]` ###
...
### `def union[B >: (A, B), That](that: GenSeq[B])(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def updated[B >: (A, B), That](index: Int, elem: B)(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
--------------------------------------------------------------------------------
        Concrete Value Members From scala.collection.SeqViewLike.Zipped
--------------------------------------------------------------------------------
...
* Definition Classes
  * Zipped → Transformed → SeqLike → GenSeqLike → Function1
* Exceptions thrown
  * IndexOutOfBoundsException if `idx` does not satisfy `0 <= idx < length` .

(defined at scala.collection.SeqViewLike.Zipped)
...
### `def scan[B >: (A, B), That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def ++:[B >: (A, B), That](xs: collection.Traversable[B])(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def ++:[B >: (A, B), That](xs: TraversableOnce[B])(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def ++[B >: (A, B), That](xs: GenTraversableOnce[B])(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[(A, B), B])(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def dropWhile(p: ((A, B)) ⇒ Boolean): StreamView[(A, B), Coll]`         ###
...
### `def filter(p: ((A, B)) ⇒ Boolean): StreamView[(A, B), Coll]`            ###
...
### `def filterNot(p: ((A, B)) ⇒ Boolean): StreamView[(A, B), Coll]`         ###
...
### `def flatMap[B, That](f: ((A, B)) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def flatten[B](implicit asTraversable: ((A, B)) ⇒ GenTraversableOnce[B]): Zipped.Transformed[B]` ###
...
### `def groupBy[K](f: ((A, B)) ⇒ K): Map[K, StreamView[(A, B), Coll]]`      ###
...
### `def inits: Iterator[StreamView[(A, B), Coll]]`                          ###
...
### `def map[B, That](f: ((A, B)) ⇒ B)(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def newBuilder: Builder[(A, B), StreamView[(A, B), Coll]]`              ###
...
### `def partition(p: ((A, B)) ⇒ Boolean): (StreamView[(A, B), Coll], StreamView[(A, B), Coll])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, (A, B)) ⇒ B)(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: ((A, B), B) ⇒ B)(implicit bf: CanBuildFrom[StreamView[(A, B), Coll], B, That]): That` ###
...
### `def slice(from: Int, until: Int): StreamView[(A, B), Coll]`             ###
...
### `def span(p: ((A, B)) ⇒ Boolean): (StreamView[(A, B), Coll], StreamView[(A, B), Coll])` ###
...
### `def splitAt(n: Int): (StreamView[(A, B), Coll], StreamView[(A, B), Coll])` ###
...
### `def tails: Iterator[StreamView[(A, B), Coll]]`                          ###
...
### `def takeWhile(p: ((A, B)) ⇒ Boolean): StreamView[(A, B), Coll]`         ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: ((A, B)) ⇒ (A1, A2, A3)): (Zipped.Transformed[A1], Zipped.Transformed[A2], Zipped.Transformed[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: ((A, B)) ⇒ (A1, A2)): (Zipped.Transformed[A1], Zipped.Transformed[A2])` ###
...
### `def withFilter(p: ((A, B)) ⇒ Boolean): StreamView[(A, B), Coll]`        ###
...
### `def thisSeq: collection.Seq[(A, B)]`                                    ###
...
### `def transpose[B](implicit asTraversable: ((A, B)) ⇒ GenTraversableOnce[B]): collection.Seq[collection.Seq[B]]` ###
...
### `def force[B >: (A, B), That](implicit bf: CanBuildFrom[Coll, B, That]): That` ###
...
### `def newAppended[B >: (A, B)](that: GenTraversable[B]): Transformed[B]`  ###
...
### `def newDroppedWhile(p: ((A, B)) ⇒ Boolean): Transformed[(A, B)]`        ###
...
### `def newFiltered(p: ((A, B)) ⇒ Boolean): Transformed[(A, B)]`            ###
...
### `def newFlatMapped[B](f: ((A, B)) ⇒ GenTraversableOnce[B]): Transformed[B]` ###
...
### `def newMapped[B](f: ((A, B)) ⇒ B): Transformed[B]`                      ###
...
### `def newPatched[B >: (A, B)](_from: Int, _patch: GenSeq[B], _replaced: Int): Transformed[B]` ###
...
### `def newPrepended[B >: (A, B)](that: GenTraversable[B]): Transformed[B]` ###
...
### `def newReversed: Transformed[(A, B)]`                                   ###
...
### `def newSliced(_endpoints: SliceInterval): Transformed[(A, B)]`          ###
...
### `def newTakenWhile(p: ((A, B)) ⇒ Boolean): Transformed[(A, B)]`          ###
...
### `def newZippedAll[A1 >: (A, B), B](that: GenIterable[B], _thisElem: A1, _thatElem: B): Transformed[(A1, B)]` ###
...
### `def newZipped[B](that: GenIterable[B]): Transformed[((A, B), B)]`       ###
...
* Implicit information
  * This member is added by an implicit conversion from Zipped [B] to
    CollectionsHaveToParArray [Zipped [B], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Zipped [B]) ⇒
