...
### `def reduce[A1 >: (Pub, Evt)](op: (A1, A1) ⇒ A1): A1`                    ###
...
--------------------------------------------------------------------------------
     Instance Constructors From scala.collection.mutable.RevertibleHistory
--------------------------------------------------------------------------------


### `new RevertibleHistory()`                                                ###

(defined at scala.collection.mutable.RevertibleHistory)
...
* Implicit information
  * This member is added by an implicit conversion from RevertibleHistory [Evt,
    Pub] to CollectionsHaveToParArray [RevertibleHistory [Evt, Pub], T]
    ...
    RevertibleHistory [Evt, Pub]) ⇒ GenTraversableOnce [T] is in scope.
* Definition Classes
