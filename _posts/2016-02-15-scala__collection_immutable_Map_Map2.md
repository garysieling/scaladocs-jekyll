...
--------------------------------------------------------------------------------
         Instance Constructors From scala.collection.immutable.Map.Map2
--------------------------------------------------------------------------------


### `new Map2(key1: A, value1: B, key2: A, value2: B)`                       ###

(defined at scala.collection.immutable.Map.Map2)


--------------------------------------------------------------------------------
             Value Members From scala.collection.immutable.Map.Map2
--------------------------------------------------------------------------------
...
* Definition Classes
  * Map2 → Map → MapLike → MapLike → GenMapLike
...
* Definition Classes
  * Map2 → MapLike → Subtractable → GenMapLike
...
* Definition Classes
  * Map2 → MapLike → Function1 → GenMapLike
...
* Definition Classes
  * Map2 → IterableLike → GenericTraversableTemplate → TraversableLike →
...
* Definition Classes
  * Map2 → Map → MapLike → MapLike → GenMap
...
* Implicit information
  * This member is added by an implicit conversion from Map2 [A, B] to
    CollectionsHaveToParArray [Map2 [A, B], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Map2 [A, B]) ⇒
