...
### `def dropWhile(p: (Unit) ⇒ Boolean): Array[Unit]`                        ###
...
### `def span(p: (Unit) ⇒ Boolean): (Array[Unit], Array[Unit])`              ###
...
### `def takeWhile(p: (Unit) ⇒ Boolean): Array[Unit]`                        ###
...
### `def zip[A1 >: Unit, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[Array[Unit], (A1, B), That]): That` ###
...
### `def zipAll[B, A1 >: Unit, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[Array[Unit], (A1, B), That]): That` ###
...
### `def +:[B >: Unit, That](elem: B)(implicit bf: CanBuildFrom[Array[Unit], B, That]): That` ###
...
### `def diff[B >: Unit](that: GenSeq[B]): Array[Unit]`                      ###
...
### `def intersect[B >: Unit](that: GenSeq[B]): Array[Unit]`                 ###
...
### `def padTo[B >: Unit, That](len: Int, elem: B)(implicit bf: CanBuildFrom[Array[Unit], B, That]): That` ###
...
### `def patch[B >: Unit, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[Array[Unit], B, That]): That` ###
...
### `def sortBy[B](f: (Unit) ⇒ B)(implicit ord: math.Ordering[B]): Array[Unit]` ###
...
### `def sortWith(lt: (Unit, Unit) ⇒ Boolean): Array[Unit]`                  ###
...
### `def union[B >: Unit, That](that: GenSeq[B])(implicit bf: CanBuildFrom[Array[Unit], B, That]): That` ###
...
### `def updated[B >: Unit, That](index: Int, elem: B)(implicit bf: CanBuildFrom[Array[Unit], B, That]): That` ###
...
### `def ++:[B >: Unit, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[Array[Unit], B, That]): That` ###
...
### `def filter(p: (Unit) ⇒ Boolean): Array[Unit]`                           ###
...
### `def filterNot(p: (Unit) ⇒ Boolean): Array[Unit]`                        ###
...
### `def groupBy[K](f: (Unit) ⇒ K): immutable.Map[K, Array[Unit]]`           ###
...
### `def partition(p: (Unit) ⇒ Boolean): (Array[Unit], Array[Unit])`         ###
...
### `def scanLeft[B, That](z: B)(op: (B, Unit) ⇒ B)(implicit bf: CanBuildFrom[Array[Unit], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Unit, B) ⇒ B)(implicit bf: CanBuildFrom[Array[Unit], B, That]): That` ###
...
### `def scan[B >: Unit, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[Array[Unit], B, That]): That` ###
...
### `def withFilter(p: (Unit) ⇒ Boolean): FilterMonadic[Unit, Array[Unit]]`  ###
...
### `def copyToArray[U >: Unit](xs: Array[U], start: Int, len: Int): Unit`   ###
...
### `def flatten[U](implicit asTrav: (Unit) ⇒ collection.Traversable[U], m: ClassTag[U]): Array[U]` ###
...
### `def transpose[U](implicit asArray: (Unit) ⇒ Array[U]): Array[Array[U]]` ###
...
### `def unzip3[T1, T2, T3](implicit asTriple: (Unit) ⇒ (T1, T2, T3), ct1: ClassTag[T1], ct2: ClassTag[T2], ct3: ClassTag[T3]): (Array[T1], Array[T2], Array[T3])` ###
...
### `def unzip[T1, T2](implicit asPair: (Unit) ⇒ (T1, T2), ct1: ClassTag[T1], ct2: ClassTag[T2]): (Array[T1], Array[T2])` ###
...
--------------------------------------------------------------------------------
      Instance Constructors From scala.collection.mutable.ArrayOps.ofUnit
--------------------------------------------------------------------------------


### `new ofUnit(repr: Array[Unit])`                                          ###

(defined at scala.collection.mutable.ArrayOps.ofUnit)


--------------------------------------------------------------------------------
          Value Members From scala.collection.mutable.ArrayOps.ofUnit
--------------------------------------------------------------------------------
...
* Attributes
  * protected[this]
* Definition Classes
  * ofUnit → TraversableLike → HasNewBuilder
...
* Attributes
  * protected[this]
* Definition Classes
  * ofUnit → IndexedSeqLike → IndexedSeqLike → SeqLike → IterableLike →
    TraversableLike
