...
### `def newAppended[B >: A](that: GenTraversable[B]): TakenWhile.Transformed[B]` ###
...
### `def newFlatMapped[B](f: (A) ⇒ GenTraversableOnce[B]): TakenWhile.Transformed[B]` ###
...
### `def newForced[B](xs: ⇒ GenSeq[B]): TakenWhile.Transformed[B]`           ###
...
### `def newMapped[B](f: (A) ⇒ B): TakenWhile.Transformed[B]`                ###
...
### `def newPatched[B >: A](_from: Int, _patch: GenSeq[B], _replaced: Int): TakenWhile.Transformed[B]` ###
...
### `def newPrepended[B >: A](that: GenTraversable[B]): TakenWhile.Transformed[B]` ###
...
### `def newZippedAll[A1 >: A, B](that: GenIterable[B], _thisElem: A1, _thatElem: B): TakenWhile.Transformed[(A1, B)]` ###
...
### `def newZipped[B](that: GenIterable[B]): TakenWhile.Transformed[(A, B)]` ###
...
--------------------------------------------------------------------------------
 Concrete Value Members From scala.collection.mutable.IndexedSeqView.TakenWhile
--------------------------------------------------------------------------------
...
* Definition Classes
  * TakenWhile → Transformed → IndexedSeqView → IndexedSeqLike → SeqLike
* Exceptions thrown
  * IndexOutOfBoundsException if the index is not valid.

(defined at scala.collection.mutable.IndexedSeqView.TakenWhile)
...
### `def transform(f: (A) ⇒ A): TakenWhile.this.type`                        ###
