...
### `abstract type Pub <: ObservableSet[A]`                                  ###

* Definition Classes
  * ObservableSet → Publisher
...
### `def ++=(xs: TraversableOnce[A]): ObservableSet.this.type`               ###
...
### `def +=(elem1: A, elem2: A, elems: A*): ObservableSet.this.type`         ###
...
--------------------------------------------------------------------------------
       Concrete Value Members From scala.collection.mutable.ObservableSet
--------------------------------------------------------------------------------


### `def +=(elem: A): ObservableSet.this.type`                               ###
...
* Definition Classes
  * ObservableSet → SetLike → Builder → Growable

(defined at scala.collection.mutable.ObservableSet)
...
* Definition Classes
  * ObservableSet → SetLike → Shrinkable
...
* Implicit information
  * This member is added by an implicit conversion from ObservableSet [A] to
    CollectionsHaveToParArray [ObservableSet [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ObservableSet [A]) ⇒
