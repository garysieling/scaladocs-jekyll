...
### `abstract def seq: immutable.Map[K, V]`                                  ###
...
### `def bf2seq[S, That](bf: CanBuildFrom[ParMap[K, V], S, That]): CanBuildFrom[immutable.Map[K, V], S, That]` ###
...
### `def sequentially[S, That <: Parallel](b: (immutable.Map[K, V]) ⇒ Parallelizable[S, That]): ParMap[K, V]` ###
...
### `def view: IterableView[(K, V), immutable.Map[K, V]]`                    ###
...
--------------------------------------------------------------------------------
     Abstract Value Members From scala.collection.parallel.immutable.ParMap
--------------------------------------------------------------------------------


### `abstract def +[U >: V](kv: (K, U)): ParMap[K, U]`                       ###

* Definition Classes
  * ParMap → ParMap → GenMapLike

(defined at scala.collection.parallel.immutable.ParMap)


--------------------------------------------------------------------------------
     Concrete Value Members From scala.collection.parallel.immutable.ParMap
--------------------------------------------------------------------------------
