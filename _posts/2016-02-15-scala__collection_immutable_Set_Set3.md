...
--------------------------------------------------------------------------------
             Value Members From scala.collection.immutable.Set.Set3
--------------------------------------------------------------------------------
...
* Definition Classes
  * Set3 → SetLike → GenSetLike

(defined at scala.collection.immutable.Set.Set3)
...
* Definition Classes
  * Set3 → SetLike → Subtractable → GenSetLike
...
* Definition Classes
  * Set3 → IterableLike → TraversableLike → TraversableOnce → GenTraversableOnce
...
* Definition Classes
  * Set3 → IterableLike → GenericTraversableTemplate → TraversableLike →
...
* Definition Classes
  * Set3 → Set → TraversableOnce → GenTraversableOnce
* Annotations
...
* Implicit information
  * This member is added by an implicit conversion from Set3 [A] to
    CollectionsHaveToParArray [Set3 [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Set3 [A]) ⇒ GenTraversableOnce
    [T] is in scope.
* Definition Classes
