...
--------------------------------------------------------------------------------
   Instance Constructors From scala.collection.immutable.HashMap.HashTrieMap
--------------------------------------------------------------------------------


### `new HashTrieMap(bitmap: HashMap.Int, elems: Array[HashMap[A, B]], size0: HashMap.Int)` ###

(defined at scala.collection.immutable.HashMap.HashTrieMap)


--------------------------------------------------------------------------------
       Value Members From scala.collection.immutable.HashMap.HashTrieMap
--------------------------------------------------------------------------------
...
* Definition Classes
  * HashTrieMap → HashMap → IterableLike → GenericTraversableTemplate →
...
* Definition Classes
  * HashTrieMap → HashMap → GenTraversableLike → TraversableOnce →
    GenTraversableOnce
...
* Implicit information
  * This member is added by an implicit conversion from HashTrieMap [A, B] to
    CollectionsHaveToParArray [HashTrieMap [A, B], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (HashTrieMap [A, B]) ⇒
