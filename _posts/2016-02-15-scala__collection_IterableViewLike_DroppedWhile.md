...
### `def slice(from: Int, until: Int): IterableView[A, Coll]`                ###
...
### `def takeWhile(p: (A) ⇒ Boolean): IterableView[A, Coll]`                 ###
...
### `def toCollection(repr: IterableView[A, Coll]): Iterable[A]`             ###
...
### `def view(from: Int, until: Int): IterableView[A, IterableView[A, Coll]]` ###
...
### `def view: IterableView[A, IterableView[A, Coll]]`                       ###
...
### `def drop(n: Int): IterableView[A, Coll]`                                ###
...
### `def dropRight(n: Int): IterableView[A, Coll]`                           ###
...
### `def grouped(size: Int): Iterator[IterableView[A, Coll]]`                ###
...
### `def sliding(size: Int): Iterator[IterableView[A, Coll]]`                ###
...
### `def sliding(size: Int, step: Int): Iterator[IterableView[A, Coll]]`     ###
...
### `def take(n: Int): IterableView[A, Coll]`                                ###
...
### `def takeRight(n: Int): IterableView[A, Coll]`                           ###
...
### `def zipAll[B, A1 >: A, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[IterableView[A, Coll], (A1, B), That]): That` ###
...
### `def zip[A1 >: A, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[IterableView[A, Coll], (A1, B), That]): That` ###
...
### `def scan[B >: A, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[IterableView[A, Coll], B, That]): That` ###
...
### `def ++:[B >: A, That](xs: Traversable[B])(implicit bf: CanBuildFrom[IterableView[A, Coll], B, That]): That` ###
...
### `def ++:[B >: A, That](xs: TraversableOnce[B])(implicit bf: CanBuildFrom[IterableView[A, Coll], B, That]): That` ###
...
### `def ++[B >: A, That](xs: GenTraversableOnce[B])(implicit bf: CanBuildFrom[IterableView[A, Coll], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[A, B])(implicit bf: CanBuildFrom[IterableView[A, Coll], B, That]): That` ###
...
### `def dropWhile(p: (A) ⇒ Boolean): IterableView[A, Coll]`                 ###
...
### `def filter(p: (A) ⇒ Boolean): IterableView[A, Coll]`                    ###
...
### `def filterNot(p: (A) ⇒ Boolean): IterableView[A, Coll]`                 ###
...
### `def flatMap[B, That](f: (A) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[IterableView[A, Coll], B, That]): That` ###
...
### `def groupBy[K](f: (A) ⇒ K): immutable.Map[K, IterableView[A, Coll]]`    ###
...
### `def inits: Iterator[IterableView[A, Coll]]`                             ###
...
### `def map[B, That](f: (A) ⇒ B)(implicit bf: CanBuildFrom[IterableView[A, Coll], B, That]): That` ###
...
### `def newBuilder: Builder[A, IterableView[A, Coll]]`                      ###
...
### `def partition(p: (A) ⇒ Boolean): (IterableView[A, Coll], IterableView[A, Coll])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, A) ⇒ B)(implicit bf: CanBuildFrom[IterableView[A, Coll], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (A, B) ⇒ B)(implicit bf: CanBuildFrom[IterableView[A, Coll], B, That]): That` ###
...
### `def span(p: (A) ⇒ Boolean): (IterableView[A, Coll], IterableView[A, Coll])` ###
...
### `def splitAt(n: Int): (IterableView[A, Coll], IterableView[A, Coll])`    ###
...
### `def tails: Iterator[IterableView[A, Coll]]`                             ###
...
### `def withFilter(p: (A) ⇒ Boolean): IterableView[A, Coll]`                ###
