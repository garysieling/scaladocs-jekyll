...
### `def newDropped(n: Int): Forced.Transformed[B]`                          ###
...
### `def newTaken(n: Int): Forced.Transformed[B]`                            ###
...
--------------------------------------------------------------------------------
        Concrete Value Members From scala.collection.SeqViewLike.Forced
--------------------------------------------------------------------------------
...
* Definition Classes
  * Forced → Transformed → SeqLike → GenSeqLike → Function1
* Exceptions thrown
  * IndexOutOfBoundsException if `idx` does not satisfy `0 <= idx < length` .

(defined at scala.collection.SeqViewLike.Forced)
...
### `def flatten[B](implicit asTraversable: (B) ⇒ GenTraversableOnce[B]): Forced.Transformed[B]` ###
