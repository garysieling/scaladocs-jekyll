...
### `def newDropped(n: Int): Filtered.Transformed[A]`                        ###
...
### `def newTaken(n: Int): Filtered.Transformed[A]`                          ###
...
### `def flatten[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): Filtered.Transformed[B]` ###
