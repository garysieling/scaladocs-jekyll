...
--------------------------------------------------------------------------------
       Instance Constructors From scala.collection.immutable.ListSet.Node
--------------------------------------------------------------------------------


### `new Node(head: A)`                                                      ###

(defined at scala.collection.immutable.ListSet.Node)


--------------------------------------------------------------------------------
           Value Members From scala.collection.immutable.ListSet.Node
--------------------------------------------------------------------------------
...
* Definition Classes
  * Node → ListSet → SetLike → GenSetLike
...
* Definition Classes
  * Node → ListSet → SetLike → Subtractable → GenSetLike
...
* Definition Classes
  * Node → ListSet → TraversableLike → GenTraversableLike
* Exceptions thrown
  *
...
* Implicit information
  * This member is added by an implicit conversion from Node to
    CollectionsHaveToParArray [Node, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Node) ⇒ GenTraversableOnce [T]
    is in scope.
* Definition Classes
