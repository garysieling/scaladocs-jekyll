...
```scala
class BufferedLineIterator extends AbstractIterator[String] with collection.Iterator[String]
```
...
--------------------------------------------------------------------------------
    Instance Constructors From scala.io.BufferedSource.BufferedLineIterator
--------------------------------------------------------------------------------


### `new BufferedLineIterator()`                                             ###
(defined at scala.io.BufferedSource.BufferedLineIterator)
