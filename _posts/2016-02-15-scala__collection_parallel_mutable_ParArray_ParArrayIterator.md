...
### `def appendParIterable[U >: T, PI <: IterableSplitter[U]](that: PI): ParArrayIterator.Appended[U, PI]` ###
...
--------------------------------------------------------------------------------
Instance Constructors From scala.collection.parallel.mutable.ParArray.ParArrayIterator
--------------------------------------------------------------------------------


### `new ParArrayIterator(i: Int = 0, until: Int = length, arr: Array[Any] = array)` ###

(defined at scala.collection.parallel.mutable.ParArray.ParArrayIterator)


--------------------------------------------------------------------------------
 Value Members From scala.collection.parallel.mutable.ParArray.ParArrayIterator
--------------------------------------------------------------------------------
...
* Definition Classes
  * ParArrayIterator → AugmentedIterableIterator → Iterator → TraversableOnce →
    GenTraversableOnce
...
* Definition Classes
  * ParArrayIterator → AugmentedIterableIterator → TraversableOnce →
    GenTraversableOnce
...
* Definition Classes
  * ParArrayIterator → IterableSplitter → Iterator
...
### `def sameElements(that: scala.Iterator[_]): Boolean`                     ###
...
* Definition Classes
  * ParArrayIterator → SeqSplitter → PreciseSplitter → IterableSplitter →
    Splitter
...
* Implicit information
  * This member is added by an implicit conversion from ParArrayIterator to
    CollectionsHaveToParArray [ParArrayIterator, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ParArrayIterator) ⇒
