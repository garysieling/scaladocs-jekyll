...
### `def groupBy[K](f: (A) ⇒ K): immutable.Map[K, IndexedSeq[A]]`            ###
...
--------------------------------------------------------------------------------
      Abstract Value Members From scala.collection.mutable.IndexedSeqLike
--------------------------------------------------------------------------------
...
### `def toCollection(repr: IndexedSeq[A]): IndexedSeq[A]`                   ###
...
### `def view(from: Int, until: Int): IndexedSeqView[A, IndexedSeq[A]]`      ###
...
### `def view: IndexedSeqView[A, IndexedSeq[A]]`                             ###
...
### `def transform(f: (A) ⇒ A): IndexedSeq.this.type`                        ###
