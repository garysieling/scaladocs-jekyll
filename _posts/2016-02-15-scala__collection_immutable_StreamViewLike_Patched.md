...
### `def newDropped(n: Int): Patched.Transformed[B]`                         ###
...
### `def newTaken(n: Int): Patched.Transformed[B]`                           ###
...
--------------------------------------------------------------------------------
        Abstract Value Members From scala.collection.SeqViewLike.Patched
--------------------------------------------------------------------------------


### `abstract val patch: GenSeq[B]`                                          ###
...
(defined at scala.collection.SeqViewLike.Patched)


--------------------------------------------------------------------------------
        Concrete Value Members From scala.collection.SeqViewLike.Patched
--------------------------------------------------------------------------------
...
* Definition Classes
  * Patched → Transformed → SeqLike → GenSeqLike → Function1
* Exceptions thrown
...
### `def flatten[B](implicit asTraversable: (B) ⇒ GenTraversableOnce[B]): Patched.Transformed[B]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (B) ⇒ (A1, A2, A3)): (Patched.Transformed[A1], Patched.Transformed[A2], Patched.Transformed[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (B) ⇒ (A1, A2)): (Patched.Transformed[A1], Patched.Transformed[A2])` ###
...
* Implicit information
  * This member is added by an implicit conversion from Patched [B] to
    CollectionsHaveToParArray [Patched [B], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Patched [B]) ⇒
