...
### `def drop(n: Int): SeqView[(A, B), Coll]`                                ###
...
### `def dropRight(n: Int): SeqView[(A, B), Coll]`                           ###
...
### `def grouped(size: Int): Iterator[SeqView[(A, B), Coll]]`                ###
...
### `def sliding(size: Int): Iterator[SeqView[(A, B), Coll]]`                ###
...
### `def sliding(size: Int, step: Int): Iterator[SeqView[(A, B), Coll]]`     ###
...
### `def take(n: Int): SeqView[(A, B), Coll]`                                ###
...
### `def takeRight(n: Int): SeqView[(A, B), Coll]`                           ###
...
### `def zipAll[B, A1 >: (A, B), That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], (A1, B), That]): That` ###
...
### `def zip[A1 >: (A, B), B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], (A1, B), That]): That` ###
...
### `def toCollection(repr: SeqView[(A, B), Coll]): Seq[(A, B)]`             ###
...
### `def view(from: Int, until: Int): SeqView[(A, B), SeqView[(A, B), Coll]]` ###
...
### `def view: SeqView[(A, B), SeqView[(A, B), Coll]]`                       ###
...
### `def +:[B >: (A, B), That](elem: B)(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[SeqView[(A, B), Coll]]`              ###
...
### `def diff[B >: (A, B)](that: GenSeq[B]): SeqView[(A, B), Coll]`          ###
...
### `def intersect[B >: (A, B)](that: GenSeq[B]): SeqView[(A, B), Coll]`     ###
...
### `def newDropped(n: Int): Transformed[(A, B)]`                            ###
...
### `def newTaken(n: Int): Transformed[(A, B)]`                              ###
...
### `def padTo[B >: (A, B), That](len: Int, elem: B)(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def patch[B >: (A, B), That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def permutations: Iterator[SeqView[(A, B), Coll]]`                      ###
...
### `def reverseMap[B, That](f: ((A, B)) ⇒ B)(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def sortBy[B](f: ((A, B)) ⇒ B)(implicit ord: Ordering[B]): SeqView[(A, B), Coll]` ###
...
### `def sortWith(lt: ((A, B), (A, B)) ⇒ Boolean): SeqView[(A, B), Coll]`    ###
...
### `def sorted[B >: (A, B)](implicit ord: Ordering[B]): SeqView[(A, B), Coll]` ###
...
### `def union[B >: (A, B), That](that: GenSeq[B])(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def updated[B >: (A, B), That](index: Int, elem: B)(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def scan[B >: (A, B), That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def ++:[B >: (A, B), That](xs: Traversable[B])(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def ++:[B >: (A, B), That](xs: TraversableOnce[B])(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def ++[B >: (A, B), That](xs: GenTraversableOnce[B])(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[(A, B), B])(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def dropWhile(p: ((A, B)) ⇒ Boolean): SeqView[(A, B), Coll]`            ###
...
### `def filter(p: ((A, B)) ⇒ Boolean): SeqView[(A, B), Coll]`               ###
...
### `def filterNot(p: ((A, B)) ⇒ Boolean): SeqView[(A, B), Coll]`            ###
...
### `def flatMap[B, That](f: ((A, B)) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def groupBy[K](f: ((A, B)) ⇒ K): immutable.Map[K, SeqView[(A, B), Coll]]` ###
...
### `def inits: Iterator[SeqView[(A, B), Coll]]`                             ###
...
### `def map[B, That](f: ((A, B)) ⇒ B)(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def newBuilder: Builder[(A, B), SeqView[(A, B), Coll]]`                 ###
...
### `def partition(p: ((A, B)) ⇒ Boolean): (SeqView[(A, B), Coll], SeqView[(A, B), Coll])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, (A, B)) ⇒ B)(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: ((A, B), B) ⇒ B)(implicit bf: CanBuildFrom[SeqView[(A, B), Coll], B, That]): That` ###
...
### `def slice(from: Int, until: Int): SeqView[(A, B), Coll]`                ###
...
### `def span(p: ((A, B)) ⇒ Boolean): (SeqView[(A, B), Coll], SeqView[(A, B), Coll])` ###
...
### `def splitAt(n: Int): (SeqView[(A, B), Coll], SeqView[(A, B), Coll])`    ###
...
### `def tails: Iterator[SeqView[(A, B), Coll]]`                             ###
...
### `def takeWhile(p: ((A, B)) ⇒ Boolean): SeqView[(A, B), Coll]`            ###
...
### `def withFilter(p: ((A, B)) ⇒ Boolean): SeqView[(A, B), Coll]`           ###
...
### `def transpose[B](implicit asTraversable: ((A, B)) ⇒ GenTraversableOnce[B]): Seq[Seq[B]]` ###
