...
Converts this mutable set of traversable collections into a mutable set formed
...
### `def ++=(xs: TraversableOnce[A]): ImmutableSetAdaptor.this.type`         ###
...
### `def +=(elem1: A, elem2: A, elems: A*): ImmutableSetAdaptor.this.type`   ###
...
--------------------------------------------------------------------------------
    Instance Constructors From scala.collection.mutable.ImmutableSetAdaptor
--------------------------------------------------------------------------------


### `new ImmutableSetAdaptor(set: immutable.Set[A])`                         ###

(defined at scala.collection.mutable.ImmutableSetAdaptor)


--------------------------------------------------------------------------------
        Value Members From scala.collection.mutable.ImmutableSetAdaptor
--------------------------------------------------------------------------------
...
* Definition Classes
  * ImmutableSetAdaptor → SetLike → Builder → Growable
...
* Definition Classes
  * ImmutableSetAdaptor → SetLike → Shrinkable
...
* Definition Classes
  * ImmutableSetAdaptor → SetLike → GenSetLike
...
* p
  * the predicate used to test elements.
* returns
  * `false` if this mutable set is empty, otherwise `true` if the given
    predicate `p` holds for some of the elements of this mutable set, otherwise
     `false`

* Definition Classes
  * ImmutableSetAdaptor → IterableLike → TraversableLike → TraversableOnce →
    GenTraversableOnce
...
* Definition Classes
  * ImmutableSetAdaptor → IterableLike → GenericTraversableTemplate →
...
* Implicit information
  * This member is added by an implicit conversion from ImmutableSetAdaptor [A]
    to CollectionsHaveToParArray [ImmutableSetAdaptor [A], T] performed by
    ...
    ImmutableSetAdaptor [A]) ⇒ GenTraversableOnce [T] is in scope.
* Definition Classes
