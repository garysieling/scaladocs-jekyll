...
### `def drop(n: Int): WrappedArray[Short]`                                  ###
...
### `def dropRight(n: Int): WrappedArray[Short]`                             ###
...
### `def dropWhile(p: (Short) ⇒ Boolean): WrappedArray[Short]`               ###
...
### `def reverse: WrappedArray[Short]`                                       ###
...
### `def slice(from: Int, until: Int): WrappedArray[Short]`                  ###
...
### `def span(p: (Short) ⇒ Boolean): (WrappedArray[Short], WrappedArray[Short])` ###
...
### `def splitAt(n: Int): (WrappedArray[Short], WrappedArray[Short])`        ###
...
### `def take(n: Int): WrappedArray[Short]`                                  ###
...
### `def takeRight(n: Int): WrappedArray[Short]`                             ###
...
### `def takeWhile(p: (Short) ⇒ Boolean): WrappedArray[Short]`               ###
...
### `def zipWithIndex[A1 >: Short, That](implicit bf: CanBuildFrom[WrappedArray[Short], (A1, Int), That]): That` ###
...
### `def zip[A1 >: Short, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[WrappedArray[Short], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[WrappedArray[Short]]`                  ###
...
### `def sliding(size: Int): Iterator[WrappedArray[Short]]`                  ###
...
### `def sliding(size: Int, step: Int): Iterator[WrappedArray[Short]]`       ###
...
### `def zipAll[B, A1 >: Short, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[WrappedArray[Short], (A1, B), That]): That` ###
...
### `def +:[B >: Short, That](elem: B)(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[WrappedArray[Short]]`                ###
...
### `def diff[B >: Short](that: GenSeq[B]): WrappedArray[Short]`             ###
...
### `def distinct: WrappedArray[Short]`                                      ###
...
### `def intersect[B >: Short](that: GenSeq[B]): WrappedArray[Short]`        ###
...
### `def padTo[B >: Short, That](len: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def patch[B >: Short, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def permutations: Iterator[WrappedArray[Short]]`                        ###
...
### `def reverseMap[B, That](f: (Short) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def sortBy[B](f: (Short) ⇒ B)(implicit ord: math.Ordering[B]): WrappedArray[Short]` ###
...
### `def sortWith(lt: (Short, Short) ⇒ Boolean): WrappedArray[Short]`        ###
...
### `def sorted[B >: Short](implicit ord: math.Ordering[B]): WrappedArray[Short]` ###
...
### `def union[B >: Short, That](that: GenSeq[B])(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def updated[B >: Short, That](index: Int, elem: B)(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def ++:[B >: Short, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def ++:[B >: Short, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def ++[B >: Short, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[Short, B])(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def filter(p: (Short) ⇒ Boolean): WrappedArray[Short]`                  ###
...
### `def filterNot(p: (Short) ⇒ Boolean): WrappedArray[Short]`               ###
...
### `def flatMap[B, That](f: (Short) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def groupBy[K](f: (Short) ⇒ K): immutable.Map[K, WrappedArray[Short]]`  ###
...
### `def inits: Iterator[WrappedArray[Short]]`                               ###
...
### `def map[B, That](f: (Short) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def partition(p: (Short) ⇒ Boolean): (WrappedArray[Short], WrappedArray[Short])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, Short) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Short, B) ⇒ B)(implicit bf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def scan[B >: Short, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[WrappedArray[Short], B, That]): That` ###
...
### `def tails: Iterator[WrappedArray[Short]]`                               ###
...
### `def withFilter(p: (Short) ⇒ Boolean): FilterMonadic[Short, WrappedArray[Short]]` ###
...
### `def flatten[B](implicit asTraversable: (Short) ⇒ GenTraversableOnce[B]): IndexedSeq[B]` ###
...
### `def transpose[B](implicit asTraversable: (Short) ⇒ GenTraversableOnce[B]): IndexedSeq[IndexedSeq[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (Short) ⇒ (A1, A2, A3)): (IndexedSeq[A1], IndexedSeq[A2], IndexedSeq[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (Short) ⇒ (A1, A2)): (IndexedSeq[A1], IndexedSeq[A2])` ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Short, WrappedArray[Short]]` ###
...
### `def view: IndexedSeqView[Short, WrappedArray[Short]]`                   ###
...
### `def transform(f: (Short) ⇒ Short): ofShort.this.type`                   ###
...
### `def newBuilder: Builder[Short, WrappedArray[Short]]`                    ###
...
### `def toCollection(repr: WrappedArray[Short]): WrappedArray[Short]`       ###
...
--------------------------------------------------------------------------------
    Instance Constructors From scala.collection.mutable.WrappedArray.ofShort
--------------------------------------------------------------------------------


### `new ofShort(array: Array[Short])`                                       ###

(defined at scala.collection.mutable.WrappedArray.ofShort)


--------------------------------------------------------------------------------
        Value Members From scala.collection.mutable.WrappedArray.ofShort
--------------------------------------------------------------------------------
...
* Definition Classes
  * ofShort → WrappedArray → SeqLike → GenSeqLike → Function1
...
* Definition Classes
  * ofShort → WrappedArray → IndexedSeqLike → SeqLike
