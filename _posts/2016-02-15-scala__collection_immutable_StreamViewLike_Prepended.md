...
### `def newDropped(n: Int): Prepended.Transformed[B]`                       ###
...
### `def newTaken(n: Int): Prepended.Transformed[B]`                         ###
...
--------------------------------------------------------------------------------
       Concrete Value Members From scala.collection.SeqViewLike.Prepended
--------------------------------------------------------------------------------
...
* Definition Classes
  * Prepended → Transformed → SeqLike → GenSeqLike → Function1
* Exceptions thrown
  * IndexOutOfBoundsException if `idx` does not satisfy `0 <= idx < length` .

(defined at scala.collection.SeqViewLike.Prepended)


### `lazy val fstSeq: GenSeq[B]`                                             ###
...
### `def flatten[B](implicit asTraversable: (B) ⇒ GenTraversableOnce[B]): Prepended.Transformed[B]` ###
