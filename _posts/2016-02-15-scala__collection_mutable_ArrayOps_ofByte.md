...
### `def dropRight(n: Int): Array[Byte]`                                     ###
...
### `def dropWhile(p: (Byte) ⇒ Boolean): Array[Byte]`                        ###
...
### `def span(p: (Byte) ⇒ Boolean): (Array[Byte], Array[Byte])`              ###
...
### `def splitAt(n: Int): (Array[Byte], Array[Byte])`                        ###
...
### `def takeRight(n: Int): Array[Byte]`                                     ###
...
### `def zip[A1 >: Byte, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[Array[Byte], (A1, B), That]): That` ###
...
### `def grouped(size: Int): Iterator[Array[Byte]]`                          ###
...
### `def sliding(size: Int): Iterator[Array[Byte]]`                          ###
...
### `def sliding(size: Int, step: Int): Iterator[Array[Byte]]`               ###
...
### `def zipAll[B, A1 >: Byte, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[Array[Byte], (A1, B), That]): That` ###
...
### `def +:[B >: Byte, That](elem: B)(implicit bf: CanBuildFrom[Array[Byte], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[Array[Byte]]`                        ###
...
### `def diff[B >: Byte](that: GenSeq[B]): Array[Byte]`                      ###
...
### `def intersect[B >: Byte](that: GenSeq[B]): Array[Byte]`                 ###
...
### `def padTo[B >: Byte, That](len: Int, elem: B)(implicit bf: CanBuildFrom[Array[Byte], B, That]): That` ###
...
### `def patch[B >: Byte, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[Array[Byte], B, That]): That` ###
...
### `def permutations: Iterator[Array[Byte]]`                                ###
...
### `def sortBy[B](f: (Byte) ⇒ B)(implicit ord: math.Ordering[B]): Array[Byte]` ###
...
### `def sortWith(lt: (Byte, Byte) ⇒ Boolean): Array[Byte]`                  ###
...
### `def sorted[B >: Byte](implicit ord: math.Ordering[B]): Array[Byte]`     ###
...
### `def union[B >: Byte, That](that: GenSeq[B])(implicit bf: CanBuildFrom[Array[Byte], B, That]): That` ###
...
### `def updated[B >: Byte, That](index: Int, elem: B)(implicit bf: CanBuildFrom[Array[Byte], B, That]): That` ###
...
### `def ++:[B >: Byte, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[Array[Byte], B, That]): That` ###
...
### `def ++:[B >: Byte, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[Array[Byte], B, That]): That` ###
...
### `def ++[B >: Byte, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[Array[Byte], B, That]): That` ###
...
### `def filter(p: (Byte) ⇒ Boolean): Array[Byte]`                           ###
...
### `def filterNot(p: (Byte) ⇒ Boolean): Array[Byte]`                        ###
...
### `def groupBy[K](f: (Byte) ⇒ K): immutable.Map[K, Array[Byte]]`           ###
...
### `def partition(p: (Byte) ⇒ Boolean): (Array[Byte], Array[Byte])`         ###
...
### `def scanLeft[B, That](z: B)(op: (B, Byte) ⇒ B)(implicit bf: CanBuildFrom[Array[Byte], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Byte, B) ⇒ B)(implicit bf: CanBuildFrom[Array[Byte], B, That]): That` ###
...
### `def scan[B >: Byte, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[Array[Byte], B, That]): That` ###
...
### `def withFilter(p: (Byte) ⇒ Boolean): FilterMonadic[Byte, Array[Byte]]`  ###
...
### `def +:[B >: Byte](elem: B)(implicit arg0: ClassTag[B]): Array[B]`       ###
...
### `def copyToArray[U >: Byte](xs: Array[U], start: Int, len: Int): Unit`   ###
...
### `def flatten[U](implicit asTrav: (Byte) ⇒ collection.Traversable[U], m: ClassTag[U]): Array[U]` ###
...
### `def transpose[U](implicit asArray: (Byte) ⇒ Array[U]): Array[Array[U]]` ###
...
### `def unzip3[T1, T2, T3](implicit asTriple: (Byte) ⇒ (T1, T2, T3), ct1: ClassTag[T1], ct2: ClassTag[T2], ct3: ClassTag[T3]): (Array[T1], Array[T2], Array[T3])` ###
...
### `def unzip[T1, T2](implicit asPair: (Byte) ⇒ (T1, T2), ct1: ClassTag[T1], ct2: ClassTag[T2]): (Array[T1], Array[T2])` ###
...
--------------------------------------------------------------------------------
      Instance Constructors From scala.collection.mutable.ArrayOps.ofByte
--------------------------------------------------------------------------------


### `new ofByte(repr: Array[Byte])`                                          ###

(defined at scala.collection.mutable.ArrayOps.ofByte)


--------------------------------------------------------------------------------
          Value Members From scala.collection.mutable.ArrayOps.ofByte
--------------------------------------------------------------------------------
...
### `def newBuilder: ArrayBuilder.ofByte`                                    ###
...
* Attributes
  * protected[this]
* Definition Classes
  * ofByte → TraversableLike → HasNewBuilder
...
* Attributes
  * protected[this]
* Definition Classes
  * ofByte → IndexedSeqLike → IndexedSeqLike → SeqLike → IterableLike →
    TraversableLike

(defined at scala.collection.mutable.ArrayOps.ofByte)


### `def toCollection(repr: Array[Byte]): WrappedArray[Byte]`                ###
...
### `def view(from: Int, until: Int): IndexedSeqView[Byte, Array[Byte]]`     ###
...
### `def view: IndexedSeqView[Byte, Array[Byte]]`                            ###
