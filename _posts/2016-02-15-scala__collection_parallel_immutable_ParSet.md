...
### `def bf2seq[S, That](bf: CanBuildFrom[ParSet[T], S, That]): CanBuildFrom[immutable.Set[T], S, That]` ###
...
mutable parallel set on which the function is defined.
...
parallel set and using the elements of the resulting collections.
...
### `def sequentially[S, That <: Parallel](b: (immutable.Set[T]) ⇒ Parallelizable[S, That]): ParSet[T]` ###
...
### `def view: IterableView[T, immutable.Set[T]]`                            ###
...
--------------------------------------------------------------------------------
     Concrete Value Members From scala.collection.parallel.immutable.ParSet
--------------------------------------------------------------------------------
...
* Definition Classes
  * ParSet → ParIterable → ParSet → ParIterable → GenericParTemplate → GenSet →
...
* Definition Classes
  * ParSet → ParSet → ParSetLike → GenericSetTemplate
