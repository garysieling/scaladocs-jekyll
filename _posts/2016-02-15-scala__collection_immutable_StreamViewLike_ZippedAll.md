...
### `type Self = StreamView[(A1, B), Coll]`                                  ###
...
### `def andThen[C](k: ((A1, B)) ⇒ C): PartialFunction[Int, C]`              ###
...
### `def applyOrElse[A1 <: Int, B1 >: (A1, B)](x: A1, default: (A1) ⇒ B1): B1` ###
...
### `def orElse[A1 <: Int, B1 >: (A1, B)](that: PartialFunction[A1, B1]): PartialFunction[A1, B1]` ###
...
### `def runWith[U](action: ((A1, B)) ⇒ U): (Int) ⇒ Boolean`                 ###
...
### `def indexOf[B >: (A1, B)](elem: B, from: Int): Int`                     ###
...
### `def indexWhere(p: ((A1, B)) ⇒ Boolean): Int`                            ###
...
### `def lastIndexOf[B >: (A1, B)](elem: B): Int`                            ###
...
### `def lastIndexOf[B >: (A1, B)](elem: B, end: Int): Int`                  ###
...
### `def lastIndexWhere(p: ((A1, B)) ⇒ Boolean): Int`                        ###
...
### `def prefixLength(p: ((A1, B)) ⇒ Boolean): Int`                          ###
...
### `def copyToArray[B >: (A1, B)](xs: Array[B], start: Int, len: Int): Unit` ###
...
### `def exists(p: ((A1, B)) ⇒ Boolean): Boolean`                            ###
...
### `def find(p: ((A1, B)) ⇒ Boolean): Option[(A1, B)]`                      ###
...
### `def foldRight[B](z: B)(op: ((A1, B), B) ⇒ B): B`                        ###
...
### `def forall(p: ((A1, B)) ⇒ Boolean): Boolean`                            ###
...
### `def reduceRight[B >: (A1, B)](op: ((A1, B), B) ⇒ B): B`                 ###
...
### `def sameElements[B >: (A1, B)](that: GenIterable[B]): Boolean`          ###
...
### `def toIterable: collection.Iterable[(A1, B)]`                           ###
...
### `def drop(n: Int): StreamView[(A1, B), Coll]`                            ###
...
### `def dropRight(n: Int): StreamView[(A1, B), Coll]`                       ###
...
### `def grouped(size: Int): Iterator[StreamView[(A1, B), Coll]]`            ###
...
### `def sliding(size: Int): Iterator[StreamView[(A1, B), Coll]]`            ###
...
### `def sliding(size: Int, step: Int): Iterator[StreamView[(A1, B), Coll]]` ###
...
### `def take(n: Int): StreamView[(A1, B), Coll]`                            ###
...
### `def takeRight(n: Int): StreamView[(A1, B), Coll]`                       ###
...
### `def zipAll[B, A1 >: (A1, B), That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], (A1, B), That]): That` ###
...
### `def zipWithIndex[A1 >: (A1, B), That](implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], (A1, Int), That]): That` ###
...
### `def zip[A1 >: (A1, B), B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], (A1, B), That]): That` ###
...
--------------------------------------------------------------------------------
    Abstract Value Members From scala.collection.IterableViewLike.ZippedAll
--------------------------------------------------------------------------------


### `abstract val other: GenIterable[B]`                                     ###
...
(defined at scala.collection.IterableViewLike.ZippedAll)


--------------------------------------------------------------------------------
    Concrete Value Members From scala.collection.IterableViewLike.ZippedAll
--------------------------------------------------------------------------------
...
### `def contains[A1 >: (A1, B)](elem: A1): Boolean`                         ###
...
### `def corresponds[B](that: GenSeq[B])(p: ((A1, B), B) ⇒ Boolean): Boolean` ###
...
### `def indexOfSlice[B >: (A1, B)](that: GenSeq[B]): Int`                   ###
...
### `def indexOfSlice[B >: (A1, B)](that: GenSeq[B], from: Int): Int`        ###
...
### `def indexWhere(p: ((A1, B)) ⇒ Boolean, from: Int): Int`                 ###
...
### `def lastIndexOfSlice[B >: (A1, B)](that: GenSeq[B]): Int`               ###
...
### `def lastIndexOfSlice[B >: (A1, B)](that: GenSeq[B], end: Int): Int`     ###
...
### `def lastIndexWhere(p: ((A1, B)) ⇒ Boolean, end: Int): Int`              ###
...
### `def parCombiner: Combiner[(A1, B), ParSeq[(A1, B)]]`                    ###
...
### `def reverseIterator: Iterator[(A1, B)]`                                 ###
...
### `def segmentLength(p: ((A1, B)) ⇒ Boolean, from: Int): Int`              ###
...
### `def thisCollection: collection.Seq[(A1, B)]`                            ###
...
### `def toCollection(repr: StreamView[(A1, B), Coll]): collection.Seq[(A1, B)]` ###
...
### `def view(from: Int, until: Int): SeqView[(A1, B), StreamView[(A1, B), Coll]]` ###
...
### `def view: SeqView[(A1, B), StreamView[(A1, B), Coll]]`                  ###
...
### `def +:[B >: (A1, B), That](elem: B)(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[StreamView[(A1, B), Coll]]`          ###
...
### `def diff[B >: (A1, B)](that: GenSeq[B]): StreamView[(A1, B), Coll]`     ###
...
### `def distinct: StreamView[(A1, B), Coll]`                                ###
...
### `def intersect[B >: (A1, B)](that: GenSeq[B]): StreamView[(A1, B), Coll]` ###
...
### `def newDropped(n: Int): ZippedAll.Transformed[(A1, B)]`                 ###
...
### `def newTaken(n: Int): ZippedAll.Transformed[(A1, B)]`                   ###
...
### `def padTo[B >: (A1, B), That](len: Int, elem: B)(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def patch[B >: (A1, B), That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def permutations: Iterator[StreamView[(A1, B), Coll]]`                  ###
...
### `def reverse: StreamView[(A1, B), Coll]`                                 ###
...
### `def reverseMap[B, That](f: ((A1, B)) ⇒ B)(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def sortBy[B](f: ((A1, B)) ⇒ B)(implicit ord: Ordering[B]): StreamView[(A1, B), Coll]` ###
...
### `def sortWith(lt: ((A1, B), (A1, B)) ⇒ Boolean): StreamView[(A1, B), Coll]` ###
...
### `def sorted[B >: (A1, B)](implicit ord: Ordering[B]): StreamView[(A1, B), Coll]` ###
...
### `def union[B >: (A1, B), That](that: GenSeq[B])(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def updated[B >: (A1, B), That](index: Int, elem: B)(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
--------------------------------------------------------------------------------
       Concrete Value Members From scala.collection.SeqViewLike.ZippedAll
--------------------------------------------------------------------------------
...
* Definition Classes
  * ZippedAll → Transformed → SeqLike → GenSeqLike → Function1
* Exceptions thrown
  * IndexOutOfBoundsException if `idx` does not satisfy `0 <= idx < length` .

(defined at scala.collection.SeqViewLike.ZippedAll)


### `lazy val thatSeq: collection.Seq[B]`                                    ###
...
### `def scan[B >: (A1, B), That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def toTraversable: collection.Traversable[(A1, B)]`                     ###
...
### `def aggregate[B](z: ⇒ B)(seqop: (B, (A1, B)) ⇒ B, combop: (B, B) ⇒ B): B` ###
...
### `def collectFirst[B](pf: PartialFunction[(A1, B), B]): Option[B]`        ###
...
### `def copyToArray[B >: (A1, B)](xs: Array[B]): Unit`                      ###
...
### `def copyToArray[B >: (A1, B)](xs: Array[B], start: Int): Unit`          ###
...
### `def copyToBuffer[B >: (A1, B)](dest: Buffer[B]): Unit`                  ###
...
### `def foldLeft[B](z: B)(op: (B, (A1, B)) ⇒ B): B`                         ###
...
### `def fold[A1 >: (A1, B)](z: A1)(op: (A1, A1) ⇒ A1): A1`                  ###
...
### `def maxBy[B](f: ((A1, B)) ⇒ B)(implicit cmp: Ordering[B]): (A1, B)`     ###
...
### `def minBy[B](f: ((A1, B)) ⇒ B)(implicit cmp: Ordering[B]): (A1, B)`     ###
...
### `def reduceLeftOption[B >: (A1, B)](op: (B, (A1, B)) ⇒ B): Option[B]`    ###
...
### `def reduceLeft[B >: (A1, B)](op: (B, (A1, B)) ⇒ B): B`                  ###
...
### `def reduceOption[A1 >: (A1, B)](op: (A1, A1) ⇒ A1): Option[A1]`         ###
...
### `def reduceRightOption[B >: (A1, B)](op: ((A1, B), B) ⇒ B): Option[B]`   ###
...
### `def reduce[A1 >: (A1, B)](op: (A1, A1) ⇒ A1): A1`                       ###
...
### `def toIndexedSeq: IndexedSeq[(A1, B)]`                                  ###
...
### `def toMap[T, U](implicit ev: <:<[(A1, B), (T, U)]): Map[T, U]`          ###
...
### `def toVector: scala.Vector[(A1, B)]`                                    ###
...
### `def ++:[B >: (A1, B), That](xs: collection.Traversable[B])(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def ++:[B >: (A1, B), That](xs: TraversableOnce[B])(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def ++[B >: (A1, B), That](xs: GenTraversableOnce[B])(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[(A1, B), B])(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def dropWhile(p: ((A1, B)) ⇒ Boolean): StreamView[(A1, B), Coll]`       ###
...
### `def filter(p: ((A1, B)) ⇒ Boolean): StreamView[(A1, B), Coll]`          ###
...
### `def filterNot(p: ((A1, B)) ⇒ Boolean): StreamView[(A1, B), Coll]`       ###
...
### `def flatMap[B, That](f: ((A1, B)) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def flatten[B](implicit asTraversable: ((A1, B)) ⇒ GenTraversableOnce[B]): ZippedAll.Transformed[B]` ###
...
### `def groupBy[K](f: ((A1, B)) ⇒ K): Map[K, StreamView[(A1, B), Coll]]`    ###
...
### `def inits: Iterator[StreamView[(A1, B), Coll]]`                         ###
...
### `def map[B, That](f: ((A1, B)) ⇒ B)(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def newBuilder: Builder[(A1, B), StreamView[(A1, B), Coll]]`            ###
...
### `def partition(p: ((A1, B)) ⇒ Boolean): (StreamView[(A1, B), Coll], StreamView[(A1, B), Coll])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, (A1, B)) ⇒ B)(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: ((A1, B), B) ⇒ B)(implicit bf: CanBuildFrom[StreamView[(A1, B), Coll], B, That]): That` ###
...
### `def slice(from: Int, until: Int): StreamView[(A1, B), Coll]`            ###
...
### `def span(p: ((A1, B)) ⇒ Boolean): (StreamView[(A1, B), Coll], StreamView[(A1, B), Coll])` ###
...
### `def splitAt(n: Int): (StreamView[(A1, B), Coll], StreamView[(A1, B), Coll])` ###
...
### `def tails: Iterator[StreamView[(A1, B), Coll]]`                         ###
...
### `def takeWhile(p: ((A1, B)) ⇒ Boolean): StreamView[(A1, B), Coll]`       ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: ((A1, B)) ⇒ (A1, A2, A3)): (ZippedAll.Transformed[A1], ZippedAll.Transformed[A2], ZippedAll.Transformed[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: ((A1, B)) ⇒ (A1, A2)): (ZippedAll.Transformed[A1], ZippedAll.Transformed[A2])` ###
...
### `def withFilter(p: ((A1, B)) ⇒ Boolean): StreamView[(A1, B), Coll]`      ###
...
### `def thisSeq: collection.Seq[(A1, B)]`                                   ###
...
### `def transpose[B](implicit asTraversable: ((A1, B)) ⇒ GenTraversableOnce[B]): collection.Seq[collection.Seq[B]]` ###
...
### `def force[B >: (A1, B), That](implicit bf: CanBuildFrom[Coll, B, That]): That` ###
...
### `def newAppended[B >: (A1, B)](that: GenTraversable[B]): Transformed[B]` ###
...
### `def newDroppedWhile(p: ((A1, B)) ⇒ Boolean): Transformed[(A1, B)]`      ###
...
### `def newFiltered(p: ((A1, B)) ⇒ Boolean): Transformed[(A1, B)]`          ###
...
### `def newFlatMapped[B](f: ((A1, B)) ⇒ GenTraversableOnce[B]): Transformed[B]` ###
...
### `def newMapped[B](f: ((A1, B)) ⇒ B): Transformed[B]`                     ###
...
### `def newPatched[B >: (A1, B)](_from: Int, _patch: GenSeq[B], _replaced: Int): Transformed[B]` ###
...
### `def newPrepended[B >: (A1, B)](that: GenTraversable[B]): Transformed[B]` ###
...
### `def newReversed: Transformed[(A1, B)]`                                  ###
...
### `def newSliced(_endpoints: SliceInterval): Transformed[(A1, B)]`         ###
...
### `def newTakenWhile(p: ((A1, B)) ⇒ Boolean): Transformed[(A1, B)]`        ###
...
### `def newZippedAll[A1 >: (A1, B), B](that: GenIterable[B], _thisElem: A1, _thatElem: B): Transformed[(A1, B)]` ###
...
### `def newZipped[B](that: GenIterable[B]): Transformed[((A1, B), B)]`      ###
...
* Implicit information
  * This member is added by an implicit conversion from ZippedAll [A1, B] to
    CollectionsHaveToParArray [ZippedAll [A1, B], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (ZippedAll [A1, B]) ⇒
