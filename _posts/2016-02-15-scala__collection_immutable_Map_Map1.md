...
--------------------------------------------------------------------------------
         Instance Constructors From scala.collection.immutable.Map.Map1
--------------------------------------------------------------------------------


### `new Map1(key1: A, value1: B)`                                           ###

(defined at scala.collection.immutable.Map.Map1)


--------------------------------------------------------------------------------
             Value Members From scala.collection.immutable.Map.Map1
--------------------------------------------------------------------------------
...
* Definition Classes
  * Map1 → Map → MapLike → MapLike → GenMapLike
...
* Definition Classes
  * Map1 → MapLike → Subtractable → GenMapLike
...
* Definition Classes
  * Map1 → MapLike → Function1 → GenMapLike
...
* Definition Classes
  * Map1 → IterableLike → GenericTraversableTemplate → TraversableLike →
...
* Definition Classes
  * Map1 → Map → MapLike → MapLike → GenMap
...
* Implicit information
  * This member is added by an implicit conversion from Map1 [A, B] to
    CollectionsHaveToParArray [Map1 [A, B], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Map1 [A, B]) ⇒
