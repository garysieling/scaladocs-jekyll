...
### `def ++=(xs: TraversableOnce[A]): SortedSet.this.type`                   ###
...
### `def +=(elem1: A, elem2: A, elems: A*): SortedSet.this.type`             ###
...
* Implicit information
  * This member is added by an implicit conversion from SortedSet [A] to
    CollectionsHaveToParArray [SortedSet [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (SortedSet [A]) ⇒
