...
--------------------------------------------------------------------------------
  Instance Constructors From scala.collection.immutable.NumericRange.Exclusive
--------------------------------------------------------------------------------


### `new Exclusive(start: T, end: T, step: T)(implicit num: Integral[T])`    ###

(defined at scala.collection.immutable.NumericRange.Exclusive)


--------------------------------------------------------------------------------
      Value Members From scala.collection.immutable.NumericRange.Exclusive
--------------------------------------------------------------------------------
...
* Implicit information
  * This member is added by an implicit conversion from Exclusive [T] to
...
* Implicit information
  * This member is added by an implicit conversion from Exclusive [T] to
    CollectionsHaveToParArray [Exclusive [T], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Exclusive [T]) ⇒
