...
--------------------------------------------------------------------------------
       Instance Constructors From scala.collection.generic.GenSeqFactory
--------------------------------------------------------------------------------


### `new GenSeqFactory()`                                                    ###

(defined at scala.collection.generic.GenSeqFactory)
...
* Implicit information
  * This member is added by an implicit conversion from GenSeqFactory [CC] to
    CollectionsHaveToParArray [GenSeqFactory [CC], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (GenSeqFactory [CC]) ⇒
