...
### `def applyOrElse[A1 <: String, B1 >: String](x: A1, default: (A1) ⇒ B1): B1` ###
...
### `def copyToArray[B >: (String, String)](xs: Array[B], start: Int, len: Int): Unit` ###
...
### `def grouped(size: Int): collection.Iterator[Map[String, String]]`       ###
...
### `def sameElements[B >: (String, String)](that: GenIterable[B]): Boolean` ###
...
### `def sliding(size: Int): collection.Iterator[Map[String, String]]`       ###
...
### `def sliding(size: Int, step: Int): collection.Iterator[Map[String, String]]` ###
...
### `def thisCollection: collection.Iterable[(String, String)]`              ###
...
### `def toCollection(repr: Map[String, String]): collection.Iterable[(String, String)]` ###
...
### `def toIterable: collection.Iterable[(String, String)]`                  ###
...
### `def toIterator: collection.Iterator[(String, String)]`                  ###
...
### `def toStream: collection.immutable.Stream[(String, String)]`            ###
...
### `def view(from: Int, until: Int): IterableView[(String, String), Map[String, String]]` ###
...
### `def view: IterableView[(String, String), Map[String, String]]`          ###
...
### `def zipAll[B, A1 >: (String, String), That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[Map[String, String], (A1, B), That]): That` ###
...
### `def zipWithIndex[A1 >: (String, String), That](implicit bf: CanBuildFrom[Map[String, String], (A1, Int), That]): That` ###
...
### `def zip[A1 >: (String, String), B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[Map[String, String], (A1, B), That]): That` ###
...
### `def filterKeys(p: (String) ⇒ Boolean): Map[String, String]`             ###
...
### `def filterNot(p: ((String, String)) ⇒ Boolean): Map[String, String]`    ###
...
### `def getOrElse[B1 >: String](key: String, default: ⇒ B1): B1`            ###
...
### `def mapValues[C](f: (String) ⇒ C): Map[String, C]`                      ###
...
### `def toBuffer[C >: (String, String)]: Buffer[C]`                         ###
...
### `def valuesIterator: collection.Iterator[String]`                        ###
...
### `def ++:[B >: (String, String), That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[Map[String, String], B, That]): That` ###
...
### `def ++:[B >: (String, String), That](that: collection.TraversableOnce[B])(implicit bf: CanBuildFrom[Map[String, String], B, That]): That` ###
...
### `def ++[B >: (String, String), That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[Map[String, String], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[(String, String), B])(implicit bf: CanBuildFrom[Map[String, String], B, That]): That` ###
...
### `def filter(p: ((String, String)) ⇒ Boolean): Map[String, String]`       ###
...
### `def flatMap[B, That](f: ((String, String)) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[Map[String, String], B, That]): That` ###
...
The type of the resulting collection is guided by the static type of mutable map.
...
### `def groupBy[K](f: ((String, String)) ⇒ K): Map[K, Map[String, String]]` ###
...
### `def inits: collection.Iterator[Map[String, String]]`                    ###
...
### `def map[B, That](f: ((String, String)) ⇒ B)(implicit bf: CanBuildFrom[Map[String, String], B, That]): That` ###
...
### `def scanLeft[B, That](z: B)(op: (B, (String, String)) ⇒ B)(implicit bf: CanBuildFrom[Map[String, String], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: ((String, String), B) ⇒ B)(implicit bf: CanBuildFrom[Map[String, String], B, That]): That` ###
...
### `def scan[B >: (String, String), That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[Map[String, String], B, That]): That` ###
...
### `def tails: collection.Iterator[Map[String, String]]`                    ###
...
### `def toTraversable: collection.Traversable[(String, String)]`            ###
...
### `def withFilter(p: ((String, String)) ⇒ Boolean): FilterMonadic[(String, String), Map[String, String]]` ###
...
### `def /:[B](z: B)(op: (B, (String, String)) ⇒ B): B`                      ###
...
### `def :\[B](z: B)(op: ((String, String), B) ⇒ B): B`                      ###
...
### `def copyToArray[B >: (String, String)](xs: Array[B]): Unit`             ###
...
### `def copyToArray[B >: (String, String)](xs: Array[B], start: Int): Unit` ###
...
### `def copyToBuffer[B >: (String, String)](dest: Buffer[B]): Unit`         ###
...
### `def reduceOption[A1 >: (String, String)](op: (A1, A1) ⇒ A1): Option[A1]` ###
...
### `def reduce[A1 >: (String, String)](op: (A1, A1) ⇒ A1): A1`              ###
...
### `def reversed: List[(String, String)]`                                   ###
...
### `def toIndexedSeq: collection.immutable.IndexedSeq[(String, String)]`    ###
...
### `def toMap[T, U](implicit ev: <:<[(String, String), (T, U)]): Map[T, U]` ###
...
### `def flatten[B](implicit asTraversable: ((String, String)) ⇒ GenTraversableOnce[B]): collection.mutable.Iterable[B]` ###
...
The resulting collection's type will be guided by the static type of mutable map.
For example:
...
* returns
  * a new mutable map resulting from concatenating all element mutable map s.
...
### `def genericBuilder[B]: Builder[B, collection.mutable.Iterable[B]]`      ###
...
### `def transpose[B](implicit asTraversable: ((String, String)) ⇒ GenTraversableOnce[B]): collection.mutable.Iterable[collection.mutable.Iterable[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: ((String, String)) ⇒ (A1, A2, A3)): (collection.mutable.Iterable[A1], collection.mutable.Iterable[A2], collection.mutable.Iterable[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: ((String, String)) ⇒ (A1, A2)): (collection.mutable.Iterable[A1], collection.mutable.Iterable[A2])` ###
...
### `def ++=(xs: collection.TraversableOnce[(String, String)]): SystemProperties.this.type` ###
...
### `def +=(elem1: (String, String), elem2: (String, String), elems: (String, String)*): SystemProperties.this.type` ###
...
### `def --=(xs: collection.TraversableOnce[String]): SystemProperties.this.type` ###
...
### `def -=(elem1: String, elem2: String, elems: String*): SystemProperties.this.type` ###
...
### `def companion: GenericCompanion[collection.mutable.Iterable]`           ###
...
### `def ++[B1 >: String](xs: GenTraversableOnce[(String, B1)]): Map[String, B1]` ###
...
### `def +[B1 >: String](elem1: (String, B1), elem2: (String, B1), elems: (String, B1)*): Map[String, B1]` ###
...
### `def -(elem1: String, elem2: String, elems: String*): Map[String, String]` ###
...
### `def --(xs: GenTraversableOnce[String]): Map[String, String]`            ###
...
### `def newBuilder: Builder[(String, String), Map[String, String]]`         ###
...
### `def parCombiner: Combiner[(String, String), ParMap[String, String]]`    ###
...
### `def retain(p: (String, String) ⇒ Boolean): SystemProperties.this.type`  ###
...
### `def toSeq: collection.Seq[(String, String)]`                            ###
...
### `def transform(f: (String, String) ⇒ String): SystemProperties.this.type` ###
...
### `def updated[B1 >: String](key: String, value: B1): Map[String, B1]`     ###
...
--------------------------------------------------------------------------------
             Instance Constructors From scala.sys.SystemProperties
--------------------------------------------------------------------------------
...
### `def +=(kv: (String, String)): SystemProperties.this.type`               ###
...
* Definition Classes
  * SystemProperties → MapLike → Builder → Growable

(defined at scala.sys.SystemProperties)


### `def -=(key: String): SystemProperties.this.type`                        ###
...
* Definition Classes
  * SystemProperties → MapLike → Shrinkable
...
* Definition Classes
  * SystemProperties → MapLike → GenMapLike
...
* Definition Classes
  * SystemProperties → Map → Map → MapLike
...
### `def iterator: collection.Iterator[(String, String)]`                    ###
...
* Definition Classes
  * SystemProperties → MapLike → IterableLike → GenIterableLike

(defined at scala.sys.SystemProperties)


### `def names: collection.Iterator[String]`                                 ###
...
* Implicit information
  * This member is added by an implicit conversion from SystemProperties to
    CollectionsHaveToParArray [SystemProperties, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (SystemProperties) ⇒
...
--------------------------------------------------------------------------------
Deprecated Value Members From Implicit scala.sys.SystemProperties.systemPropertiesToCompanion
--------------------------------------------------------------------------------
...
* Implicit information
  * This member is added by an implicit conversion from SystemProperties to
    SystemProperties.type performed by method systemPropertiesToCompanion in
    scala.sys.SystemProperties.
* Definition Classes
  * SystemProperties
* Annotations
...
(added by implicit convertion: scala.sys.SystemProperties.systemPropertiesToCompanion)


--------------------------------------------------------------------------------
Value Members From Implicit scala.sys.SystemProperties.systemPropertiesToCompanion
--------------------------------------------------------------------------------
