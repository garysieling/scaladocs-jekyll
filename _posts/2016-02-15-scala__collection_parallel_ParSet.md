...
### `def bf2seq[S, That](bf: CanBuildFrom[ParSet[T], S, That]): CanBuildFrom[Set[T], S, That]` ###
...
### `def sequentially[S, That <: Parallel](b: (Set[T]) ⇒ Parallelizable[S, That]): ParSet[T]` ###
...
--------------------------------------------------------------------------------
          Concrete Value Members From scala.collection.parallel.ParSet
--------------------------------------------------------------------------------
