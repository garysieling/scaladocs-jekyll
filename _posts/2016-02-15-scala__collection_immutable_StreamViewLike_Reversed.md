...
--------------------------------------------------------------------------------
        Value Members From scala.collection.IterableViewLike.Transformed
--------------------------------------------------------------------------------
...
### `def newDropped(n: Int): Reversed.Transformed[A]`                        ###
...
### `def newTaken(n: Int): Reversed.Transformed[A]`                          ###
...
--------------------------------------------------------------------------------
            Value Members From scala.collection.SeqViewLike.Reversed
--------------------------------------------------------------------------------
...
* Definition Classes
  * Reversed → Transformed → SeqLike → GenSeqLike → Function1
* Exceptions thrown
  * IndexOutOfBoundsException if `idx` does not satisfy `0 <= idx < length` .

(defined at scala.collection.SeqViewLike.Reversed)
...
### `def flatten[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): Reversed.Transformed[B]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (A) ⇒ (A1, A2, A3)): (Reversed.Transformed[A1], Reversed.Transformed[A2], Reversed.Transformed[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (A) ⇒ (A1, A2)): (Reversed.Transformed[A1], Reversed.Transformed[A2])` ###
...
* Implicit information
  * This member is added by an implicit conversion from Reversed to
    CollectionsHaveToParArray [Reversed, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Reversed) ⇒ GenTraversableOnce
    [T] is in scope.
* Definition Classes
