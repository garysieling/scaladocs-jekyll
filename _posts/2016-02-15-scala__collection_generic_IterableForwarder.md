...
### `def toCollection(repr: Iterable[A]): Iterable[A]`                       ###
...
### `def ++:[B >: A, That](that: Traversable[B])(implicit bf: CanBuildFrom[Iterable[A], B, That]): That` ###
...
### `abstract def underlying: Iterable[A]`                                   ###
...
* Attributes
  * protected
* Definition Classes
  * IterableForwarder → TraversableForwarder
...
* Implicit information
  * This member is added by an implicit conversion from IterableForwarder [A] to
    CollectionsHaveToParArray [IterableForwarder [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (IterableForwarder [A]) ⇒
