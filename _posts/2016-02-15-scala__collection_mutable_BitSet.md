...
--------------------------------------------------------------------------------
                 Value Members From scala.collection.BitSetLike
--------------------------------------------------------------------------------
...
Returns a bitset formed from this bitset and another iterable collection by
...
* returns
  * a new bitset containing pairs consisting of corresponding elements of this
    bitset and `that` . The length of the returned collection is the maximum of
    the lengths of this bitset and `that` . If this bitset is shorter than
     `that` , `thisElem` values are used to pad the result. If `that` is shorter
    than this bitset, `thatElem` values are used to pad the result.
...
* returns
  * a new bitset containing pairs consisting of corresponding elements of this
    bitset and `that` . The length of the returned collection is the minimum of
    the lengths of this bitset and `that` .
...
* returns
  * a new bitset resulting from applying the given function `f` to each element
    of this bitset and collecting the results.
...
Returns a new bitset containing the elements from the left hand operand followed
by the elements from the right hand operand. The element type of the bitset is
...
* returns
  * a new bitset resulting from applying the given partial function `pf` to each
...
The type of the resulting collection is guided by the static type of bitset.
...
* returns
  * a new bitset resulting from applying the given collection-valued function
     `f` to each element of this bitset and concatenating the results.
...
* returns
  * the first element of this bitset with the largest value measured by function
    f.
...
* f
  * The measuring function.
* returns
  * the first element of this bitset with the smallest value measured by
    function f.
...
Converts this bitset to a map. This method is unavailable unless the elements
...
Converts this bitset of traversable collections into a bitset formed by the
elements of these traversable collections.

The resulting collection's type will be guided by the static type of bitset. For
example:
...
### `def ++=(xs: TraversableOnce[Int]): BitSet.this.type`                    ###
...
--------------------------------------------------------------------------------
         Deprecated Value Members From scala.collection.mutable.BitSet
--------------------------------------------------------------------------------


### `def toImmutable: immutable.BitSet`                                      ###

Wraps this bitset as an immutable bitset backed by the array of bits of this
bitset.
...
* Annotations
  * @ deprecated
* Deprecated
  * _(Since version 2.11.6)_
* Note
  * Subsequent changes in this bitset will be reflected in the returned
    immutable bitset.
...
--------------------------------------------------------------------------------
           Instance Constructors From scala.collection.mutable.BitSet
--------------------------------------------------------------------------------
...
### `def &=(other: BitSet): BitSet.this.type`                                ###

Updates this bitset to the intersection with another bitset by performing a
bitwise "and".
...
Updates this bitset to the difference with another bitset by performing a
bitwise "and-not".
...
Updates this bitset to the symmetric difference with another bitset by
...
* Definition Classes
  * BitSet → SetLike → Cloneable → AnyRef
* Note
...
### `def fromBitMaskNoCopy(words: Array[Long]): BitSet`                      ###
...
Updates this bitset to the union with another bitset by performing a bitwise
"or".
