...
### `def newDropped(n: Int): StreamView.Transformed[A]`                      ###
...
### `def newTaken(n: Int): StreamView.Transformed[A]`                        ###
...
### `def flatten[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): StreamView.Transformed[B]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (A) ⇒ (A1, A2, A3)): (StreamView.Transformed[A1], StreamView.Transformed[A2], StreamView.Transformed[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (A) ⇒ (A1, A2)): (StreamView.Transformed[A1], StreamView.Transformed[A2])` ###
...
* Implicit information
  * This member is added by an implicit conversion from StreamView [A, Coll] to
    CollectionsHaveToParArray [StreamView [A, Coll], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (StreamView [A, Coll]) ⇒
