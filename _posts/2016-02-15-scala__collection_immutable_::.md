...
### `def grouped(size: Int): Iterator[List[B]]`                              ###
...
### `def sliding(size: Int): Iterator[List[B]]`                              ###
...
### `def sliding(size: Int, step: Int): Iterator[List[B]]`                   ###
...
### `def zipAll[B, A1 >: B, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[List[B], (A1, B), That]): That` ###
...
### `def zip[A1 >: B, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[List[B], (A1, B), That]): That` ###
...
### `final def corresponds[B](that: GenSeq[B])(p: (B, B) ⇒ Boolean): Boolean` ###
...
### `def thisCollection: collection.LinearSeq[B]`                            ###
...
### `def toCollection(repr: List[B]): collection.LinearSeq[B]`               ###
...
### `def :+[B >: B, That](elem: B)(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[List[B]]`                            ###
...
### `def diff[B >: B](that: GenSeq[B]): List[B]`                             ###
...
### `def intersect[B >: B](that: GenSeq[B]): List[B]`                        ###
...
### `def padTo[B >: B, That](len: Int, elem: B)(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def patch[B >: B, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def permutations: Iterator[List[B]]`                                    ###
...
### `def reverseMap[B, That](f: (B) ⇒ B)(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def sortBy[B](f: (B) ⇒ B)(implicit ord: math.Ordering[B]): List[B]`     ###
...
### `def sortWith(lt: (B, B) ⇒ Boolean): List[B]`                            ###
...
### `def sorted[B >: B](implicit ord: math.Ordering[B]): List[B]`            ###
...
### `def union[B >: B, That](that: GenSeq[B])(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def updated[B >: B, That](index: Int, elem: B)(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def view(from: Int, until: Int): SeqView[B, List[B]]`                   ###
...
### `def ++:[B >: B, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def ++:[B >: B, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def filterNot(p: (B) ⇒ Boolean): List[B]`                               ###
...
### `def groupBy[K](f: (B) ⇒ K): Map[K, List[B]]`                            ###
...
### `def partition(p: (B) ⇒ Boolean): (List[B], List[B])`                    ###
...
### `def scanLeft[B, That](z: B)(op: (B, B) ⇒ B)(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (B, B) ⇒ B)(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def scan[B >: B, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def withFilter(p: (B) ⇒ Boolean): FilterMonadic[B, List[B]]`            ###
...
### `def newBuilder: Builder[B, List[B]]`                                    ###
...
### `def transpose[B](implicit asTraversable: (B) ⇒ GenTraversableOnce[B]): List[List[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (B) ⇒ (A1, A2, A3)): (List[A1], List[A2], List[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (B) ⇒ (A1, A2)): (List[A1], List[A2])` ###
...
--------------------------------------------------------------------------------
            Instance Constructors From scala.collection.immutable.::
--------------------------------------------------------------------------------
...
(defined at scala.collection.immutable.::)
...
### `def ++[B >: B, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `final def collect[B, That](pf: PartialFunction[B, B])(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `final def dropWhile(p: (B) ⇒ Boolean): List[B]`                         ###
...
### `final def flatMap[B, That](f: (B) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `final def mapConserve[B >: B <: AnyRef](f: (B) ⇒ B): List[B]`           ###
...
### `final def map[B, That](f: (B) ⇒ B)(implicit bf: CanBuildFrom[List[B], B, That]): That` ###
...
### `def reverse_:::[B >: B](prefix: List[B]): List[B]`                      ###
...
### `def slice(from: Int, until: Int): List[B]`                              ###
...
### `final def span(p: (B) ⇒ Boolean): (List[B], List[B])`                   ###
...
### `def splitAt(n: Int): (List[B], List[B])`                                ###
...
### `final def takeWhile(p: (B) ⇒ Boolean): List[B]`                         ###
...
* Implicit information
  * This member is added by an implicit conversion from :: [B] to
    CollectionsHaveToParArray [:: [B], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (:: [B]) ⇒ GenTraversableOnce [
    T] is in scope.
* Definition Classes
