...
--------------------------------------------------------------------------------
      Instance Constructors From scala.collection.immutable.BitSet.BitSet2
--------------------------------------------------------------------------------


### `new BitSet2(elems0: Long, elems1: Long)`                                ###

(defined at scala.collection.immutable.BitSet.BitSet2)


--------------------------------------------------------------------------------
          Value Members From scala.collection.immutable.BitSet.BitSet2
--------------------------------------------------------------------------------


### `def updateWord(idx: Int, w: Long): BitSet`                              ###
...
* Implicit information
  * This member is added by an implicit conversion from BitSet2 to
    CollectionsHaveToParArray [BitSet2, T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (BitSet2) ⇒ GenTraversableOnce
    [T] is in scope.
* Definition Classes
