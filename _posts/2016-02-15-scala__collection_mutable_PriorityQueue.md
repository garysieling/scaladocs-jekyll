...
### `def ++=(xs: TraversableOnce[A]): PriorityQueue.this.type`               ###
...
### `def +=(elem1: A, elem2: A, elems: A*): PriorityQueue.this.type`         ###
...
--------------------------------------------------------------------------------
       Instance Constructors From scala.collection.mutable.PriorityQueue
--------------------------------------------------------------------------------
...
* Implicit information
  * This member is added by an implicit conversion from PriorityQueue [A] to
    CollectionsHaveToParArray [PriorityQueue [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (PriorityQueue [A]) ⇒
