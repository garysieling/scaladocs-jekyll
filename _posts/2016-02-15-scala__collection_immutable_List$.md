...
The standard `CanBuildFrom` instance for `List` objects. The created value is an
instance of class `GenericCanBuildFrom` , which forwards calls to create a new
builder to the `genericBuilder` method of the requesting collection.
