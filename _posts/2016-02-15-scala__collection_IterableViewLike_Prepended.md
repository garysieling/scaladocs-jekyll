...
### `def slice(from: Int, until: Int): IterableView[B, Coll]`                ###
...
### `def takeWhile(p: (B) ⇒ Boolean): IterableView[B, Coll]`                 ###
...
### `def toCollection(repr: IterableView[B, Coll]): Iterable[B]`             ###
...
### `def view(from: Int, until: Int): IterableView[B, IterableView[B, Coll]]` ###
...
### `def view: IterableView[B, IterableView[B, Coll]]`                       ###
...
### `def drop(n: Int): IterableView[B, Coll]`                                ###
...
### `def dropRight(n: Int): IterableView[B, Coll]`                           ###
...
### `def grouped(size: Int): Iterator[IterableView[B, Coll]]`                ###
...
### `def sliding(size: Int): Iterator[IterableView[B, Coll]]`                ###
...
### `def sliding(size: Int, step: Int): Iterator[IterableView[B, Coll]]`     ###
...
### `def take(n: Int): IterableView[B, Coll]`                                ###
...
### `def takeRight(n: Int): IterableView[B, Coll]`                           ###
...
### `def scan[B >: B, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[IterableView[B, Coll], B, That]): That` ###
...
### `def ++:[B >: B, That](xs: Traversable[B])(implicit bf: CanBuildFrom[IterableView[B, Coll], B, That]): That` ###
...
### `def ++[B >: B, That](xs: GenTraversableOnce[B])(implicit bf: CanBuildFrom[IterableView[B, Coll], B, That]): That` ###
...
### `def dropWhile(p: (B) ⇒ Boolean): IterableView[B, Coll]`                 ###
...
### `def filter(p: (B) ⇒ Boolean): IterableView[B, Coll]`                    ###
...
### `def filterNot(p: (B) ⇒ Boolean): IterableView[B, Coll]`                 ###
...
### `def groupBy[K](f: (B) ⇒ K): immutable.Map[K, IterableView[B, Coll]]`    ###
...
### `def inits: Iterator[IterableView[B, Coll]]`                             ###
...
### `def newBuilder: Builder[B, IterableView[B, Coll]]`                      ###
...
### `def partition(p: (B) ⇒ Boolean): (IterableView[B, Coll], IterableView[B, Coll])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, B) ⇒ B)(implicit bf: CanBuildFrom[IterableView[B, Coll], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (B, B) ⇒ B)(implicit bf: CanBuildFrom[IterableView[B, Coll], B, That]): That` ###
...
### `def span(p: (B) ⇒ Boolean): (IterableView[B, Coll], IterableView[B, Coll])` ###
...
### `def splitAt(n: Int): (IterableView[B, Coll], IterableView[B, Coll])`    ###
...
### `def tails: Iterator[IterableView[B, Coll]]`                             ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (B) ⇒ (A1, A2, A3)): (Prepended.Transformed[A1], Prepended.Transformed[A2], Prepended.Transformed[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (B) ⇒ (A1, A2)): (Prepended.Transformed[A1], Prepended.Transformed[A2])` ###
...
### `def withFilter(p: (B) ⇒ Boolean): IterableView[B, Coll]`                ###
...
--------------------------------------------------------------------------------
   Abstract Value Members From scala.collection.TraversableViewLike.Prepended
--------------------------------------------------------------------------------


### `abstract val fst: GenTraversable[B]`                                    ###
...
(defined at scala.collection.TraversableViewLike.Prepended)
...
* Implicit information
  * This member is added by an implicit conversion from Prepended [B] to
    CollectionsHaveToParArray [Prepended [B], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Prepended [B]) ⇒
