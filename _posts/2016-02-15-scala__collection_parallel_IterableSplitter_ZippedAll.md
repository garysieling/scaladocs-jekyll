...
### `def indexWhere(p: ((U, S)) ⇒ Boolean): Int`                             ###
...
### `def appendParIterable[U >: (U, S), PI <: IterableSplitter[U]](that: PI): Appended[U, PI]` ###
...
### `def slice(from1: Int, until1: Int): IterableSplitter[(U, S)]`           ###
...
### `def splitWithSignalling: scala.Seq[IterableSplitter[(U, S)]]`           ###
...
### `def take(n: Int): IterableSplitter[(U, S)]`                             ###
...
--------------------------------------------------------------------------------
Instance Constructors From scala.collection.parallel.IterableSplitter.ZippedAll
--------------------------------------------------------------------------------


### `new ZippedAll(that: SeqSplitter[S], thiselem: U, thatelem: S)`          ###
...
* Definition Classes
  * ZippedAll → IterableSplitter

(defined at scala.collection.parallel.IterableSplitter.ZippedAll)


### `def split: scala.Seq[IterableSplitter[(U, S)]]`                         ###
...
* Definition Classes
  * ZippedAll → IterableSplitter → Splitter
