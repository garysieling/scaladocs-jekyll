...
### `type Self = IterableView[(A, B), Coll]`                                 ###
...
### `def toCollection(repr: IterableView[(A, B), Coll]): Iterable[(A, B)]`   ###
...
### `def view(from: Int, until: Int): IterableView[(A, B), IterableView[(A, B), Coll]]` ###
...
### `def view: IterableView[(A, B), IterableView[(A, B), Coll]]`             ###
...
### `def drop(n: Int): IterableView[(A, B), Coll]`                           ###
...
### `def dropRight(n: Int): IterableView[(A, B), Coll]`                      ###
...
### `def grouped(size: Int): Iterator[IterableView[(A, B), Coll]]`           ###
...
### `def sliding(size: Int): Iterator[IterableView[(A, B), Coll]]`           ###
...
### `def sliding(size: Int, step: Int): Iterator[IterableView[(A, B), Coll]]` ###
...
### `def take(n: Int): IterableView[(A, B), Coll]`                           ###
...
### `def takeRight(n: Int): IterableView[(A, B), Coll]`                      ###
...
### `def zipAll[B, A1 >: (A, B), That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[IterableView[(A, B), Coll], (A1, B), That]): That` ###
...
### `def zip[A1 >: (A, B), B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[IterableView[(A, B), Coll], (A1, B), That]): That` ###
...
### `def parCombiner: Combiner[(A, B), ParIterable[(A, B)]]`                 ###
...
### `def repr: IterableView[(A, B), Coll]`                                   ###
...
### `def scan[B >: (A, B), That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[IterableView[(A, B), Coll], B, That]): That` ###
...
### `def ++:[B >: (A, B), That](xs: Traversable[B])(implicit bf: CanBuildFrom[IterableView[(A, B), Coll], B, That]): That` ###
...
### `def ++:[B >: (A, B), That](xs: TraversableOnce[B])(implicit bf: CanBuildFrom[IterableView[(A, B), Coll], B, That]): That` ###
...
### `def ++[B >: (A, B), That](xs: GenTraversableOnce[B])(implicit bf: CanBuildFrom[IterableView[(A, B), Coll], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[(A, B), B])(implicit bf: CanBuildFrom[IterableView[(A, B), Coll], B, That]): That` ###
...
### `def dropWhile(p: ((A, B)) ⇒ Boolean): IterableView[(A, B), Coll]`       ###
...
### `def filter(p: ((A, B)) ⇒ Boolean): IterableView[(A, B), Coll]`          ###
...
### `def filterNot(p: ((A, B)) ⇒ Boolean): IterableView[(A, B), Coll]`       ###
...
### `def flatMap[B, That](f: ((A, B)) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[IterableView[(A, B), Coll], B, That]): That` ###
...
### `def groupBy[K](f: ((A, B)) ⇒ K): immutable.Map[K, IterableView[(A, B), Coll]]` ###
...
### `def init: IterableView[(A, B), Coll]`                                   ###
...
### `def inits: Iterator[IterableView[(A, B), Coll]]`                        ###
...
### `def map[B, That](f: ((A, B)) ⇒ B)(implicit bf: CanBuildFrom[IterableView[(A, B), Coll], B, That]): That` ###
...
### `def newBuilder: Builder[(A, B), IterableView[(A, B), Coll]]`            ###
...
### `def partition(p: ((A, B)) ⇒ Boolean): (IterableView[(A, B), Coll], IterableView[(A, B), Coll])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, (A, B)) ⇒ B)(implicit bf: CanBuildFrom[IterableView[(A, B), Coll], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: ((A, B), B) ⇒ B)(implicit bf: CanBuildFrom[IterableView[(A, B), Coll], B, That]): That` ###
...
### `def slice(from: Int, until: Int): IterableView[(A, B), Coll]`           ###
...
### `def span(p: ((A, B)) ⇒ Boolean): (IterableView[(A, B), Coll], IterableView[(A, B), Coll])` ###
...
### `def splitAt(n: Int): (IterableView[(A, B), Coll], IterableView[(A, B), Coll])` ###
...
### `def tail: IterableView[(A, B), Coll]`                                   ###
...
### `def tails: Iterator[IterableView[(A, B), Coll]]`                        ###
...
### `def takeWhile(p: ((A, B)) ⇒ Boolean): IterableView[(A, B), Coll]`       ###
...
### `def withFilter(p: ((A, B)) ⇒ Boolean): IterableView[(A, B), Coll]`      ###
