...
### `def ++=(xs: TraversableOnce[A]): Queue.this.type`                       ###
...
### `def +=(elem1: A, elem2: A, elems: A*): Queue.this.type`                 ###
...
--------------------------------------------------------------------------------
           Instance Constructors From scala.collection.mutable.Queue
--------------------------------------------------------------------------------
...
### `def transform(f: (A) ⇒ A): Queue.this.type`                             ###
...
* Implicit information
  * This member is added by an implicit conversion from Queue [A] to
    CollectionsHaveToParArray [Queue [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (Queue [A]) ⇒
