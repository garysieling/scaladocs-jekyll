...
### `def ++=(xs: TraversableOnce[(A, B)]): AbstractMap.this.type`            ###
...
### `def +=(elem1: (A, B), elem2: (A, B), elems: (A, B)*): AbstractMap.this.type` ###
...
### `def --=(xs: TraversableOnce[A]): AbstractMap.this.type`                 ###
...
### `def -=(elem1: A, elem2: A, elems: A*): AbstractMap.this.type`           ###
...
--------------------------------------------------------------------------------
        Instance Constructors From scala.collection.mutable.AbstractMap
--------------------------------------------------------------------------------


### `new AbstractMap()`                                                      ###

(defined at scala.collection.mutable.AbstractMap)
...
### `abstract def +=(kv: (A, B)): AbstractMap.this.type`                     ###
...
### `abstract def -=(key: A): AbstractMap.this.type`                         ###
...
### `def retain(p: (A, B) ⇒ Boolean): AbstractMap.this.type`                 ###
...
### `def transform(f: (A, B) ⇒ B): AbstractMap.this.type`                    ###
