...
### `def dropRight(n: Int): LinkedList[A]`                                   ###
...
### `def grouped(size: Int): Iterator[LinkedList[A]]`                        ###
...
### `def slice(from: Int, until: Int): LinkedList[A]`                        ###
...
### `def sliding(size: Int): Iterator[LinkedList[A]]`                        ###
...
### `def sliding(size: Int, step: Int): Iterator[LinkedList[A]]`             ###
...
### `def takeRight(n: Int): LinkedList[A]`                                   ###
...
### `def takeWhile(p: (A) ⇒ Boolean): LinkedList[A]`                         ###
...
### `def zipAll[B, A1 >: A, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[LinkedList[A], (A1, B), That]): That` ###
...
### `def zipWithIndex[A1 >: A, That](implicit bf: CanBuildFrom[LinkedList[A], (A1, Int), That]): That` ###
...
### `def zip[A1 >: A, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[LinkedList[A], (A1, B), That]): That` ###
...
### `def +:[B >: A, That](elem: B)(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[LinkedList[A]]`                      ###
...
### `def diff[B >: A](that: GenSeq[B]): LinkedList[A]`                       ###
...
### `def intersect[B >: A](that: GenSeq[B]): LinkedList[A]`                  ###
...
### `def padTo[B >: A, That](len: Int, elem: B)(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def patch[B >: A, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def permutations: Iterator[LinkedList[A]]`                              ###
...
### `def reverseMap[B, That](f: (A) ⇒ B)(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def sortBy[B](f: (A) ⇒ B)(implicit ord: math.Ordering[B]): LinkedList[A]` ###
...
### `def sortWith(lt: (A, A) ⇒ Boolean): LinkedList[A]`                      ###
...
### `def sorted[B >: A](implicit ord: math.Ordering[B]): LinkedList[A]`      ###
...
### `def toCollection(repr: LinkedList[A]): collection.Seq[A]`               ###
...
### `def union[B >: A, That](that: GenSeq[B])(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def updated[B >: A, That](index: Int, elem: B)(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def view(from: Int, until: Int): SeqView[A, LinkedList[A]]`             ###
...
### `def view: SeqView[A, LinkedList[A]]`                                    ###
...
### `def ++:[B >: A, That](that: collection.Traversable[B])(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def ++:[B >: A, That](that: TraversableOnce[B])(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def ++[B >: A, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[A, B])(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###

[use case]

Builds a new collection by applying a partial function to all elements of this
linked list on which the function is defined.
...
### `def dropWhile(p: (A) ⇒ Boolean): LinkedList[A]`                         ###
...
### `def filterNot(p: (A) ⇒ Boolean): LinkedList[A]`                         ###
...
### `def flatMap[B, That](f: (A) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
The type of the resulting collection is guided by the static type of linked
...
### `def groupBy[K](f: (A) ⇒ K): immutable.Map[K, LinkedList[A]]`            ###
...
### `def inits: Iterator[LinkedList[A]]`                                     ###
...
### `def map[B, That](f: (A) ⇒ B)(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def scanLeft[B, That](z: B)(op: (B, A) ⇒ B)(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (A, B) ⇒ B)(implicit bf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def scan[B >: A, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[LinkedList[A], B, That]): That` ###
...
### `def span(p: (A) ⇒ Boolean): (LinkedList[A], LinkedList[A])`             ###
...
### `def tails: Iterator[LinkedList[A]]`                                     ###
...
### `def withFilter(p: (A) ⇒ Boolean): FilterMonadic[A, LinkedList[A]]`      ###
...
### `def flatten[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): LinkedList[B]` ###

[use case]

Converts this linked list of traversable collections into a linked list formed
by the elements of these traversable collections.

The resulting collection's type will be guided by the static type of linked
list. For example:
...
### `def genericBuilder[B]: Builder[B, LinkedList[B]]`                       ###
...
### `def newBuilder: Builder[A, LinkedList[A]]`                              ###
...
### `def transpose[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): LinkedList[LinkedList[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (A) ⇒ (A1, A2, A3)): (LinkedList[A1], LinkedList[A2], LinkedList[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (A) ⇒ (A1, A2)): (LinkedList[A1], LinkedList[A2])` ###
...
--------------------------------------------------------------------------------
         Instance Constructors From scala.collection.mutable.LinkedList
--------------------------------------------------------------------------------


### `new LinkedList(elem: A, next: LinkedList[A])`                           ###

Creates a new list. If the parameter next is null, the result is an empty list.
Otherwise, the result is a list with elem at the head, followed by the contents
of next.

Note that next is part of the new list, as opposed to the +: operator, which
makes a new copy of the original list.
...
### `def companion: GenericCompanion[LinkedList]`                            ###

The factory companion object that builds instances of class `LinkedList` . (or
its `Iterable` superclass where class `LinkedList` is not a `Seq` .)

* Definition Classes
  * LinkedList → LinearSeq → LinearSeq → Seq → Iterable → Traversable → Seq →
...
* Definition Classes
  * LinkedListLike → TraversableLike → GenTraversableLike
* Exceptions thrown
  * ``UnsupportedOperationException`` if the linked list is empty.
...
### `def transform(f: (A) ⇒ A): LinkedList.this.type`                        ###
...
* Implicit information
  * This member is added by an implicit conversion from LinkedList [A] to
    CollectionsHaveToParArray [LinkedList [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (LinkedList [A]) ⇒
