...
(defined at scala.collection.GenIterable)
...
### `abstract def zipAll[B, A1 >: A, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[GenIterable[A], (A1, B), That]): That` ###
...
### `abstract def zip[A1 >: A, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[GenIterable[A], (A1, B), That]): That` ###
...
### `abstract def drop(n: Int): GenIterable[A]`                              ###
...
### `abstract def dropWhile(pred: (A) ⇒ Boolean): GenIterable[A]`            ###
...
### `abstract def filter(pred: (A) ⇒ Boolean): GenIterable[A]`               ###
...
### `abstract def filterNot(pred: (A) ⇒ Boolean): GenIterable[A]`            ###
...
### `abstract def groupBy[K](f: (A) ⇒ K): GenMap[K, GenIterable[A]]`         ###
...
### `abstract def init: GenIterable[A]`                                      ###
...
### `abstract def partition(pred: (A) ⇒ Boolean): (GenIterable[A], GenIterable[A])` ###
...
### `abstract def repr: GenIterable[A]`                                      ###
...
### `abstract def scanLeft[B, That](z: B)(op: (B, A) ⇒ B)(implicit bf: CanBuildFrom[GenIterable[A], B, That]): That` ###
...
### `abstract def scanRight[B, That](z: B)(op: (A, B) ⇒ B)(implicit bf: CanBuildFrom[GenIterable[A], B, That]): That` ###
...
### `abstract def scan[B >: A, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[GenIterable[A], B, That]): That` ###
...
### `abstract def slice(unc_from: Int, unc_until: Int): GenIterable[A]`      ###
...
### `abstract def span(pred: (A) ⇒ Boolean): (GenIterable[A], GenIterable[A])` ###
...
### `abstract def splitAt(n: Int): (GenIterable[A], GenIterable[A])`         ###
...
### `abstract def tail: GenIterable[A]`                                      ###
...
### `abstract def take(n: Int): GenIterable[A]`                              ###
...
### `abstract def takeWhile(pred: (A) ⇒ Boolean): GenIterable[A]`            ###
...
### `abstract def ++[B >: A, That](that: GenTraversableOnce[B])(implicit bf: CanBuildFrom[GenIterable[A], B, That]): That` ###
...
### `abstract def collect[B, That](pf: PartialFunction[A, B])(implicit bf: CanBuildFrom[GenIterable[A], B, That]): That` ###
...
### `abstract def flatMap[B, That](f: (A) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[GenIterable[A], B, That]): That` ###
...
### `abstract def map[B, That](f: (A) ⇒ B)(implicit bf: CanBuildFrom[GenIterable[A], B, That]): That` ###
...
### `def newBuilder: Builder[A, GenIterable[A]]`                             ###
...
### `def transpose[B](implicit asTraversable: (A) ⇒ GenTraversableOnce[B]): GenIterable[GenIterable[B]]` ###
...
### `def unzip3[A1, A2, A3](implicit asTriple: (A) ⇒ (A1, A2, A3)): (GenIterable[A1], GenIterable[A2], GenIterable[A3])` ###
...
### `def unzip[A1, A2](implicit asPair: (A) ⇒ (A1, A2)): (GenIterable[A1], GenIterable[A2])` ###
...
* Implicit information
  * This member is added by an implicit conversion from GenIterable [A] to
    CollectionsHaveToParArray [GenIterable [A], T] performed by method
    CollectionsHaveToParArray in scala.collection.parallel. This conversion will
    take place only if an implicit value of type (GenIterable [A]) ⇒
