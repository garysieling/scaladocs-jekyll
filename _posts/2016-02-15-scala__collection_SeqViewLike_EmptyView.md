...
### `type Self = SeqView[Nothing, Coll]`                                     ###
...
### `def drop(n: Int): SeqView[Nothing, Coll]`                               ###
...
### `def dropRight(n: Int): SeqView[Nothing, Coll]`                          ###
...
### `def grouped(size: Int): Iterator[SeqView[Nothing, Coll]]`               ###
...
### `def sliding(size: Int): Iterator[SeqView[Nothing, Coll]]`               ###
...
### `def sliding(size: Int, step: Int): Iterator[SeqView[Nothing, Coll]]`    ###
...
### `def take(n: Int): SeqView[Nothing, Coll]`                               ###
...
### `def takeRight(n: Int): SeqView[Nothing, Coll]`                          ###
...
### `def zipAll[B, A1 >: Nothing, That](that: GenIterable[B], thisElem: A1, thatElem: B)(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], (A1, B), That]): That` ###
...
### `def zip[A1 >: Nothing, B, That](that: GenIterable[B])(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], (A1, B), That]): That` ###
...
### `def thisCollection: Seq[Nothing]`                                       ###
...
### `def toCollection(repr: SeqView[Nothing, Coll]): Seq[Nothing]`           ###
...
### `def view(from: Int, until: Int): SeqView[Nothing, SeqView[Nothing, Coll]]` ###
...
### `def view: SeqView[Nothing, SeqView[Nothing, Coll]]`                     ###
...
### `def +:[B >: Nothing, That](elem: B)(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def combinations(n: Int): Iterator[SeqView[Nothing, Coll]]`             ###
...
### `def diff[B >: Nothing](that: GenSeq[B]): SeqView[Nothing, Coll]`        ###
...
### `def distinct: SeqView[Nothing, Coll]`                                   ###
...
### `def intersect[B >: Nothing](that: GenSeq[B]): SeqView[Nothing, Coll]`   ###
...
### `def padTo[B >: Nothing, That](len: Int, elem: B)(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def patch[B >: Nothing, That](from: Int, patch: GenSeq[B], replaced: Int)(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def permutations: Iterator[SeqView[Nothing, Coll]]`                     ###
...
### `def reverse: SeqView[Nothing, Coll]`                                    ###
...
### `def reverseMap[B, That](f: (Nothing) ⇒ B)(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def sortBy[B](f: (Nothing) ⇒ B)(implicit ord: Ordering[B]): SeqView[Nothing, Coll]` ###
...
### `def sortWith(lt: (Nothing, Nothing) ⇒ Boolean): SeqView[Nothing, Coll]` ###
...
### `def sorted[B >: Nothing](implicit ord: Ordering[B]): SeqView[Nothing, Coll]` ###
...
### `def union[B >: Nothing, That](that: GenSeq[B])(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def updated[B >: Nothing, That](index: Int, elem: B)(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def scan[B >: Nothing, That](z: B)(op: (B, B) ⇒ B)(implicit cbf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def ++:[B >: Nothing, That](xs: Traversable[B])(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def ++:[B >: Nothing, That](xs: TraversableOnce[B])(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def ++[B >: Nothing, That](xs: GenTraversableOnce[B])(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def collect[B, That](pf: PartialFunction[Nothing, B])(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def dropWhile(p: (Nothing) ⇒ Boolean): SeqView[Nothing, Coll]`          ###
...
### `def filter(p: (Nothing) ⇒ Boolean): SeqView[Nothing, Coll]`             ###
...
### `def filterNot(p: (Nothing) ⇒ Boolean): SeqView[Nothing, Coll]`          ###
...
### `def flatMap[B, That](f: (Nothing) ⇒ GenTraversableOnce[B])(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def groupBy[K](f: (Nothing) ⇒ K): immutable.Map[K, SeqView[Nothing, Coll]]` ###
...
### `def inits: Iterator[SeqView[Nothing, Coll]]`                            ###
...
### `def map[B, That](f: (Nothing) ⇒ B)(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def newBuilder: Builder[Nothing, SeqView[Nothing, Coll]]`               ###
...
### `def partition(p: (Nothing) ⇒ Boolean): (SeqView[Nothing, Coll], SeqView[Nothing, Coll])` ###
...
### `def scanLeft[B, That](z: B)(op: (B, Nothing) ⇒ B)(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def scanRight[B, That](z: B)(op: (Nothing, B) ⇒ B)(implicit bf: CanBuildFrom[SeqView[Nothing, Coll], B, That]): That` ###
...
### `def slice(from: Int, until: Int): SeqView[Nothing, Coll]`               ###
...
### `def span(p: (Nothing) ⇒ Boolean): (SeqView[Nothing, Coll], SeqView[Nothing, Coll])` ###
...
### `def splitAt(n: Int): (SeqView[Nothing, Coll], SeqView[Nothing, Coll])`  ###
...
### `def tails: Iterator[SeqView[Nothing, Coll]]`                            ###
...
### `def takeWhile(p: (Nothing) ⇒ Boolean): SeqView[Nothing, Coll]`          ###
...
### `def withFilter(p: (Nothing) ⇒ Boolean): SeqView[Nothing, Coll]`         ###
...
### `def transpose[B](implicit asTraversable: (Nothing) ⇒ GenTraversableOnce[B]): Seq[Seq[B]]` ###
